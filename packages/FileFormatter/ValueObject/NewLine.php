...
final class NewLine implements \Stringable
{
    ...
    {
        $matches = \RectorPrefix20210519\Nette\Utils\Strings::match($content, self::VALID_NEWLINE_REGEX);
        if ($matches === null) {
    ...
    {
        $match = \RectorPrefix20210519\Nette\Utils\Strings::match($content, self::NEWLINE_REGEX);
