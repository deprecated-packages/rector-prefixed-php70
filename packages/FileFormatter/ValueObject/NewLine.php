...
final class NewLine
{
    ...
    {
        $matches = \RectorPrefix20210616\Nette\Utils\Strings::match($content, self::VALID_NEWLINE_REGEX);
        if ($matches === null) {
    ...
    {
        $match = \RectorPrefix20210616\Nette\Utils\Strings::match($content, self::NEWLINE_REGEX);
