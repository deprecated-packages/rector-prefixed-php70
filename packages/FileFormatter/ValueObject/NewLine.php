...
final class NewLine implements \Stringable
{
    ...
    {
        $matches = \RectorPrefix20210520\Nette\Utils\Strings::match($content, self::VALID_NEWLINE_REGEX);
        if ($matches === null) {
    ...
    {
        $match = \RectorPrefix20210520\Nette\Utils\Strings::match($content, self::NEWLINE_REGEX);
