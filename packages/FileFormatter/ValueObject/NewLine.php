...
final class NewLine implements \Stringable
{
     ...
     * @var string
     */
    const CARRIAGE_RETURN = 'cr';
    /**
     * @var string
     */
    const CARRIAGE_RETURN_LINE_FEED = 'crlf';
    /**
     * @var array<string, string>
     */
    const ALLOWED_END_OF_LINE = [self::LINE_FEED => "\n", self::CARRIAGE_RETURN => "\r", self::CARRIAGE_RETURN_LINE_FEED => "\r\n"];
    /**
     * @see https://regex101.com/r/icaBBp/1
     * @var string
     */
    const NEWLINE_REGEX = '#(?P<newLine>\\r\\n|\\n|\\r)#';
    /**
     * @see https://regex101.com/r/WrY9ZW/1/
     * @var string
     */
    const VALID_NEWLINE_REGEX = '#^(?>\\r\\n|\\n|\\r)$#';
    /**
     * @var string
     */
    private $string;
    ...
    {
        $matches = \RectorPrefix20210525\Nette\Utils\Strings::match($content, self::VALID_NEWLINE_REGEX);
        if ($matches === null) {
    ...
    {
        $match = \RectorPrefix20210525\Nette\Utils\Strings::match($content, self::NEWLINE_REGEX);
