...
final class XmlFileFormatter implements \Rector\FileFormatter\Contract\Formatter\FileFormatterInterface
{
     ...
     * @var string
     */
    const XML_PARTS_REGEX = '#(>)(<)(\\/*)#';
    /**
     * @see https://regex101.com/r/hSG1JT/1
     * @var string
     */
    const IS_OPENING_TAG_REGEX = '#^<[^\\/]*>$#';
    /**
     * @see https://regex101.com/r/ywS62K/1
     * @var string
     */
    const IS_CLOSING_TAG_REGEX = '#^\\s*<\\/#';
    /**
     * @var int|null
     */
    private $depth;
     ...
     * @return void
     */
    public function format(\Rector\Core\ValueObject\Application\File $file, \Rector\FileFormatter\ValueObject\EditorConfigConfiguration $editorConfigConfiguration)
    {
    ...
    {
        $withNewLines = \RectorPrefix20210520\Nette\Utils\Strings::replace(\trim($xml), self::XML_PARTS_REGEX, "\$1\n\$2\$3");
        return \explode("\n", $withNewLines);
    }
     ...
     * @return void
     */
    private function runPre(string $part)
    {
     ...
     * @return void
     */
    private function runPost(string $part)
    {
    ...
    {
        return (bool) \RectorPrefix20210520\Nette\Utils\Strings::match($part, self::IS_OPENING_TAG_REGEX);
    }
    private function isClosingTag(string $part) : bool
    {
        return (bool) \RectorPrefix20210520\Nette\Utils\Strings::match($part, self::IS_CLOSING_TAG_REGEX);
    }
    private function isOpeningCdataTag(string $part) : bool
    {
        return \RectorPrefix20210520\Nette\Utils\Strings::contains($part, '<![CDATA[');
    }
    private function isClosingCdataTag(string $part) : bool
    {
        return \RectorPrefix20210520\Nette\Utils\Strings::contains($part, ']]>');
    }
}
