...
use RectorPrefix20210620\Symplify\EasyTesting\DataProvider\StaticFixtureFinder;
use RectorPrefix20210620\Symplify\EasyTesting\DataProvider\StaticFixtureUpdater;
...
abstract class AbstractRectorTestCase extends \Rector\Testing\PHPUnit\AbstractTestCase implements \Rector\Testing\Contract\RectorTestInterface
{
    ...
    protected function setUp()
    {
        ...
        $this->parameterProvider = $this->getService(\RectorPrefix20210620\Symplify\PackageBuilder\Parameter\ParameterProvider::class);
    ...
    {
        return \RectorPrefix20210620\Symplify\EasyTesting\DataProvider\StaticFixtureFinder::yieldDirectoryExclusively($directory, $suffix);
    }
    /**
     * @return void
     */
    ...
    {
        $inputFileInfoAndExpectedFileInfo = \RectorPrefix20210620\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToLocalInputAndExpectedFileInfos($fixtureFileInfo);
    ...
    private function doTestFileMatchesExpectedContent(\Symplify\SmartFileSystem\SmartFileInfo $originalFileInfo, \Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, \Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo)
    {
        ...
        try {
            ...
            \RectorPrefix20210620\Symplify\EasyTesting\DataProvider\StaticFixtureUpdater::updateFixtureContent($originalFileInfo, $changedContent, $fixtureFileInfo);
    ...
    {
        return \RectorPrefix20210620\Nette\Utils\Strings::replace($string, '#\\r\\n|\\r|\\n#', "\n");
    }
