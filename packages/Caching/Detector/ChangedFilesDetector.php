...
final class ChangedFilesDetector
{
     ...
     */
    private $cache;
    public function __construct(\Rector\Caching\Config\FileHashComputer $fileHashComputer, \RectorPrefix20210526\Nette\Caching\Cache $cache)
    {
    ...
    {
        $key = self::CONFIGURATION_HASH_KEY . '_' . \RectorPrefix20210526\Nette\Utils\Strings::webalize($fileInfo->getRealPath());
