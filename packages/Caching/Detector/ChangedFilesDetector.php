...
final class ChangedFilesDetector
{
     ...
     */
    private $cache;
    public function __construct(\Rector\Caching\Config\FileHashComputer $fileHashComputer, \RectorPrefix20210504\Nette\Caching\Cache $cache)
    {
     ...
     * @return void
     */
    public function addFileWithDependencies(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, array $dependentFiles)
    {
     ...
     * @return void
     */
    public function invalidateFile(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo)
    {
        $fileInfoCacheKey = $this->getFileInfoCacheKey($smartFileInfo);
    ...
    {
        $this->cache->clean([\RectorPrefix20210504\Nette\Caching\Cache::ALL => \true]);
    }
    /**
     ...
     * @return void
     */
    public function setFirstResolvedConfigFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $fileInfo)
    {
     ...
     * @return void
     */
    private function storeConfigurationDataHash(\Symplify\SmartFileSystem\SmartFileInfo $fileInfo, string $configurationHash)
    {
        $key = self::CONFIGURATION_HASH_KEY . '_' . \RectorPrefix20210504\Nette\Utils\Strings::webalize($fileInfo->getRealPath());
