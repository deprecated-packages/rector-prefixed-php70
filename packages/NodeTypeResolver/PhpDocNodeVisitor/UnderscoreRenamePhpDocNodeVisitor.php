...
final class UnderscoreRenamePhpDocNodeVisitor extends \RectorPrefix20210522\Symplify\SimplePhpDocParser\PhpDocNodeVisitor\AbstractPhpDocNodeVisitor
{
    /**
    ...
    public function enterNode(\PHPStan\PhpDocParser\Ast\Node $node)
    {
        ...
        $slashedName = '\\' . \RectorPrefix20210522\Nette\Utils\Strings::replace($staticType->getClassName(), '#_#', '\\');
    ...
    private function shouldSkip(\PHPStan\PhpDocParser\Ast\Type\IdentifierTypeNode $identifierTypeNode, \PhpParser\Node $phpParserNode, \Rector\Renaming\ValueObject\PseudoNamespaceToNamespace $pseudoNamespaceToNamespace) : bool
    {
        ...
        if (!\RectorPrefix20210522\Nette\Utils\Strings::startsWith($staticType->getClassName(), $pseudoNamespaceToNamespace->getNamespacePrefix())) {
            return \true;
        }
        // excluded?
