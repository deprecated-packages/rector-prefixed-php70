...
final class VerifyRectorServiceExistsCompilerPass implements \RectorPrefix20210526\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     * @return void
     */
    public function process(\RectorPrefix20210526\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder)
    {
        foreach ($containerBuilder->getDefinitions() as $definition) {
            ...
            if (!\RectorPrefix20210526\Nette\Utils\Strings::endsWith($class, 'Rector')) {
                continue;
            }
