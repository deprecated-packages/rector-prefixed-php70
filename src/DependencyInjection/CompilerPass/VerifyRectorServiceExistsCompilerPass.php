...
final class VerifyRectorServiceExistsCompilerPass implements \RectorPrefix20210525\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     * @return void
     */
    public function process(\RectorPrefix20210525\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder)
    {
        foreach ($containerBuilder->getDefinitions() as $definition) {
            ...
            if (!\RectorPrefix20210525\Nette\Utils\Strings::endsWith($class, 'Rector')) {
                continue;
            }
