...
final class Configuration
{
     ...
     * @return void
     */
    public function resolveFromInput(\RectorPrefix20210528\Symfony\Component\Console\Input\InputInterface $input)
    {
    ...
    private function canShowProgressBar(\RectorPrefix20210528\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
    ...
    private function correctBashSpacePaths(array $commandLinePaths) : array
    {
        ...
        foreach ($commandLinePaths as $commandLinePath) {
            if (\RectorPrefix20210528\Nette\Utils\Strings::contains($commandLinePath, ' ')) {
