...
final class Configuration
{
     ...
     * @return void
     */
    public function resolveFromInput(\RectorPrefix20210527\Symfony\Component\Console\Input\InputInterface $input)
    {
    ...
    private function canShowProgressBar(\RectorPrefix20210527\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
    ...
    private function correctBashSpacePaths(array $commandLinePaths) : array
    {
        ...
        foreach ($commandLinePaths as $commandLinePath) {
            if (\RectorPrefix20210527\Nette\Utils\Strings::contains($commandLinePath, ' ')) {
