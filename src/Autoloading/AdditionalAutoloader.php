...
final class AdditionalAutoloader
{
    ...
    public function __construct(\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard, \RectorPrefix20210531\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Rector\Core\StaticReflection\DynamicSourceLocatorDecorator $dynamicSourceLocatorDecorator)
    {
     ...
     * @return void
     */
    public function autoloadInput(\RectorPrefix20210531\Symfony\Component\Console\Input\InputInterface $input)
    {
