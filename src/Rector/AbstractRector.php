...
use RectorPrefix20210620\Symplify\Skipper\Skipper\Skipper;
/**
...
abstract class AbstractRector extends \PhpParser\NodeVisitorAbstract implements \Rector\Core\Contract\Rector\PhpRectorInterface
{
     ...
     * @return void
     */
    protected function removeNodeFromStatements($nodeWithStatements, \PhpParser\Node $toBeRemovedNode)
    {
     ...
     * @return void
     */
    private function connectParentNodes($node)
    {
