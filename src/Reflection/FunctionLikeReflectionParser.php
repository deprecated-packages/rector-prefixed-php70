...
final class FunctionLikeReflectionParser
{
     ...
     * @return \PhpParser\Node\Stmt\ClassMethod|null
     */
    public function parseCaller(\PhpParser\Node $node)
    {
     ...
     * @return \PhpParser\Node\Stmt\ClassMethod|null
     */
    private function getClassMethodFromNodes(array $nodes, \PHPStan\Reflection\ClassReflection $classReflection, string $className, string $methodName)
    {
     ...
     * @return \PhpParser\Node\Stmt\ClassMethod|null
     */
    private function getClassMethod(\PhpParser\Node\Stmt $stmt, string $shortClassName, string $methodName)
    {
