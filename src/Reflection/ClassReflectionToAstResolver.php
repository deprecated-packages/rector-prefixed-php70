...
final class ClassReflectionToAstResolver
{
    ...
    public function __construct(\PhpParser\Parser $parser, \RectorPrefix20210518\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \Rector\Core\PhpParser\Node\BetterNodeFinder $betterNodeFinder, \PHPStan\Reflection\ReflectionProvider $reflectionProvider)
    {
        $this->parser = $parser;
