...
final class ClassReflectionToAstResolver
{
    ...
    public function __construct(\PhpParser\Parser $parser, \RectorPrefix20210503\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \Rector\Core\PhpParser\Node\BetterNodeFinder $betterNodeFinder, \PHPStan\Reflection\ReflectionProvider $reflectionProvider)
    {
        $this->parser = $parser;
