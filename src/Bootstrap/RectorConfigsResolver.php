...
final class RectorConfigsResolver
{
    ...
    {
        $argvInput = new \RectorPrefix20210620\Symfony\Component\Console\Input\ArgvInput();
     ...
     */
    private function resolveRectorRecipeConfig(\RectorPrefix20210620\Symfony\Component\Console\Input\ArgvInput $argvInput)
    {
     ...
     * @return \Symplify\SmartFileSystem\SmartFileInfo|null
     */
    private function resolveFromInput(\RectorPrefix20210620\Symfony\Component\Console\Input\ArgvInput $argvInput)
    {
        ...
        if (!\file_exists($configValue)) {
            ...
            throw new \RectorPrefix20210620\Symplify\SmartFileSystem\Exception\FileNotFoundException($message);
        }
     ...
     * @return \Symplify\SmartFileSystem\SmartFileInfo|null
     */
    private function resolveFromInputWithFallback(\RectorPrefix20210620\Symfony\Component\Console\Input\ArgvInput $argvInput, string $fallbackFile)
    {
     ...
     * @return string|null
     */
    private function getOptionValue(\RectorPrefix20210620\Symfony\Component\Console\Input\ArgvInput $argvInput, array $optionNames)
    {
