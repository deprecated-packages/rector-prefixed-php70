...
use RectorPrefix20210504\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder;
/**
...
final class NodeFactory
{
    ...
    {
        $methodBuilder = new \RectorPrefix20210504\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder($name);
    ...
    {
        $paramBuilder = new \RectorPrefix20210504\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder($name);
        if ($type !== null) {
    ...
    {
        $propertyBuilder = new \RectorPrefix20210504\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder($name);
    ...
    {
        $methodBuilder = new \RectorPrefix20210504\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('get' . \ucfirst($propertyName));
        $methodBuilder->makePublic();
    ...
    {
        $methodBuilder = new \RectorPrefix20210504\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('set' . \ucfirst($propertyName));
        $methodBuilder->makePublic();
        $variable = new \PhpParser\Node\Expr\Variable($propertyName);
    ...
    {
        $paramBuilder = new \RectorPrefix20210504\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder($propertyMetadata->getName());
