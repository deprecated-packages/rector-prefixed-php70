...
final class InfiniteLoopValidator
{
     ...
     * @return void
     */
    public function process(\PhpParser\Node $node, \PhpParser\Node $originalNode, string $rectorClass)
    {
     ...
     * @return void
     */
    private function decorateNode(\PhpParser\Node $node, string $rectorClass)
    {
