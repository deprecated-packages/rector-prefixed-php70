...
$autoloadIncluder = new \RectorPrefix20210531\AutoloadIncluder();
...
} elseif (\RectorPrefix20210531\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210531\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210531\\AutoloadIncluder', 'AutoloadIncluder', \false);
