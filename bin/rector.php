...
$autoloadIncluder = new \RectorPrefix20210517\AutoloadIncluder();
...
} elseif (\RectorPrefix20210517\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210517\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210517\\AutoloadIncluder', 'AutoloadIncluder', \false);
