...
$autoloadIncluder = new \RectorPrefix20210520\AutoloadIncluder();
...
} elseif (\RectorPrefix20210520\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210520\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210520\\AutoloadIncluder', 'AutoloadIncluder', \false);
