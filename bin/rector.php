...
$autoloadIncluder = new \RectorPrefix20210616\AutoloadIncluder();
...
} elseif (\RectorPrefix20210616\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210616\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210616\\AutoloadIncluder', 'AutoloadIncluder', \false);
