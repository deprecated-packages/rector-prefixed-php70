...
$autoloadIncluder = new \RectorPrefix20210528\AutoloadIncluder();
...
} elseif (\RectorPrefix20210528\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210528\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210528\\AutoloadIncluder', 'AutoloadIncluder', \false);
