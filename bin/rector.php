...
$autoloadIncluder = new \RectorPrefix20210523\AutoloadIncluder();
...
} elseif (\RectorPrefix20210523\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210523\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210523\\AutoloadIncluder', 'AutoloadIncluder', \false);
