...
$autoloadIncluder = new \RectorPrefix20210620\AutoloadIncluder();
...
} elseif (\RectorPrefix20210620\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210620\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210620\\AutoloadIncluder', 'AutoloadIncluder', \false);
