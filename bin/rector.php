...
$autoloadIncluder = new \RectorPrefix20210527\AutoloadIncluder();
...
} elseif (\RectorPrefix20210527\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210527\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210527\\AutoloadIncluder', 'AutoloadIncluder', \false);
