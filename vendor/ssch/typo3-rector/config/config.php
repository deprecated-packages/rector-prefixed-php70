...
use RectorPrefix20210519\Helmich\TypoScriptParser\Parser\Parser;
use RectorPrefix20210519\Helmich\TypoScriptParser\Parser\ParserInterface;
use RectorPrefix20210519\Helmich\TypoScriptParser\Parser\Printer\ASTPrinterInterface;
use RectorPrefix20210519\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinter;
...
return static function (\RectorPrefix20210519\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) {
    ...
    $services->load('RectorPrefix20210519\Ssch\\TYPO3Rector\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/Rector', __DIR__ . '/../src/Set', __DIR__ . '/../src/ValueObject', __DIR__ . '/../src/TypoScript/Conditions', __DIR__ . '/../src/TypoScript/Visitors', __DIR__ . '/../src/FlexForms/Rector', __DIR__ . '/../src/Yaml/Form/Rector', __DIR__ . '/../src/Resources/Icons/Rector']);
    ...
    $services->set(\RectorPrefix20210519\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinter::class);
    $services->alias(\RectorPrefix20210519\Helmich\TypoScriptParser\Parser\Printer\ASTPrinterInterface::class, \RectorPrefix20210519\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinter::class);
    $services->set(\RectorPrefix20210519\Helmich\TypoScriptParser\Parser\Parser::class);
    $services->alias(\RectorPrefix20210519\Helmich\TypoScriptParser\Parser\ParserInterface::class, \RectorPrefix20210519\Helmich\TypoScriptParser\Parser\Parser::class);
    $services->set(\RectorPrefix20210519\Symfony\Component\Console\Output\BufferedOutput::class);
    $services->alias(\RectorPrefix20210519\Symfony\Component\Console\Output\OutputInterface::class, \RectorPrefix20210519\Symfony\Component\Console\Output\BufferedOutput::class);
