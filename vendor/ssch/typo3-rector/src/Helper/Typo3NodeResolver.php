...
final class Typo3NodeResolver
{
     ...
     * @var string
     */
    const TYPO_SCRIPT_FRONTEND_CONTROLLER = 'TSFE';
    /**
     * @var string
     */
    const TIME_TRACKER = 'TT';
    /**
     * @var string
     */
    const PARSETIME_START = 'PARSETIME_START';
    /**
     * @var string
     */
    const TYPO3_LOADED_EXT = 'TYPO3_LOADED_EXT';
    /**
     * @var string
     */
    const TYPO3_DB = 'TYPO3_DB';
    /**
     * @var string
     */
    const BACKEND_USER = 'BE_USER';
    /**
     * @var string
     */
     ...
     * @var string
     */
    const SIM_EXEC_TIME = 'SIM_EXEC_TIME';
    /**
     * @var string
     */
     ...
     * @var string
     */
    const SIM_ACCESS_TIME = 'SIM_ACCESS_TIME';
    /**
