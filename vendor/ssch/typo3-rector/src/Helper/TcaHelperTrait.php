...
trait TcaHelperTrait
{
     ...
     */
    protected function extractArrayItemByKey($node, string $key)
    {
        if (null === $node) {
            return null;
        }
     ...
     */
    protected function extractSubArrayByKey($node, string $key)
    {
        if (null === $node) {
            return null;
        }
     ...
     */
    protected function extractArrayValueByKey($node, string $key)
    {
     ...
     * @return \PhpParser\Node\Expr\ArrayItem|null
     */
    private function extractColumns(\PhpParser\Node\Stmt\Return_ $node)
    {
     ...
     * @return \PhpParser\Node\Expr\ArrayItem|null
     */
    private function extractTypes(\PhpParser\Node\Stmt\Return_ $node)
    {
     ...
     * @return \PhpParser\Node\Expr\ArrayItem|null
     */
    private function extractCtrl(\PhpParser\Node\Stmt\Return_ $node)
    {
     ...
     * @return \PhpParser\Node\Expr\ArrayItem|null
     */
    private function extractInterface(\PhpParser\Node\Stmt\Return_ $node)
    {
