...
final class DefaultSwitchFluidRector implements \Ssch\TYPO3Rector\Contract\FileProcessor\Fluid\Rector\FluidRectorInterface
{
     ...
     * @var string
     */
    const PATTERN = '#<f:case default="(1|true)">(.*)</f:case>#';
    /**
     * @var string
     */
    const REPLACEMENT = '<f:defaultCase>$2</f:defaultCase>';
    /**
     * @return void
     */
    public function transform(\Rector\Core\ValueObject\Application\File $file)
    {
        ...
        $content = \RectorPrefix20210527\Nette\Utils\Strings::replace($content, self::PATTERN, self::REPLACEMENT);
