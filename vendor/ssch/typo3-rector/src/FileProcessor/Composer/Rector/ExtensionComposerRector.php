...
final class ExtensionComposerRector implements \Rector\Composer\Contract\Rector\ComposerRectorInterface
{
     ...
     * @return void
     */
    public function refactor(\RectorPrefix20210526\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson)
    {
...
, [self::TYPO3_VERSION_CONSTRAINT => '^10.4'])]);
     ...
     * @return void
     */
    private function addExtensionKey(\RectorPrefix20210526\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson)
    {
     ...
     * @return void
     */
    private function addDescription(\RectorPrefix20210526\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson)
    {
     ...
     * @return void
     */
    private function addLicense(\RectorPrefix20210526\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson)
    {
     ...
     * @return void
     */
    private function fixPackageName(\RectorPrefix20210526\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson)
    {
