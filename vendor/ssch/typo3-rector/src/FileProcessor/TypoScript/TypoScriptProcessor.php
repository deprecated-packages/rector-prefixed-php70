...
use RectorPrefix20210531\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinterConfiguration;
use RectorPrefix20210531\Helmich\TypoScriptParser\Parser\Traverser\Traverser;
use RectorPrefix20210531\Helmich\TypoScriptParser\Parser\Traverser\Visitor;
use RectorPrefix20210531\Helmich\TypoScriptParser\Tokenizer\TokenizerException;
...
final class TypoScriptProcessor implements \Ssch\TYPO3Rector\Contract\Processor\ConfigurableProcessorInterface
{
     ...
     */
    public function __construct(\RectorPrefix20210531\Helmich\TypoScriptParser\Parser\ParserInterface $typoscriptParser, \RectorPrefix20210531\Symfony\Component\Console\Output\BufferedOutput $output, \RectorPrefix20210531\Helmich\TypoScriptParser\Parser\Printer\ASTPrinterInterface $typoscriptPrinter, \Rector\Core\Provider\CurrentFileProvider $currentFileProvider, \Rector\FileFormatter\EditorConfig\EditorConfigParser $editorConfigParser, \Rector\Core\Application\FileSystem\RemovedAndAddedFilesCollector $removedAndAddedFilesCollector, \Rector\Core\Console\Output\RectorOutputStyle $rectorOutputStyle, array $visitors = [])
    {
    ...
    private function processFile(\Rector\Core\ValueObject\Application\File $file)
    {
        try {
            ...
            $traverser = new \RectorPrefix20210531\Helmich\TypoScriptParser\Parser\Traverser\Traverser($originalStatements);
            ...
            $prettyPrinterConfiguration = \RectorPrefix20210531\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinterConfiguration::create();
        ...
        } catch (\RectorPrefix20210531\Helmich\TypoScriptParser\Tokenizer\TokenizerException $tokenizerException) {
            return;
        }
    }
    /**
    ...
    {
        return \array_filter($this->visitors, function (\RectorPrefix20210531\Helmich\TypoScriptParser\Parser\Traverser\Visitor $visitor) : bool {
