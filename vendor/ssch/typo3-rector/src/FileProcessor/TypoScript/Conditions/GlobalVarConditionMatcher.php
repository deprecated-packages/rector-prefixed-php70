...
final class GlobalVarConditionMatcher extends \Ssch\TYPO3Rector\FileProcessor\TypoScript\Conditions\AbstractGlobalConditionMatcher
{
    ...
    {
        return \RectorPrefix20210527\Nette\Utils\Strings::startsWith($condition, self::TYPE);
    }
    ...
    {
        $delimiter = \RectorPrefix20210527\Nette\Utils\Strings::contains($property, ':') ? ':' : '|';
        list(, $property) = \Ssch\TYPO3Rector\Helper\ArrayUtility::trimExplode($delimiter, $property, \true, 2);
