...
final class FormYamlProcessor implements \Rector\Core\Contract\Processor\FileProcessorInterface
{
    ...
    public function supports(\Rector\Core\ValueObject\Application\File $file) : bool
    {
        ...
        return \RectorPrefix20210526\Nette\Utils\Strings::endsWith($smartFileInfo->getFilename(), 'form.yaml');
    }
    ...
    private function processFile(\Rector\Core\ValueObject\Application\File $file)
    {
        ...
        $smartFileInfo = $file->getSmartFileInfo();
        $yaml = \RectorPrefix20210526\Symfony\Component\Yaml\Yaml::parseFile($smartFileInfo->getRealPath());
        if (!\is_array($yaml)) {
            return;
        }
        $newYaml = $yaml;
        ...
        $newFileContent = \RectorPrefix20210526\Symfony\Component\Yaml\Yaml::dump($newYaml, 99);
