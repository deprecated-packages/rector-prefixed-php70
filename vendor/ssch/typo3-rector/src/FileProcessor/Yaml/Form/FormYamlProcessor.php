...
final class FormYamlProcessor implements \Rector\Core\Contract\Processor\FileProcessorInterface
{
    ...
    public function supports(\Rector\Core\ValueObject\Application\File $file) : bool
    {
        ...
        return \RectorPrefix20210616\Nette\Utils\Strings::endsWith($smartFileInfo->getFilename(), 'yaml');
    }
    ...
    private function processFile(\Rector\Core\ValueObject\Application\File $file)
    {
        ...
        $smartFileInfo = $file->getSmartFileInfo();
        $yaml = \RectorPrefix20210616\Symfony\Component\Yaml\Yaml::parseFile($smartFileInfo->getRealPath());
        if (!\is_array($yaml)) {
            return;
        }
        $newYaml = $yaml;
        ...
        $newFileContent = \RectorPrefix20210616\Symfony\Component\Yaml\Yaml::dump($newYaml, 99);
