...
final class IgnoreValidationAnnotationRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string
     */
    const OLD_ANNOTATION = 'ignorevalidation';
    /**
     * @var string
     */
    const VERY_OLD_ANNOTATION = 'dontvalidate';
    /**
...
CODE_SAMPLE
     ...
     */
    private function refactorValidation(string $oldAnnotation, \Rector\BetterPhpDocParser\PhpDocInfo\PhpDocInfo $phpDocInfo, \PhpParser\Node\Stmt\ClassMethod $node)
    {
