...
final class SubstituteCacheWrapperMethodsRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string
     */
    const HASH_CONTENT = 'hashContent';
    /**
...
CODE_SAMPLE
     ...
     * @return void
     */
    private function getCacheMethod(\PhpParser\Node\Expr\StaticCall $node)
    {
     ...
     * @return void
     */
    private function addCacheManagerNode(\PhpParser\Node\Expr\StaticCall $node)
    {
     ...
     * @return void
     */
    private function setCacheMethod(\PhpParser\Node\Expr\StaticCall $node)
    {
        $this->addCacheManagerNode($node);
