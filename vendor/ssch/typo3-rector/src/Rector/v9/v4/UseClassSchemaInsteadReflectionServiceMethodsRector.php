...
CODE_SAMPLE
     ...
     * @return \PhpParser\Node|null
     */
    private function refactorGetPropertyTagsValuesMethod(\PhpParser\Node\Expr\MethodCall $node)
    {
     ...
     * @return \PhpParser\Node|null
     */
    private function refactorGetPropertyTagValuesMethod(\PhpParser\Node\Expr\MethodCall $node)
    {
        if (!$this->isAtLeastPhpVersion(\Rector\Core\ValueObject\PhpVersionFeature::NULL_COALESCE)) {
            return null;
        }
     ...
     * @return \PhpParser\Node|null
     */
    private function refactorGetClassTagValues(\PhpParser\Node\Expr\MethodCall $node)
    {
        if (!$this->isAtLeastPhpVersion(\Rector\Core\ValueObject\PhpVersionFeature::NULL_COALESCE)) {
            return null;
        }
     ...
     * @return \PhpParser\Node|null
     */
    private function refactorGetMethodTagsValues(\PhpParser\Node\Expr\MethodCall $node)
    {
        if (!$this->isAtLeastPhpVersion(\Rector\Core\ValueObject\PhpVersionFeature::NULL_COALESCE)) {
            return null;
        }
     ...
     * @return \PhpParser\Node|null
     */
    private function refactorHasMethod(\PhpParser\Node\Expr\MethodCall $node)
    {
        if (!isset($node->args[1])) {
            return null;
        }
     ...
     * @return \PhpParser\Node|null
     */
    private function refactorGetMethodParameters(\PhpParser\Node\Expr\MethodCall $node)
    {
        if (!$this->isAtLeastPhpVersion(\Rector\Core\ValueObject\PhpVersionFeature::NULL_COALESCE)) {
            return null;
        }
     ...
     * @return \PhpParser\Node|null
     */
    private function refactorIsPropertyTaggedWith(\PhpParser\Node\Expr\MethodCall $node)
    {
     ...
     * @return \PhpParser\Node|null
     */
    private function refactorIsClassTaggedWith(\PhpParser\Node\Expr\MethodCall $node)
    {
        if (!isset($node->args[1])) {
            return null;
        }
