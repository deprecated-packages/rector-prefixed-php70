...
final class UseLanguageAspectForTsfeLanguagePropertiesRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     */
    const NODE_NAME_MAPPING = ['sys_language_uid' => 'id', 'sys_language_content' => 'contentId', 'sys_language_contentOL' => 'legacyOverlayType', 'sys_language_mode' => 'legacyLanguageMode'];
    /**
