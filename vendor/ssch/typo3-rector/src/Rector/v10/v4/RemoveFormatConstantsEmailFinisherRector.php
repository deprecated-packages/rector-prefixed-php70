...
final class RemoveFormatConstantsEmailFinisherRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string
     */
    const ADD_HTML_PART = 'addHtmlPart';
    /**
...
CODE_SAMPLE
     ...
     * @return void
     */
    private function refactorSetOptionMethodCall(\PhpParser\Node\Arg $parent, \PhpParser\Node\Expr\ClassConstFetch $node)
    {
     ...
     * @return void
     */
    private function refactorArrayItemOption(\PhpParser\Node\Expr\ArrayItem $parent, \PhpParser\Node\Expr\ClassConstFetch $node)
    {
     ...
     * @return void
     */
    private function refactorOptionAssignment(\PhpParser\Node\Expr\Assign $parent, \PhpParser\Node\Expr\ClassConstFetch $node)
    {
     ...
     * @return void
     */
    private function refactorCondition(\PhpParser\Node\Expr\BinaryOp\Identical $parent, \PhpParser\Node\Expr\ClassConstFetch $node)
    {
