...
CODE_SAMPLE
     ...
     * @return void
     */
    private function createNewControllerActionsArray(\PhpParser\Node\Expr\Array_ $controllerActions, string $vendorName, string $extensionName)
    {
     ...
     * @return void
     */
    private function refactorConfigurePluginMethod(\PhpParser\Node\Expr\StaticCall $node, string $vendorName, string $extensionName)
    {
     ...
     * @return void
     */
    private function refactorRegisterPluginMethod(\PhpParser\Node\Expr\StaticCall $node, string $vendorName, string $extensionName)
    {
