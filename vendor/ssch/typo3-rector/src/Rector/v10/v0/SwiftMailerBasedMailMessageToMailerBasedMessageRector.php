...
CODE_SAMPLE
     ...
     */
    private function refactorMethodSetBody(\PhpParser\Node\Expr\MethodCall $node)
    {
     ...
     * @return \PhpParser\Node|null
     */
    private function refactorMethodAddPart(\PhpParser\Node\Expr\MethodCall $node)
    {
        $contentType = isset($node->args[1]) ? $this->valueResolver->getValue($node->args[1]->value) : null;
     ...
     * @return \PhpParser\Node|null
     */
    private function refactorAttachMethod(\PhpParser\Node\Expr\MethodCall $node)
    {
     ...
     * @return \PhpParser\Node|null
     */
    private function refactorEmbedMethod(\PhpParser\Node\Expr\MethodCall $node)
    {
        $firstArgument = $node->args[0]->value;
        if (!$firstArgument instanceof \PhpParser\Node\Expr\StaticCall) {
            return null;
