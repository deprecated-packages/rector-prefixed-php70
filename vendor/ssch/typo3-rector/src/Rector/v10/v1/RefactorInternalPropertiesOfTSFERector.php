...
use RectorPrefix20210525\TYPO3\CMS\Core\Utility\GeneralUtility;
use RectorPrefix20210525\TYPO3\CMS\Core\Utility\HttpUtility;
use RectorPrefix20210525\TYPO3\CMS\Frontend\Page\CacheHashCalculator;
/**
...
final class RefactorInternalPropertiesOfTSFERector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string
     */
    const RELEVANT_PARAMETERS_FOR_CACHING_FROM_PAGE_ARGUMENTS = 'relevantParametersForCachingFromPageArguments';
    /**
     * @var string
     */
    const PAGE_ARGUMENTS = 'pageArguments';
    /**
     * @var string
     */
