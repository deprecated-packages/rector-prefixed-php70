...
final class RefactorGraphicalFunctionsTempPathAndCreateTemSubDirRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string
     */
    const CREATE_TEMP_SUB_DIR = 'createTempSubDir';
    /**
     * @var string
     */
    const TEMP_PATH = 'tempPath';
    /**
     * @var string
     */
...
CODE_SAMPLE
     ...
     * @return \PhpParser\Node|null
     */
    private function refactorMethodCall(\PhpParser\Node\Expr\MethodCall $node)
    {
     ...
     * @return \PhpParser\Node|null
     */
    private function refactorPropertyFetch(\PhpParser\Node\Expr\PropertyFetch $node)
    {
