...
use RectorPrefix20210522\TYPO3\CMS\Core\Utility\ExtensionManagementUtility;
/**
...
final class MoveForeignTypesToOverrideChildTcaRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string
     */
    const FOREIGN_TYPES = 'foreign_types';
    /**
     * @var string
     */
    const FOREIGN_SELECTOR_FIELDTCAOVERRIDE = 'foreign_selector_fieldTcaOverride';
    /**
     * @var string
     */
    const FOREIGN_SELECTOR = 'foreign_selector';
    /**
     * @var string
     */
    const FOREIGN_RECORD_DEFAULTS = 'foreign_record_defaults';
    /**
     * @var string
     */
    const OVERRIDE_CHILD_TCA = 'overrideChildTca';
    /**
     * @codeCoverageIgnore
     */
...
CODE_SAMPLE
     ...
     * @return void
     */
    private function injectOverrideChildTca(\PhpParser\Node\Expr\Array_ $overrideChildTcaNode, string $overrideKey, \PhpParser\Node\Expr\Array_ $overrideValue)
    {
