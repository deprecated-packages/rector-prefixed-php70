...
final class RefactorRemovedMarkerMethodsFromHtmlParserRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string[]
     */
    const MOVED_METHODS_TO_MARKER_BASED_TEMPLATES = ['getSubpart', 'substituteSubpart', 'substituteSubpartArray', 'substituteMarker', 'substituteMarkerArray', 'substituteMarkerAndSubpartArrayRecursive'];
    /**
     * @var string
     */
    const RENAMED_METHOD = 'XHTML_clean';
    /**
     * @var string[]
     */
    const REMOVED_METHODS = ['processTag', 'processContent'];
    /**
...
CODE_SAMPLE
     ...
     * @return void
     */
    public function removeMethods(\PhpParser\Node $node)
    {
     ...
     * @return void
     */
    public function renameMethod(\PhpParser\Node $node)
    {
     ...
     * @return \PhpParser\Node|null
     */
    private function migrateMethodsToMarkerBasedTemplateService(\PhpParser\Node $node)
    {
