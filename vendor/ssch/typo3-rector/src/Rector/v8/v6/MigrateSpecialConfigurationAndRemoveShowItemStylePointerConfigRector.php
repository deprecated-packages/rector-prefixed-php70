...
final class MigrateSpecialConfigurationAndRemoveShowItemStylePointerConfigRector extends \Ssch\TYPO3Rector\Rector\Tca\AbstractTcaRector
{
     ...
     * @var string
     */
    const PALETTE_NAME = 'paletteName';
    /**
     * @var string
     */
    const FIELD_EXTRA = 'fieldExtra';
    /**
...
CODE_SAMPLE
     ...
     * @return void
     */
    protected function refactorType(\PhpParser\Node\Expr $typeKey, \PhpParser\Node\Expr $typeConfiguration)
    {
