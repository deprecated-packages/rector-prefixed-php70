...
CODE_SAMPLE
    ...
    private function isRichtextInDefaultExtras(\PhpParser\Node\Expr\ArrayItem $configValue) : bool
    {
        ...
        return \RectorPrefix20210519\Nette\Utils\Strings::startsWith($defaultExtras, 'richtext');
    }
    /**
     * @return void
     */
    private function refactorRichtextColumns(\PhpParser\Node\Expr\Array_ $columnItems)
    {
