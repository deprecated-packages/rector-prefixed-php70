...
CODE_SAMPLE
    ...
    {
        if ($this->isObjectType($node->var, new \PHPStan\Type\ObjectType('RectorPrefix20210519\\TYPO3\\CMS\\Frontend\\ContentObject\\ContentObjectRenderer'))) {
            return \false;
        }
     ...
     * @return void
     */
    private function addInitializeVariableNode(\PhpParser\Node\Expr\MethodCall $node)
    {
        $parentNode = $node->getAttribute(\Rector\NodeTypeResolver\Node\AttributeKey::PARENT_NODE);
     ...
     * @return void
     */
    private function addTypoScriptFrontendControllerAssignmentNode(\PhpParser\Node\Expr\MethodCall $node)
    {
     ...
     * @return void
     */
    private function addFileNameNode(\PhpParser\Node\Expr\MethodCall $node)
    {
     ...
     * @return void
     */
    private function addIfNode(\PhpParser\Node\Expr\MethodCall $node)
    {
        $parentNode = $node->getAttribute(\Rector\NodeTypeResolver\Node\AttributeKey::PARENT_NODE);
