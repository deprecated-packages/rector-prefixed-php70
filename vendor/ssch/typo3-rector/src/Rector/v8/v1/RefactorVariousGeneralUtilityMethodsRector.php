...
final class RefactorVariousGeneralUtilityMethodsRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string
     */
    const COMPAT_VERSION = 'compat_version';
    /**
     * @var string
     */
    const CONVERT_MICROTIME = 'convertMicrotime';
    /**
     * @var string
     */
    const RAW_URL_ENCODE_JS = 'rawUrlEncodeJS';
    /**
     * @var string
     */
    const RAW_URL_ENCODE_FP = 'rawUrlEncodeFP';
    /**
     * @var string
     */
    const GET_MAXIMUM_PATH_LENGTH = 'getMaximumPathLength';
    /**
     * @var string
     */
    const LCFIRST = 'lcfirst';
    /**
     * @var string
     */
    const PARTS = 'parts';
