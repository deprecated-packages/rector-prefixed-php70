...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node)
    {
        ...
        foreach (self::MAPPING_OLD_TO_NEW_PATHS as $oldPath => $newPath) {
            ...
            if (\RectorPrefix20210528\Nette\Utils\Strings::contains($value, $oldPathPrefixed)) {
