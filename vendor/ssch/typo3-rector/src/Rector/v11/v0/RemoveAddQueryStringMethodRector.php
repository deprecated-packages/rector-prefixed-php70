...
CODE_SAMPLE
     ...
     * @return \PhpParser\Node|null
     */
    private function refactorSetAddQueryStringMethodCall(\PhpParser\Node\Expr\MethodCall $node)
    {
        try {
     ...
     * @return void
     */
    private function refactorGetQueryArgumentsMethodCall(\PhpParser\Node\Expr\MethodCall $node)
    {
