...
, [self::TYPO3_VERSION_CONSTRAINT => '^10.4'])]);
     ...
     * @return void
     */
    private function addExtensionKey(\RectorPrefix20210523\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson)
    {
     ...
     * @return void
     */
    private function addDescription(\RectorPrefix20210523\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson)
    {
     ...
     * @return void
     */
    private function addLicense(\RectorPrefix20210523\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson)
    {
     ...
     * @return void
     */
    private function fixPackageName(\RectorPrefix20210523\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson)
    {
