...
final class InitializeArgumentsClassMethodFactory
{
     ...
     * @var string
     */
    const METHOD_NAME = 'initializeArguments';
    /**
     * @var string
     */
    const MIXED = 'mixed';
     ...
     * @return void
     */
    public function decorateClass(\PhpParser\Node\Stmt\Class_ $class)
    {
    ...
    /**
     * @param \PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode|null $paramTagValueNode
     */
    private function getDescription($paramTagValueNode) : string
    {
     ...
     * @param \PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode|null $paramTagValueNode
     */
    private function createTypeInString($paramTagValueNode, \PhpParser\Node\Param $param) : string
    {
        if (null !== $param->type) {
