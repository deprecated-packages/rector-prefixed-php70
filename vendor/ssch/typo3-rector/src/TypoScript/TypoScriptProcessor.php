...
use RectorPrefix20210520\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinterConfiguration;
use RectorPrefix20210520\Helmich\TypoScriptParser\Parser\Traverser\Traverser;
use RectorPrefix20210520\Helmich\TypoScriptParser\Parser\Traverser\Visitor;
use RectorPrefix20210520\Helmich\TypoScriptParser\Tokenizer\TokenizerException;
...
final class TypoScriptProcessor implements \Ssch\TYPO3Rector\Contract\Processor\ConfigurableProcessorInterface
{
    ...
    private function processFile(\Rector\Core\ValueObject\Application\File $file)
    {
        try {
            ...
            $traverser = new \RectorPrefix20210520\Helmich\TypoScriptParser\Parser\Traverser\Traverser($originalStatements);
            ...
            $prettyPrinterConfiguration = \RectorPrefix20210520\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinterConfiguration::create();
        ...
        } catch (\RectorPrefix20210520\Helmich\TypoScriptParser\Tokenizer\TokenizerException $tokenizerException) {
            return;
        }
    }
    /**
    ...
    {
        return \array_filter($this->visitors, function (\RectorPrefix20210520\Helmich\TypoScriptParser\Parser\Traverser\Visitor $visitor) : bool {
