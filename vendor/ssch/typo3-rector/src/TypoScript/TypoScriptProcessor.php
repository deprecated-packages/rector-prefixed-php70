...
use RectorPrefix20210523\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinterConfiguration;
use RectorPrefix20210523\Helmich\TypoScriptParser\Parser\Traverser\Traverser;
use RectorPrefix20210523\Helmich\TypoScriptParser\Parser\Traverser\Visitor;
use RectorPrefix20210523\Helmich\TypoScriptParser\Tokenizer\TokenizerException;
...
final class TypoScriptProcessor implements \Ssch\TYPO3Rector\Contract\Processor\ConfigurableProcessorInterface
{
     ...
     * @var string
     */
    const ALLOWED_FILE_EXTENSIONS = 'allowed_file_extensions';
    /**
     * @var string[]
     */
     ...
     */
    public function __construct(\RectorPrefix20210523\Helmich\TypoScriptParser\Parser\ParserInterface $typoscriptParser, \RectorPrefix20210523\Symfony\Component\Console\Output\BufferedOutput $output, \RectorPrefix20210523\Helmich\TypoScriptParser\Parser\Printer\ASTPrinterInterface $typoscriptPrinter, \Rector\Core\Provider\CurrentFileProvider $currentFileProvider, \Rector\FileFormatter\EditorConfig\EditorConfigParser $editorConfigParser, \Rector\Core\Application\FileSystem\RemovedAndAddedFilesCollector $removedAndAddedFilesCollector, \Rector\Core\Console\Output\RectorOutputStyle $rectorOutputStyle, array $visitors = [])
    {
    ...
    private function processFile(\Rector\Core\ValueObject\Application\File $file)
    {
        try {
            ...
            $traverser = new \RectorPrefix20210523\Helmich\TypoScriptParser\Parser\Traverser\Traverser($originalStatements);
            foreach ($this->visitors as $visitor) {
                $traverser->addVisitor($visitor);
            }
            $traverser->walk();
            $visitorsChanged = \array_filter($this->visitors, function (\Ssch\TYPO3Rector\TypoScript\Visitors\AbstractVisitor $visitor) {
            ...
            $prettyPrinterConfiguration = \RectorPrefix20210523\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinterConfiguration::create();
        ...
        } catch (\RectorPrefix20210523\Helmich\TypoScriptParser\Tokenizer\TokenizerException $tokenizerException) {
            return;
        }
    }
    /**
    ...
    {
        return \array_filter($this->visitors, function (\RectorPrefix20210523\Helmich\TypoScriptParser\Parser\Traverser\Visitor $visitor) : bool {
            return \is_a($visitor, \Ssch\TYPO3Rector\Contract\TypoScript\ConvertToPhpFileInterface::class, \true);
        });
    }
    /**
     * @return void
     */
    private function convertTypoScriptToPhpFiles()
    {
