...
use RectorPrefix20210525\Helmich\TypoScriptParser\Parser\AST\Scalar as ScalarValue;
...
use RectorPrefix20210525\Symfony\Component\VarExporter\VarExporter;
...
final class ExtbasePersistenceVisitor extends \Ssch\TYPO3Rector\TypoScript\Visitors\AbstractVisitor implements \Ssch\TYPO3Rector\Contract\TypoScript\ConvertToPhpFileInterface, \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
     ...
     * @return void
     */
    public function enterNode(\RectorPrefix20210525\Helmich\TypoScriptParser\Parser\AST\Statement $statement)
    {
        if (!$statement instanceof \RectorPrefix20210525\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment) {
            return;
        }
        if (!\RectorPrefix20210525\Nette\Utils\Strings::contains($statement->object->absoluteName, 'persistence.classes')) {
            return;
        }
...
, [self::FILENAME => 'path/to/Configuration/Extbase/Persistence/Classes.php'])]);
    ...
    public function convert()
    {
        ...
        $content = \str_replace('__PERSISTENCE_ARRAY__', \RectorPrefix20210525\Symfony\Component\VarExporter\VarExporter::export(self::$persistenceArray), $this->fileTemplate->getContents());
     ...
     * @return void
     */
    private function extractSubClasses(array $paths, \RectorPrefix20210525\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment $statement)
    {
     ...
     * @return void
     */
    private function extractMapping(string $name, array $paths, \RectorPrefix20210525\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment $statement)
    {
     ...
     * @return void
     */
    private function extractColumns(array $paths, \RectorPrefix20210525\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment $statement)
    {
