...
final class ExtbasePersistenceVisitor extends \Ssch\TYPO3Rector\TypoScript\Visitors\AbstractVisitor implements \Ssch\TYPO3Rector\Contract\TypoScript\ConvertToPhpFileInterface, \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
     ...
     * @return void
     */
    public function enterNode(\RectorPrefix20210523\Helmich\TypoScriptParser\Parser\AST\Statement $statement)
    {
...
, [self::FILENAME => 'path/to/Configuration/Extbase/Persistence/Classes.php'])]);
     ...
     * @return void
     */
    private function extractSubClasses(array $paths, \RectorPrefix20210523\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment $statement)
    {
     ...
     * @return void
     */
    private function extractMapping(string $name, array $paths, \RectorPrefix20210523\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment $statement)
    {
     ...
     * @return void
     */
    private function extractColumns(array $paths, \RectorPrefix20210523\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment $statement)
    {
