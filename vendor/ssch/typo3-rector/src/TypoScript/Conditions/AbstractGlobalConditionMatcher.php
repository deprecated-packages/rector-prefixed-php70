...
abstract class AbstractGlobalConditionMatcher implements \Ssch\TYPO3Rector\Contract\TypoScript\Conditions\TyposcriptConditionMatcher
{
    ...
    {
        if (\RectorPrefix20210520\Nette\Utils\Strings::startsWith($property, 'page')) {
    ...
    protected function createIndependentCondition(string $property, string $operator, string $value) : string
    {
        ...
        if (\array_key_exists($property, self::IENV_MAPPING_NORMALIZED)) {
            ...
            if (\RectorPrefix20210520\Nette\Utils\Strings::startsWith(self::IENV_MAPPING_NORMALIZED[$property], 'get')) {
