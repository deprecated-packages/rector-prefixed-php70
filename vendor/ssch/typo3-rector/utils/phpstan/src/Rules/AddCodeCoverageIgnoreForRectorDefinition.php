...
final class AddCodeCoverageIgnoreForRectorDefinition implements \PHPStan\Rules\Rule
{
     ...
     * @var string
     */
    const ERROR_MESSAGE = 'Provide @codeCoverageIgnore doc block for "%s" RectorDefinition method';
    /**
    ...
    public function processNode(\PhpParser\Node $node, \PHPStan\Analyser\Scope $scope) : array
    {
        ...
        if (\RectorPrefix20210527\Nette\Utils\Strings::contains($phpDocString, '@codeCoverageIgnore')) {
            return [];
        }
        return [\sprintf(self::ERROR_MESSAGE, $className)];
    }
