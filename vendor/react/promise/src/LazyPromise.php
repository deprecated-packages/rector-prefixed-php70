 ...
 */
class LazyPromise implements \RectorPrefix20210527\React\Promise\ExtendedPromiseInterface, \RectorPrefix20210527\React\Promise\CancellablePromiseInterface
{
    private $factory;
    private $promise;
    ...
    public function promise()
    {
        if (null === $this->promise) {
            try {
                ...
                $this->promise = new \RectorPrefix20210527\React\Promise\RejectedPromise($exception);
