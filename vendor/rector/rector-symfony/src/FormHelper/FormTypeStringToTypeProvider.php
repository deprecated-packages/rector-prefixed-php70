...
final class FormTypeStringToTypeProvider
{
    ...
    public function matchClassForNameWithPrefix(string $name)
    {
        ...
        if (\RectorPrefix20210519\Nette\Utils\Strings::startsWith($name, 'form.type.')) {
            $name = \RectorPrefix20210519\Nette\Utils\Strings::substring($name, \strlen('form.type.'));
        }
