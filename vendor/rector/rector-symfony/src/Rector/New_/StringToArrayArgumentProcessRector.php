...
CODE_SAMPLE
    ...
    {
        $privatesCaller = new \RectorPrefix20210503\Symplify\PackageBuilder\Reflection\PrivatesCaller();
        return $privatesCaller->callPrivateMethod(new \RectorPrefix20210503\Symfony\Component\Console\Input\StringInput(''), 'tokenize', [$process]);
    }
    /**
     * @return void
     */
