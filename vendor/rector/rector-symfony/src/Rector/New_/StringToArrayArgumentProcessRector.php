...
use RectorPrefix20210527\Symfony\Component\Console\Input\StringInput;
...
CODE_SAMPLE
    ...
    {
        $privatesCaller = new \RectorPrefix20210527\Symplify\PackageBuilder\Reflection\PrivatesCaller();
        return $privatesCaller->callPrivateMethod(new \RectorPrefix20210527\Symfony\Component\Console\Input\StringInput(''), 'tokenize', [$process]);
    }
    /**
     * @return void
     */
