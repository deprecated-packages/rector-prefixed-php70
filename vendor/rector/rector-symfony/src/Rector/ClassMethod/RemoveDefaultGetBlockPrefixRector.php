...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node)
    {
        ...
        if (\RectorPrefix20210531\Nette\Utils\Strings::endsWith($shortClassName, 'Type')) {
            $shortClassName = (string) \RectorPrefix20210531\Nette\Utils\Strings::before($shortClassName, 'Type');
        }
        $stringy = new \RectorPrefix20210531\Stringy\Stringy($shortClassName);
