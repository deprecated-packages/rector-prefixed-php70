...
final class ServiceMapFactory
{
    ...
    {
        $data = \RectorPrefix20210504\Nette\Utils\Json::decode(\RectorPrefix20210504\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210504\Nette\Utils\Json::FORCE_ARRAY);
