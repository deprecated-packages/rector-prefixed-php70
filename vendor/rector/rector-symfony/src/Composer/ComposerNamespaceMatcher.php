...
final class ComposerNamespaceMatcher
{
    ...
    public function __construct(\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \RectorPrefix20210616\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory)
    {
