...
final class OnFormVariableMethodCallsCollector
{
    ...
    public function __construct(\RectorPrefix20210519\Symplify\Astral\NodeTraverser\SimpleCallableNodeTraverser $simpleCallableNodeTraverser, \Rector\NodeTypeResolver\NodeTypeResolver $nodeTypeResolver, \Rector\Core\PhpParser\Comparing\NodeComparator $nodeComparator)
    {
    ...
    private function resolveNewFormVariable(\PhpParser\Node\Stmt\ClassMethod $classMethod)
    {
        ...
        $this->simpleCallableNodeTraverser->traverseNodesWithCallable((array) $classMethod->getStmts(), function (\PhpParser\Node $node) use(&$newFormVariable) {
