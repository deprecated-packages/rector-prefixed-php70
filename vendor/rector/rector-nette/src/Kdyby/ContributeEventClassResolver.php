...
final class ContributeEventClassResolver
{
    ...
    /**
     * @param \PhpParser\Node\Identifier|null $identifier
     */
    private function resolveParamType($identifier, \PhpParser\Node\Param $param) : string
    {
        if ($identifier === null) {
    ...
    /**
     * @param \PhpParser\Node|null $paramTypeNode
     * @return string|null
     */
    private function matchGetterMethodBlueprintMethodName(\Rector\Nette\Kdyby\ValueObject\EventAndListenerTree $eventAndListenerTree, $paramTypeNode)
    {
     ...
     * @return string|null
     */
    private function matchByParamName(\Rector\Nette\Kdyby\ValueObject\EventAndListenerTree $eventAndListenerTree, $paramName)
    {
        $getterMethodBlueprints = $eventAndListenerTree->getGetterMethodBlueprints();
        foreach ($getterMethodBlueprints as $getterMethodBlueprint) {
