...
final class GetSubscribedEventsArrayManipulator
{
    ...
    public function __construct(\RectorPrefix20210520\Symplify\Astral\NodeTraverser\SimpleCallableNodeTraverser $simpleCallableNodeTraverser, \Rector\Core\PhpParser\Node\Value\ValueResolver $valueResolver)
    {
    ...
    public function change(\PhpParser\Node\Expr\Array_ $array)
    {
        ...
        $this->simpleCallableNodeTraverser->traverseNodesWithCallable($arrayItems, function (\PhpParser\Node $node) {
