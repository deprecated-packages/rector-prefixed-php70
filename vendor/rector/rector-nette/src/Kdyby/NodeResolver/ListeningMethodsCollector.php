...
final class ListeningMethodsCollector
{
    ...
    public function __construct(\RectorPrefix20210519\Symplify\Astral\NodeTraverser\SimpleCallableNodeTraverser $simpleCallableNodeTraverser, \Rector\Nette\Kdyby\Naming\EventClassNaming $eventClassNaming, \Rector\Core\PhpParser\Node\Value\ValueResolver $valueResolver)
    {
    ...
    private function resolveCustomClassMethodAndEventClass(\PhpParser\Node\Expr\ArrayItem $arrayItem, \PhpParser\Node\Stmt\Class_ $class, string $eventClass)
    {
        ...
        if (\RectorPrefix20210519\Nette\Utils\Strings::contains($eventClass, '::')) {
