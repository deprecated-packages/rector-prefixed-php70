...
use RectorPrefix20210504\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection;
...
final class ComposerAutoloadedDirectoryProvider
{
     ...
     * @var string[]
     */
    const AUTOLOAD_SECTIONS = [\RectorPrefix20210504\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD, \RectorPrefix20210504\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD_DEV];
    /**
     * @var string
     */
    ...
    public function __construct(\RectorPrefix20210504\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    private function loadComposerJsonArray() : array
    {
        ...
        return \RectorPrefix20210504\Nette\Utils\Json::decode($composerFileContent, \RectorPrefix20210504\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
