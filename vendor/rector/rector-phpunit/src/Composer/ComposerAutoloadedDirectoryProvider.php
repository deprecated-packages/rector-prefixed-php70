...
use RectorPrefix20210503\Nette\Utils\Json;
use Rector\Testing\PHPUnit\StaticPHPUnitEnvironment;
use RectorPrefix20210503\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection;
...
final class ComposerAutoloadedDirectoryProvider
{
     ...
     * @var string[]
     */
    const AUTOLOAD_SECTIONS = [\RectorPrefix20210503\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD, \RectorPrefix20210503\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD_DEV];
    /**
     * @var string
     */
    ...
    public function __construct(\RectorPrefix20210503\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    private function loadComposerJsonArray() : array
    {
        ...
        return \RectorPrefix20210503\Nette\Utils\Json::decode($composerFileContent, \RectorPrefix20210503\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
