...
use RectorPrefix20210503\Prophecy\Argument;
use RectorPrefix20210503\Prophecy\PhpUnit\ProphecyTrait;
use RectorPrefix20210503\Prophecy\Prophecy\ObjectProphecy;
use Rector\RectorInstaller\Filesystem;
use Rector\RectorInstaller\PluginInstaller;
/**
 * @covers PluginInstaller
 */
final class PluginInstallerTest extends \RectorPrefix20210503\PHPUnit\Framework\TestCase
{
    use ProphecyTrait;
    /**
     * @var string
    ...
    protected function setUp()
    {
        ...
        $this->localRepository = $this->prophesize(\RectorPrefix20210503\Composer\Repository\InstalledRepositoryInterface::class);
        $this->io = $this->prophesize(\RectorPrefix20210503\Composer\IO\IOInterface::class);
    ...
    public function testPackagesInstalled()
    {
        ...
        $nonRectorExtensionPackage = $this->prophesize(\RectorPrefix20210503\Composer\Package\PackageInterface::class);
        $nonRectorExtensionPackageWithExtra = $this->prophesize(\RectorPrefix20210503\Composer\Package\PackageInterface::class);
        ...
        $this->filesystem->hashEquals(self::FILE_HASH, \RectorPrefix20210503\Prophecy\Argument::any())->willReturn(\false);
        $this->filesystem->writeFile($this->configurationFile, \RectorPrefix20210503\Prophecy\Argument::any())->shouldBeCalledOnce();
