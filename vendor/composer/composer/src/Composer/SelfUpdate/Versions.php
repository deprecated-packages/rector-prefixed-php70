 ...
 */
namespace RectorPrefix20210503\Composer\SelfUpdate;
...
class Versions
{
    ...
    public function __construct(\RectorPrefix20210503\Composer\Config $config, \RectorPrefix20210503\Composer\Util\HttpDownloader $httpDownloader)
    {
    ...
    public function getChannel()
    {
        ...
        if (\file_exists($channelFile)) {
            ...
            if (\in_array($channel, array('stable', 'preview', 'snapshot'), \true)) {
