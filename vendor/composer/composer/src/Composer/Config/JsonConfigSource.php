 ...
 */
namespace RectorPrefix20210503\Composer\Config;
 ...
 */
class JsonConfigSource implements \RectorPrefix20210503\Composer\Config\ConfigSourceInterface
{
    /**
     * @var JsonFile
     */
     ...
     */
    public function __construct(\RectorPrefix20210503\Composer\Json\JsonFile $file, $authConfig = \false)
    {
        $this->file = $file;
    ...
    protected function manipulateJson($method, $args, $fallback)
    {
        ...
        try {
            $this->file->validateSchema(\RectorPrefix20210503\Composer\Json\JsonFile::LAX_SCHEMA);
        ...
        if ($newFile) {
            \RectorPrefix20210503\Composer\Util\Silencer::call('chmod', $this->file->getPath(), 0600);
        }
    }
    /**
