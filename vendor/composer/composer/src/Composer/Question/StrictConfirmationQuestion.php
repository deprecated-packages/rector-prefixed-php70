 ...
 */
namespace RectorPrefix20210503\Composer\Question;
 ...
 */
class StrictConfirmationQuestion extends \RectorPrefix20210503\Symfony\Component\Console\Question\Question
{
     ...
     */
    public function __construct($question, $default = \true, $trueAnswerRegex = '/^y(?:es)?$/i', $falseAnswerRegex = '/^no?$/i')
    {
    ...
    private function getDefaultValidator()
    {
        return function ($answer) {
            if (!\is_bool($answer)) {
                throw new \RectorPrefix20210503\Symfony\Component\Console\Exception\InvalidArgumentException('Please answer yes, y, no, or n.');
            }
            return $answer;
        };
    }
