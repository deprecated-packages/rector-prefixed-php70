...
class Url
{
     ...
     */
    public static function updateDistReference(\RectorPrefix20210503\Composer\Config $config, $url, $ref)
    {
     ...
     * @return string
     */
    public static function getOrigin(\RectorPrefix20210503\Composer\Config $config, $url)
    {
        ...
        if (\is_array($config->get('gitlab-domains')) && \false === \strpos($origin, '/') && !\in_array($origin, $config->get('gitlab-domains'))) {
