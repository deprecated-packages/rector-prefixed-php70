...
class Loop
{
    ...
    /** @var int */
    private $waitIndex = 0;
    public function __construct(\RectorPrefix20210503\Composer\Util\HttpDownloader $httpDownloader, \RectorPrefix20210503\Composer\Util\ProcessExecutor $processExecutor = null)
    {
    ...
    public function wait(array $promises, \RectorPrefix20210503\Symfony\Component\Console\Helper\ProgressBar $progress = null)
    {
        /** @var \Exception|null */
        $uncaught = null;
        \RectorPrefix20210503\React\Promise\all($promises)->then(function () {
