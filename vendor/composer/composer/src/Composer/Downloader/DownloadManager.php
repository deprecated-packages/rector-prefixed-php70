...
class DownloadManager
{
     ...
     */
    public function __construct(\RectorPrefix20210503\Composer\IO\IOInterface $io, $preferSource = \false, \RectorPrefix20210503\Composer\Util\Filesystem $filesystem = null)
    {
        $this->io = $io;
     ...
     * @return DownloadManager
     */
    public function setDownloader($type, \RectorPrefix20210503\Composer\Downloader\DownloaderInterface $downloader)
    {
     ...
     */
    public function getDownloaderForPackage(\RectorPrefix20210503\Composer\Package\PackageInterface $package)
    {
    ...
    public function getDownloaderType(\RectorPrefix20210503\Composer\Downloader\DownloaderInterface $downloader)
    {
     ...
     */
    public function download(\RectorPrefix20210503\Composer\Package\PackageInterface $package, $targetDir, \RectorPrefix20210503\Composer\Package\PackageInterface $prevPackage = null)
    {
        ...
        $download = function ($retry = \false) use(&$sources, $io, $package, $self, $targetDir, &$download, $prevPackage) {
            ...
            if (!$downloader) {
                return \RectorPrefix20210503\React\Promise\resolve();
            }
            $handleError = function ($e) use($sources, $source, $package, $io, $download) {
                if ($e instanceof \RuntimeException && !$e instanceof \RectorPrefix20210503\Composer\Exception\IrrecoverableDownloadException) {
                    if (!$sources) {
                        throw $e;
                    }
            ...
            if (!$result instanceof \RectorPrefix20210503\React\Promise\PromiseInterface) {
                return \RectorPrefix20210503\React\Promise\resolve($result);
            }
     ...
     */
    public function prepare($type, \RectorPrefix20210503\Composer\Package\PackageInterface $package, $targetDir, \RectorPrefix20210503\Composer\Package\PackageInterface $prevPackage = null)
    {
        $targetDir = $this->normalizeTargetDir($targetDir);
     ...
     * @return PromiseInterface|null
     */
    public function install(\RectorPrefix20210503\Composer\Package\PackageInterface $package, $targetDir)
    {
        $targetDir = $this->normalizeTargetDir($targetDir);
        $downloader = $this->getDownloaderForPackage($package);
        if ($downloader) {
     ...
     * @return PromiseInterface|null
     */
    public function update(\RectorPrefix20210503\Composer\Package\PackageInterface $initial, \RectorPrefix20210503\Composer\Package\PackageInterface $target, $targetDir)
    {
        $targetDir = $this->normalizeTargetDir($targetDir);
     ...
     * @return PromiseInterface|null
     */
    public function remove(\RectorPrefix20210503\Composer\Package\PackageInterface $package, $targetDir)
    {
        $targetDir = $this->normalizeTargetDir($targetDir);
        $downloader = $this->getDownloaderForPackage($package);
        if ($downloader) {
     ...
     * @return PromiseInterface|null
     */
    public function cleanup($type, \RectorPrefix20210503\Composer\Package\PackageInterface $package, $targetDir, \RectorPrefix20210503\Composer\Package\PackageInterface $prevPackage = null)
    {
        $targetDir = $this->normalizeTargetDir($targetDir);
        $downloader = $this->getDownloaderForPackage($package);
        if ($downloader) {
     ...
     * @return string
     */
    protected function resolvePackageInstallPreference(\RectorPrefix20210503\Composer\Package\PackageInterface $package)
    {
     ...
     * @return string[]
     */
    private function getAvailableSources(\RectorPrefix20210503\Composer\Package\PackageInterface $package, \RectorPrefix20210503\Composer\Package\PackageInterface $prevPackage = null)
    {
