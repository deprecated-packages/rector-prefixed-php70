 ...
 */
class DependsCommand extends \RectorPrefix20210503\Composer\Command\BaseDependencyCommand
{
    /**
    ...
    {
        parent::configure();
        $this->setName('depends')->setAliases(array('why'))->setDescription('Shows which packages cause the given package to be installed.')->setHelp(<<<EOT
