...
class SuggestedPackagesReporter
{
    ...
    {
        $this->suggestedPackages[] = array('source' => $source, 'target' => $target, 'reason' => $reason);
        return $this;
    }
    /**
     ...
     * @return SuggestedPackagesReporter
     */
    public function addSuggestionsFromPackage(\RectorPrefix20210503\Composer\Package\PackageInterface $package)
    {
     ...
     * @return SuggestedPackagesReporter
     */
    public function output($mode, \RectorPrefix20210503\Composer\Repository\InstalledRepository $installedRepo = null, \RectorPrefix20210503\Composer\Package\PackageInterface $onlyDependentsOf = null)
    {
     ...
     * @return SuggestedPackagesReporter
     */
    public function outputMinimalistic(\RectorPrefix20210503\Composer\Repository\InstalledRepository $installedRepo = null, \RectorPrefix20210503\Composer\Package\PackageInterface $onlyDependentsOf = null)
    {
        $suggestedPackages = $this->getFilteredSuggestions($installedRepo, $onlyDependentsOf);
     ...
     * @return array[]
     */
    private function getFilteredSuggestions(\RectorPrefix20210503\Composer\Repository\InstalledRepository $installedRepo = null, \RectorPrefix20210503\Composer\Package\PackageInterface $onlyDependentsOf = null)
    {
    ...
    {
        return \RectorPrefix20210503\Symfony\Component\Console\Formatter\OutputFormatter::escape($this->removeControlCharacters($string));
    }
    /**
     * @param  string $string
     * @return string
    ...
    {
        return \preg_replace('/[[:cntrl:]]/', '', \str_replace("\n", ' ', $string));
    }
}
