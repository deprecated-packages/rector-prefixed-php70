...
class JsonFile
{
     ...
     */
    public function __construct($path, \RectorPrefix20210503\Composer\Util\HttpDownloader $httpDownloader = null, \RectorPrefix20210503\Composer\IO\IOInterface $io = null)
    {
        $this->path = $path;
    ...
    public function validateSchema($schema = self::STRICT_SCHEMA, $schemaFile = null)
    {
        ...
        if ($schema === self::LAX_SCHEMA) {
            $schemaData->additionalProperties = \true;
            $schemaData->required = array();
        }
        $validator = new \RectorPrefix20210503\JsonSchema\Validator();
        ...
        if (!$validator->isValid()) {
            ...
            throw new \RectorPrefix20210503\Composer\Json\JsonValidationException('"' . $this->path . '" does not match the expected JSON schema', $errors);
        }
        return \true;
    }
    /**
    ...
    public static function encode($data, $options = 448)
    {
        ...
        return \RectorPrefix20210503\Composer\Json\JsonFormatter::format($json, $unescapeUnicode, $unescapeSlashes);
    }
    /**
    ...
    {
        $parser = new \RectorPrefix20210503\Seld\JsonLint\JsonParser();
        ...
        throw new \RectorPrefix20210503\Seld\JsonLint\ParsingException('"' . $file . '" does not contain valid JSON' . "\n" . $result->getMessage(), $result->getDetails());
    }
}
