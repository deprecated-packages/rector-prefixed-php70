 ...
 */
class PreFileDownloadEvent extends \RectorPrefix20210503\Composer\EventDispatcher\Event
{
    /**
     * @var HttpDownloader
     */
     ...
     * @param mixed          $context
     */
    public function __construct($name, \RectorPrefix20210503\Composer\Util\HttpDownloader $httpDownloader, $processedUrl, $type, $context = null)
    {
