 ...
 */
class PostFileDownloadEvent extends \RectorPrefix20210503\Composer\EventDispatcher\Event
{
    /**
     * @var string
     */
     ...
     */
    public function __construct($name, $fileName, $checksum, $url, \RectorPrefix20210503\Composer\Package\PackageInterface $package)
    {
