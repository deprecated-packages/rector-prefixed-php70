...
abstract class BaseIO implements \RectorPrefix20210503\Composer\IO\IOInterface
{
     ...
     * {@inheritDoc}
     */
    public function loadConfiguration(\RectorPrefix20210503\Composer\Config $config)
    {
        ...
        \RectorPrefix20210503\Composer\Util\ProcessExecutor::setTimeout((int) $config->get('process-timeout'));
    }
    /**
     * System is unusable.
     *
    ...
    {
        return $this->log(\RectorPrefix20210503\Psr\Log\LogLevel::EMERGENCY, $message, $context);
    }
    /**
    ...
    {
        return $this->log(\RectorPrefix20210503\Psr\Log\LogLevel::ALERT, $message, $context);
    }
    /**
     * Critical conditions.
     *
    ...
    {
        return $this->log(\RectorPrefix20210503\Psr\Log\LogLevel::CRITICAL, $message, $context);
    }
    /**
    ...
    {
        return $this->log(\RectorPrefix20210503\Psr\Log\LogLevel::ERROR, $message, $context);
    }
    /**
    ...
    {
        return $this->log(\RectorPrefix20210503\Psr\Log\LogLevel::WARNING, $message, $context);
    }
    /**
    ...
    {
        return $this->log(\RectorPrefix20210503\Psr\Log\LogLevel::NOTICE, $message, $context);
    }
    /**
     * Interesting events.
     *
    ...
    {
        return $this->log(\RectorPrefix20210503\Psr\Log\LogLevel::INFO, $message, $context);
    }
    /**
    ...
    {
        return $this->log(\RectorPrefix20210503\Psr\Log\LogLevel::DEBUG, $message, $context);
    }
    /**
    ...
    {
        if (\in_array($level, array(\RectorPrefix20210503\Psr\Log\LogLevel::EMERGENCY, \RectorPrefix20210503\Psr\Log\LogLevel::ALERT, \RectorPrefix20210503\Psr\Log\LogLevel::CRITICAL, \RectorPrefix20210503\Psr\Log\LogLevel::ERROR))) {
            $this->writeError('<error>' . $message . '</error>');
        } elseif ($level === \RectorPrefix20210503\Psr\Log\LogLevel::WARNING) {
            $this->writeError('<warning>' . $message . '</warning>');
        } elseif ($level === \RectorPrefix20210503\Psr\Log\LogLevel::NOTICE) {
            $this->writeError('<info>' . $message . '</info>', \true, self::VERBOSE);
        } elseif ($level === \RectorPrefix20210503\Psr\Log\LogLevel::INFO) {
