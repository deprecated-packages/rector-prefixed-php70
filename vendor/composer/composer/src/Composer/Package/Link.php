...
class Link
{
     ...
     * @var string[]
     */
    public static $TYPES = array(self::TYPE_REQUIRE, self::TYPE_DEV_REQUIRE, self::TYPE_PROVIDE, self::TYPE_CONFLICT, self::TYPE_REPLACE);
    /**
     * @var string
     */
    protected $source;
     ...
     */
    public function __construct($source, $target, \RectorPrefix20210503\Composer\Semver\Constraint\ConstraintInterface $constraint, $description = 'relates to', $prettyConstraint = null)
    {
     ...
     * @return string
     */
    public function getPrettyString(\RectorPrefix20210503\Composer\Package\PackageInterface $sourcePackage)
    {
