...
use RectorPrefix20210503\Composer\Repository\Vcs\HgDriver;
use RectorPrefix20210503\Composer\IO\NullIO;
use RectorPrefix20210503\Composer\Semver\VersionParser as SemverVersionParser;
...
class VersionGuesser
{
     ...
     */
    public function __construct(\RectorPrefix20210503\Composer\Config $config, \RectorPrefix20210503\Composer\Util\ProcessExecutor $process, \RectorPrefix20210503\Composer\Semver\VersionParser $versionParser)
    {
        $this->config = $config;
    ...
    private function guessGitVersion(array $packageConfig, $path)
    {
        ...
        if (!$commit) {
            $command = 'git log --pretty="%H" -n1 HEAD' . \RectorPrefix20210503\Composer\Util\Git::getNoShowSignatureFlag($this->process);
    ...
    private function guessHgVersion(array $packageConfig, $path)
    {
        ...
        if (0 === $this->process->execute('hg branch', $output, $path)) {
            ...
            if (\RectorPrefix20210503\Composer\Package\Version\VersionParser::DEFAULT_BRANCH_ALIAS === $version) {
            ...
            $io = new \RectorPrefix20210503\Composer\IO\NullIO();
            $driver = new \RectorPrefix20210503\Composer\Repository\Vcs\HgDriver(array('url' => $path), $io, $this->config, new \RectorPrefix20210503\Composer\Util\HttpDownloader($io, $this->config), $this->process);
