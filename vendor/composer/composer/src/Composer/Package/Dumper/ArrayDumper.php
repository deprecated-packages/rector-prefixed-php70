 ...
 */
namespace RectorPrefix20210503\Composer\Package\Dumper;
...
class ArrayDumper
{
    public function dump(\RectorPrefix20210503\Composer\Package\PackageInterface $package)
    {
        ...
        if ($package instanceof \RectorPrefix20210503\Composer\Package\CompletePackageInterface) {
            $keys = array('scripts', 'license', 'authors', 'description', 'homepage', 'keywords', 'repositories', 'support', 'funding');
            $data = $this->dumpValues($package, $keys, $data);
    ...
    private function dumpValues(\RectorPrefix20210503\Composer\Package\PackageInterface $package, array $keys, array $data)
    {
