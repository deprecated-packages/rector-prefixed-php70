...
class ArchiveManager
{
     ...
     */
    public function __construct(\RectorPrefix20210503\Composer\Downloader\DownloadManager $downloadManager, \RectorPrefix20210503\Composer\Util\Loop $loop)
    {
     ...
     */
    public function addArchiver(\RectorPrefix20210503\Composer\Package\Archiver\ArchiverInterface $archiver)
    {
     ...
     */
    public function getPackageFilename(\RectorPrefix20210503\Composer\Package\PackageInterface $package)
    {
     ...
     */
    public function archive(\RectorPrefix20210503\Composer\Package\PackageInterface $package, $format, $targetDir, $fileName = null, $ignoreFilters = \false)
    {
        if (empty($format)) {
        ...
        if ($package instanceof \RectorPrefix20210503\Composer\Package\RootPackageInterface) {
            ...
            if (\file_exists($composerJsonPath = $sourcePath . '/composer.json')) {
                $jsonFile = new \RectorPrefix20210503\Composer\Json\JsonFile($composerJsonPath);
