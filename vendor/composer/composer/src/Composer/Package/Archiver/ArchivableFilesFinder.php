...
class ArchivableFilesFinder extends \FilterIterator
{
    ...
    public function __construct($sources, array $excludes, $ignoreFilters = \false)
    {
        ...
        if ($ignoreFilters) {
            ...
            $filters = array(new \RectorPrefix20210503\Composer\Package\Archiver\HgExcludeFilter($sources), new \RectorPrefix20210503\Composer\Package\Archiver\GitExcludeFilter($sources), new \RectorPrefix20210503\Composer\Package\Archiver\ComposerExcludeFilter($sources, $excludes));
        }
        $this->finder = new \RectorPrefix20210503\Symfony\Component\Finder\Finder();
        ...
        $this->finder->in($sources)->filter($filter)->ignoreVCS(\true)->ignoreDotFiles(\false);
