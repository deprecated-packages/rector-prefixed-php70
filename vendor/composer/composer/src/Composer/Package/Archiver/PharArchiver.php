 ...
 */
class PharArchiver implements \RectorPrefix20210503\Composer\Package\Archiver\ArchiverInterface
{
    ...
    public function archive($sources, $target, $format, array $excludes = array(), $ignoreFilters = \false)
    {
        ...
        try {
            ...
            $filesOnly = new \RectorPrefix20210503\Composer\Package\Archiver\ArchivableFilesFilter($files);
