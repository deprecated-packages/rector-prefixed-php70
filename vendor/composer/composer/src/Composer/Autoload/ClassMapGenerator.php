...
class ClassMapGenerator
{
     ...
     */
    public static function createMap($path, $excluded = null, \RectorPrefix20210503\Composer\IO\IOInterface $io = null, $namespace = null, $autoloadType = null, &$scannedFiles = array())
    {
        $basePath = $path;
        if (\is_string($path)) {
            if (\is_file($path)) {
                ...
                $path = \RectorPrefix20210503\Symfony\Component\Finder\Finder::create()->files()->followLinks()->name('/\\.(php|inc|hh)$/')->in($path);
            } else {
