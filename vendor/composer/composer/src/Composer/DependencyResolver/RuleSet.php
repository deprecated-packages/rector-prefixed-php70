...
class RuleSet implements \IteratorAggregate, \Countable
{
     ...
     */
    public $ruleById;
    protected static $types = array(255 => 'UNKNOWN', self::TYPE_PACKAGE => 'PACKAGE', self::TYPE_REQUEST => 'REQUEST', self::TYPE_LEARNED => 'LEARNED');
    protected $rules;
    ...
    public function add(\RectorPrefix20210503\Composer\DependencyResolver\Rule $rule, $type)
    {
    ...
    {
        return new \RectorPrefix20210503\Composer\DependencyResolver\RuleSetIterator($this->getRules());
    }
    public function getIteratorFor($types)
    {
        ...
        return new \RectorPrefix20210503\Composer\DependencyResolver\RuleSetIterator($rules);
    }
    ...
    public function getPrettyString(\RectorPrefix20210503\Composer\Repository\RepositorySet $repositorySet = null, \RectorPrefix20210503\Composer\DependencyResolver\Request $request = null, \RectorPrefix20210503\Composer\DependencyResolver\Pool $pool = null, $isVerbose = \false)
    {
        $string = "\n";
