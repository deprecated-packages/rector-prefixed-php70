...
class Request
{
    ...
    public function __construct(\RectorPrefix20210503\Composer\Repository\LockArrayRepository $lockedRepository = null)
    {
        $this->lockedRepository = $lockedRepository;
    }
    public function requireName($packageName, \RectorPrefix20210503\Composer\Semver\Constraint\ConstraintInterface $constraint = null)
    {
        $packageName = \strtolower($packageName);
        if ($constraint === null) {
            $constraint = new \RectorPrefix20210503\Composer\Semver\Constraint\MatchAllConstraint();
        }
     ...
     */
    public function fixPackage(\RectorPrefix20210503\Composer\Package\PackageInterface $package)
    {
     ...
     */
    public function lockPackage(\RectorPrefix20210503\Composer\Package\PackageInterface $package)
    {
     ...
     */
    public function fixLockedPackage(\RectorPrefix20210503\Composer\Package\PackageInterface $package)
    {
        $this->fixedPackages[\spl_object_hash($package)] = $package;
        $this->fixedLockedPackages[\spl_object_hash($package)] = $package;
    }
    public function unlockPackage(\RectorPrefix20210503\Composer\Package\PackageInterface $package)
    {
    ...
    public function isFixedPackage(\RectorPrefix20210503\Composer\Package\PackageInterface $package)
    {
    ...
    public function isLockedPackage(\RectorPrefix20210503\Composer\Package\PackageInterface $package)
    {
