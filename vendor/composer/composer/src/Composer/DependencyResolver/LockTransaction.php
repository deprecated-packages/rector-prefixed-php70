 ...
 * @internal
 */
class LockTransaction extends \RectorPrefix20210503\Composer\DependencyResolver\Transaction
{
    /**
    ...
    public function __construct(\RectorPrefix20210503\Composer\DependencyResolver\Pool $pool, $presentMap, $unlockableMap, $decisions)
    {
    ...
    public function setResultPackages(\RectorPrefix20210503\Composer\DependencyResolver\Pool $pool, \RectorPrefix20210503\Composer\DependencyResolver\Decisions $decisions)
    {
    ...
    public function setNonDevPackages(\RectorPrefix20210503\Composer\DependencyResolver\LockTransaction $extractionResult)
    {
    ...
    public function getNewLockPackages($devMode, $updateMirrors = \false)
    {
        ...
        foreach ($this->resultPackages[$devMode ? 'dev' : 'non-dev'] as $package) {
            if (!$package instanceof \RectorPrefix20210503\Composer\Package\AliasPackage && !$package instanceof \RectorPrefix20210503\Composer\Package\RootAliasPackage) {
