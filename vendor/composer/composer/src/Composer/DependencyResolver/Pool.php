...
class Pool implements \Countable
{
     ...
     */
    public function whatProvides($name, \RectorPrefix20210503\Composer\Semver\Constraint\ConstraintInterface $constraint = null)
    {
     ...
     * @return bool
     */
    public function match($candidate, $name, \RectorPrefix20210503\Composer\Semver\Constraint\ConstraintInterface $constraint = null)
    {
        $candidateName = $candidate->getName();
        $candidateVersion = $candidate->getVersion();
        if ($candidateName === $name) {
            return $constraint === null || \RectorPrefix20210503\Composer\Semver\CompilingMatcher::match($constraint, \RectorPrefix20210503\Composer\Semver\Constraint\Constraint::OP_EQ, $candidateVersion);
        }
    ...
    public function isUnacceptableFixedOrLockedPackage(\RectorPrefix20210503\Composer\Package\PackageInterface $package)
    {
