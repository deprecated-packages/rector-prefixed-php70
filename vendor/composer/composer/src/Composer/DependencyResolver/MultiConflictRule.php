 ...
 */
class MultiConflictRule extends \RectorPrefix20210503\Composer\DependencyResolver\Rule
{
    protected $literals;
    /**
    ...
    {
        $data = \unpack('ihash', \md5('c:' . \implode(',', $this->literals), \true));
        return $data['hash'];
    }
    /**
     ...
     */
    public function equals(\RectorPrefix20210503\Composer\DependencyResolver\Rule $rule)
    {
