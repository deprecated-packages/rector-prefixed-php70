...
class RuleWatchNode
{
     ...
     */
    public function watch2OnHighest(\RectorPrefix20210503\Composer\DependencyResolver\Decisions $decisions)
    {
        $literals = $this->rule->getLiterals();
        // if there are only 2 elements, both are being watched anyway
        if (\count($literals) < 3 || $this->rule instanceof \RectorPrefix20210503\Composer\DependencyResolver\MultiConflictRule) {
            return;
        }
        $watchLevel = 0;
