...
class SolverProblemsException extends \RuntimeException
{
    ...
    public function getPrettyString(\RectorPrefix20210503\Composer\Repository\RepositorySet $repositorySet, \RectorPrefix20210503\Composer\DependencyResolver\Request $request, \RectorPrefix20210503\Composer\DependencyResolver\Pool $pool, $isVerbose, $isDevExtraction = \false)
    {
        ...
        if (!\class_exists('RectorPrefix20210503\\PHPUnit\\Framework\\TestCase', \false)) {
    ...
    {
        $paths = \RectorPrefix20210503\Composer\Util\IniHelper::getAll();
