...
use RectorPrefix20210503\Composer\Repository\Vcs\VcsDriverInterface;
...
use RectorPrefix20210503\Composer\Package\Loader\InvalidPackageException;
 ...
 */
class VcsRepository extends \RectorPrefix20210503\Composer\Repository\ArrayRepository implements \RectorPrefix20210503\Composer\Repository\ConfigurableRepositoryInterface
{
    protected $url;
    ...
    public function __construct(array $repoConfig, \RectorPrefix20210503\Composer\IO\IOInterface $io, \RectorPrefix20210503\Composer\Config $config, \RectorPrefix20210503\Composer\Util\HttpDownloader $httpDownloader, \RectorPrefix20210503\Composer\EventDispatcher\EventDispatcher $dispatcher = null, \RectorPrefix20210503\Composer\Util\ProcessExecutor $process = null, array $drivers = null, \RectorPrefix20210503\Composer\Repository\VersionCacheInterface $versionCache = null)
    {
        parent::__construct();
        $this->drivers = $drivers ?: array(
            'github' => 'RectorPrefix20210503\\Composer\\Repository\\Vcs\\GitHubDriver',
            'gitlab' => 'RectorPrefix20210503\\Composer\\Repository\\Vcs\\GitLabDriver',
            'git-bitbucket' => 'RectorPrefix20210503\\Composer\\Repository\\Vcs\\GitBitbucketDriver',
            'git' => 'RectorPrefix20210503\\Composer\\Repository\\Vcs\\GitDriver',
            'hg-bitbucket' => 'RectorPrefix20210503\\Composer\\Repository\\Vcs\\HgBitbucketDriver',
            'hg' => 'RectorPrefix20210503\\Composer\\Repository\\Vcs\\HgDriver',
            'perforce' => 'RectorPrefix20210503\\Composer\\Repository\\Vcs\\PerforceDriver',
            'fossil' => 'RectorPrefix20210503\\Composer\\Repository\\Vcs\\FossilDriver',
            // svn must be last because identifying a subversion server for sure is practically impossible
            'svn' => 'RectorPrefix20210503\\Composer\\Repository\\Vcs\\SvnDriver',
        );
        ...
        $this->processExecutor = $process ?: new \RectorPrefix20210503\Composer\Util\ProcessExecutor($io);
    }
    public function getRepoName()
    {
        ...
        return 'vcs repo (' . $driverType . ' ' . \RectorPrefix20210503\Composer\Util\Url::sanitize($this->url) . ')';
    }
    public function getRepoConfig()
    {
        return $this->repoConfig;
    }
    public function setLoader(\RectorPrefix20210503\Composer\Package\Loader\LoaderInterface $loader)
    {
        $this->loader = $loader;
    }
    ...
    protected function initialize()
    {
        ...
        foreach ($driver->getTags() as $tag => $identifier) {
            ...
            try {
                ...
                if ($isVeryVerbose) {
                    $this->io->writeError('<warning>Skipped tag ' . $tag . ', ' . ($e instanceof \RectorPrefix20210503\Composer\Downloader\TransportException ? 'no composer file was found (' . $e->getCode() . ' HTTP status code)' : $e->getMessage()) . '</warning>');
                }
                continue;
            }
        }
        ...
        foreach ($branches as $branch => $identifier) {
            ...
            if (\strpos($parsedBranch, 'dev-') === 0 || \RectorPrefix20210503\Composer\Package\Version\VersionParser::DEFAULT_BRANCH_ALIAS === $parsedBranch) {
                $version = 'dev-' . $branch;
            } else {
            ...
            try {
                ...
                if ($this->loader instanceof \RectorPrefix20210503\Composer\Package\Loader\ValidatingArrayLoader && $this->loader->getWarnings()) {
                    throw new \RectorPrefix20210503\Composer\Package\Loader\InvalidPackageException($this->loader->getErrors(), $this->loader->getWarnings(), $packageData);
                }
        ...
        if (!$this->getPackages()) {
            throw new \RectorPrefix20210503\Composer\Repository\InvalidRepositoryException('No valid composer.json was found in any branch or tag of ' . $this->url . ', could not load a package from it.');
        }
    }
    protected function preProcess(\RectorPrefix20210503\Composer\Repository\Vcs\VcsDriverInterface $driver, array $data, $identifier)
    {
    ...
    private function getCachedPackageVersion($version, $identifier, $isVerbose, $isVeryVerbose, $isDefaultBranch = \false)
    {
        ...
        if ($cachedPackage) {
            ...
            if ($existingPackage = $this->findPackage($cachedPackage['name'], new \RectorPrefix20210503\Composer\Semver\Constraint\Constraint('=', $cachedPackage['version_normalized']))) {
                if ($isVeryVerbose) {
