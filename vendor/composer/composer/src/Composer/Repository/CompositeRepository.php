 ...
 */
class CompositeRepository implements \RectorPrefix20210503\Composer\Repository\RepositoryInterface
{
    /**
    ...
    public function loadPackages(array $packageMap, array $acceptableStabilities, array $stabilityFlags, array $alreadyLoaded = array())
    {
        ...
        return array('packages' => $packages ? \call_user_func_array('array_merge', $packages) : array(), 'namesFound' => $namesFound ? \array_unique(\call_user_func_array('array_merge', $namesFound)) : array());
    }
    /**
     * {@inheritdoc}
     */
