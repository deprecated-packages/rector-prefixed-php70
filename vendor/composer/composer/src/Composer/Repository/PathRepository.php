 ...
 */
class PathRepository extends \RectorPrefix20210503\Composer\Repository\ArrayRepository implements \RectorPrefix20210503\Composer\Repository\ConfigurableRepositoryInterface
{
    /**
     * @var ArrayLoader
     */
     ...
     * @param Config      $config
     */
    public function __construct(array $repoConfig, \RectorPrefix20210503\Composer\IO\IOInterface $io, \RectorPrefix20210503\Composer\Config $config)
    {
        ...
        $this->url = \RectorPrefix20210503\Composer\Util\Platform::expandPath($repoConfig['url']);
        $this->process = new \RectorPrefix20210503\Composer\Util\ProcessExecutor($io);
        $this->versionGuesser = new \RectorPrefix20210503\Composer\Package\Version\VersionGuesser($config, $this->process, new \RectorPrefix20210503\Composer\Package\Version\VersionParser());
    ...
    {
        return 'path repo (' . \RectorPrefix20210503\Composer\Util\Url::sanitize($this->repoConfig['url']) . ')';
    }
    ...
    protected function initialize()
    {
        ...
        foreach ($urlMatches as $url) {
            ...
            $package = \RectorPrefix20210503\Composer\Json\JsonFile::parseJson($json, $composerFilePath);
            $package['dist'] = array('type' => 'path', 'url' => $url, 'reference' => \sha1($json . \serialize($this->options)));
            ...
            $output = '';
            if (\is_dir($path . \DIRECTORY_SEPARATOR . '.git') && 0 === $this->process->execute('git log -n1 --pretty=%H' . \RectorPrefix20210503\Composer\Util\Git::getNoShowSignatureFlag($this->process), $output, $path)) {
