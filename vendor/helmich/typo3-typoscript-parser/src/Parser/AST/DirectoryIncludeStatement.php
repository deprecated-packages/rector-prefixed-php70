 ...
 */
class DirectoryIncludeStatement extends \RectorPrefix20210526\Helmich\TypoScriptParser\Parser\AST\IncludeStatement
{
    /**
     ...
     */
    public function __construct(string $directory, $extensions, $condition, int $sourceLine)
    {
