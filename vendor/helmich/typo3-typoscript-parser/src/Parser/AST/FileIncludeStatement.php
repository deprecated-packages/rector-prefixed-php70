 ...
 */
class FileIncludeStatement extends \RectorPrefix20210522\Helmich\TypoScriptParser\Parser\AST\IncludeStatement
{
    /**
     ...
     */
    public function __construct(string $filename, bool $newSyntax, $condition, int $sourceLine)
    {
