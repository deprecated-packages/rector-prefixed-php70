...
class Traverser
{
    ...
    public function __construct(array $statements)
    {
        ...
        $this->visitors = new \RectorPrefix20210616\Helmich\TypoScriptParser\Parser\Traverser\AggregatingVisitor();
    }
    /**
     * @param Visitor $visitor
     * @return void
     */
    public function addVisitor(\RectorPrefix20210616\Helmich\TypoScriptParser\Parser\Traverser\Visitor $visitor)
    {
