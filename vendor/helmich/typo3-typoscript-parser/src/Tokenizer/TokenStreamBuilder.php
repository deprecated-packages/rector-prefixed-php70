...
class TokenStreamBuilder
{
     ...
     * @return void
     */
    public function append(string $type, string $value, int $line, array $patternMatches = [])
    {
        if ($this->currentLine !== $line) {
            $this->currentLine = $line;
            $this->currentColumn = 1;
        }
        $this->tokens->append(new \RectorPrefix20210526\Helmich\TypoScriptParser\Tokenizer\Token($type, $value, $line, $this->currentColumn, $patternMatches));
     ...
     * @return void
     */
    public function appendToken(\RectorPrefix20210526\Helmich\TypoScriptParser\Tokenizer\TokenInterface $token)
    {
