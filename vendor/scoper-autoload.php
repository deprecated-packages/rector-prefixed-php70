...
if (!class_exists('ComposerAutoloaderInit7587a7f4b9d4ef1c70002765c1a8fac4', false) && !interface_exists('ComposerAutoloaderInit7587a7f4b9d4ef1c70002765c1a8fac4', false) && !trait_exists('ComposerAutoloaderInit7587a7f4b9d4ef1c70002765c1a8fac4', false)) {
    spl_autoload_call('RectorPrefix20210503\ComposerAutoloaderInit7587a7f4b9d4ef1c70002765c1a8fac4');
}
...
if (!function_exists('composerRequire7587a7f4b9d4ef1c70002765c1a8fac4')) {
    function composerRequire7587a7f4b9d4ef1c70002765c1a8fac4() {
        return \RectorPrefix20210503\composerRequire7587a7f4b9d4ef1c70002765c1a8fac4(...func_get_args());
    }
}
...
if (!function_exists('getUrlFromPath')) {
    function getUrlFromPath() {
        return \RectorPrefix20210503\getUrlFromPath(...func_get_args());
    }
}
if (!function_exists('showJsonError')) {
    function showJsonError() {
        return \RectorPrefix20210503\showJsonError(...func_get_args());
    }
}
if (!function_exists('output')) {
    function output() {
        return \RectorPrefix20210503\output(...func_get_args());
    }
}
if (!function_exists('parseHeaderValue')) {
    function parseHeaderValue() {
        return \RectorPrefix20210503\parseHeaderValue(...func_get_args());
    }
}
...
if (!function_exists('showUsage')) {
    function showUsage() {
        return \RectorPrefix20210503\showUsage(...func_get_args());
    }
}
if (!function_exists('lintFile')) {
    function lintFile() {
        return \RectorPrefix20210503\lintFile(...func_get_args());
    }
}
if (!function_exists('lint')) {
    function lint() {
        return \RectorPrefix20210503\lint(...func_get_args());
    }
}
