...
class StubValidator
{
    ...
    public function validate(array $stubFiles, bool $debug) : array
    {
        ...
        foreach ($stubFiles as $stubFile) {
            try {
                $tmpErrors = $fileAnalyser->analyseFile($stubFile, $analysedFiles, $ruleRegistry, static function () {
                })->getErrors();
                ...
                $errors[] = new \PHPStan\Analyser\Error($internalErrorMessage, $stubFile, null, $e);
            }
        }
