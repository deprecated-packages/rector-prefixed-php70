...
use RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\Nette\Neon\Neon;
...
class ResultCacheManager
{
    ...
    private function isMetaDifferent(array $cachedMeta, array $currentMeta) : bool
    {
        ...
        if ($projectConfig !== null) {
            $currentMeta['projectConfig'] = \RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\Nette\Neon\Neon::encode($currentMeta['projectConfig']);
        }
...
php;
        ...
        if ($projectConfigArray !== null) {
            $meta['projectConfig'] = \RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\Nette\Neon\Neon::encode($projectConfigArray);
        }
    ...
    private function getClassesFromConfigDefinition($definition) : array
    {
        ...
        if ($definition instanceof \RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\Nette\DI\Definitions\Statement) {
