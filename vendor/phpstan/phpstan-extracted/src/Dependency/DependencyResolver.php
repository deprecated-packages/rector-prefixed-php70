...
class DependencyResolver
{
     ...
     */
    private function getFunctionReflection(\PhpParser\Node\Name $nameNode, $scope) : \PHPStan\Reflection\ReflectionWithFilename
    {
     ...
     * @return void
     */
    private function extractFromParametersAcceptor(\PHPStan\Reflection\ParametersAcceptorWithPhpDocs $parametersAcceptor, array &$dependenciesReflections)
    {
