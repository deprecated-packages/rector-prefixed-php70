...
class ExportedPropertyNode implements \JsonSerializable, \PHPStan\Dependency\ExportedNode
{
    ...
    private $static;
    /**
     * @param \PHPStan\Dependency\ExportedNode\ExportedPhpDocNode|null $phpDoc
     * @param string|null $type
     */
    public function __construct(string $name, $phpDoc, $type, bool $public, bool $private, bool $static)
    {
        $this->name = $name;
        $this->phpDoc = $phpDoc;
        $this->type = $type;
