...
class ClearResultCacheCommand extends \RectorPrefix20210616\_HumbugBox15516bb2b566\Symfony\Component\Console\Command\Command
{
    ...
    {
        $this->setName(self::NAME)->setDescription('Clears the result cache.')->setDefinition([new \RectorPrefix20210616\_HumbugBox15516bb2b566\Symfony\Component\Console\Input\InputOption('configuration', 'c', \RectorPrefix20210616\_HumbugBox15516bb2b566\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to project configuration file'), new \RectorPrefix20210616\_HumbugBox15516bb2b566\Symfony\Component\Console\Input\InputOption('autoload-file', 'a', \RectorPrefix20210616\_HumbugBox15516bb2b566\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Project\'s additional autoload file path')]);
    }
