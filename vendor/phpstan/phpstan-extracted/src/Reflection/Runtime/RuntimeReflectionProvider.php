...
class RuntimeReflectionProvider implements \PHPStan\Reflection\ReflectionProvider
{
     ...
     */
    private function getClassFromReflection(\ReflectionClass $reflectionClass, string $displayName, $anonymousFilename) : \PHPStan\Reflection\ClassReflection
    {
     ...
     * @param \PHPStan\Analyser\Scope|null $scope
     */
    private function hasCustomFunction(\PhpParser\Node\Name $nameNode, $scope) : bool
    {
        $functionName = $this->resolveFunctionName($nameNode, $scope);
        if ($functionName === null) {
            return \false;
     ...
     * @param \PHPStan\Analyser\Scope|null $scope
     */
    private function getCustomFunction(\PhpParser\Node\Name $nameNode, $scope) : \PHPStan\Reflection\Php\PhpFunctionReflection
    {
