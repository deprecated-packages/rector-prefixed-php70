...
class Php8SignatureMapProvider implements \PHPStan\Reflection\SignatureMap\SignatureMapProvider
{
     ...
     */
    private function findMethodNode(string $className, string $methodName)
    {
        $lowerClassName = \strtolower($className);
    ...
    public function getMethodSignature(string $className, string $methodName, $reflectionMethod, int $variant = 0) : \PHPStan\Reflection\SignatureMap\FunctionSignature
    {
        ...
        list($methodNode, $stubFile) = $methodNode;
     ...
     * @param string|null $className
     */
    private function getSignature(\PhpParser\Node\FunctionLike $function, $className, string $stubFile) : \PHPStan\Reflection\SignatureMap\FunctionSignature
    {
