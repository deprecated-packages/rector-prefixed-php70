...
class ComposerJsonAndInstalledJsonSourceLocatorMaker
{
    ...
    public function create(string $projectInstallationPath)
    {
        ...
        try {
            ...
            $composer = \RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\Nette\Utils\Json::decode($composerJsonContents, \RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\Nette\Utils\Json::FORCE_ARRAY);
        ...
        try {
            ...
            $installedJson = \RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\Nette\Utils\Json::decode($installedJsonContents, \RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\Nette\Utils\Json::FORCE_ARRAY);
        } catch (\PHPStan\File\CouldNotReadFileException $e) {
            return null;
        } catch (\RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\Nette\Utils\JsonException $e) {
            return null;
