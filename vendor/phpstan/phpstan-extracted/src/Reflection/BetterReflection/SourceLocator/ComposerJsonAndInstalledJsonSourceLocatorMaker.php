...
class ComposerJsonAndInstalledJsonSourceLocatorMaker
{
    ...
    public function create(string $projectInstallationPath)
    {
        ...
        try {
            ...
            $composer = \RectorPrefix20210616\_HumbugBox15516bb2b566\Nette\Utils\Json::decode($composerJsonContents, \RectorPrefix20210616\_HumbugBox15516bb2b566\Nette\Utils\Json::FORCE_ARRAY);
        ...
        try {
            ...
            $installedJson = \RectorPrefix20210616\_HumbugBox15516bb2b566\Nette\Utils\Json::decode($installedJsonContents, \RectorPrefix20210616\_HumbugBox15516bb2b566\Nette\Utils\Json::FORCE_ARRAY);
        } catch (\PHPStan\File\CouldNotReadFileException $e) {
            return null;
        } catch (\RectorPrefix20210616\_HumbugBox15516bb2b566\Nette\Utils\JsonException $e) {
            return null;
