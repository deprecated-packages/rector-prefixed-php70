...
class OptimizedDirectorySourceLocator implements \PHPStan\BetterReflection\SourceLocator\Type\SourceLocator
{
    ...
    private $classToFile = null;
    /** @var array<string, array<int, string>>|null */
    private $functionToFiles = null;
     ...
     * @param string[] $files
     */
    public function __construct(\PHPStan\Reflection\BetterReflection\SourceLocator\FileNodesFetcher $fileNodesFetcher, array $files)
    {
     ...
     * @return Reflection
     */
    private function nodeToReflection(\PHPStan\BetterReflection\Reflector\Reflector $reflector, \PHPStan\Reflection\BetterReflection\SourceLocator\FetchedNode $fetchedNode) : \PHPStan\BetterReflection\Reflection\Reflection
    {
     ...
     * @return string|null
     */
    private function findFileByClass(string $className)
    {
