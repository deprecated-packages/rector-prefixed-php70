...
final class MemoizingClassReflector extends \PHPStan\BetterReflection\Reflector\ClassReflector
{
     ...
     */
    public function reflect(string $className) : \PHPStan\BetterReflection\Reflection\ReflectionClass
    {
