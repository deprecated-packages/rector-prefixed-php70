...
class NativeParameterWithPhpDocsReflection implements \PHPStan\Reflection\ParameterReflectionWithPhpDocs
{
     ...
     */
    public function __construct(string $name, bool $optional, \PHPStan\Type\Type $type, \PHPStan\Type\Type $phpDocType, \PHPStan\Type\Type $nativeType, \PHPStan\Reflection\PassedByReference $passedByReference, bool $variadic, $defaultValue)
    {
        $this->name = $name;
