...
class PhpParameterFromParserNodeReflection implements \PHPStan\Reflection\ParameterReflectionWithPhpDocs
{
     ...
     */
    public function __construct(string $name, bool $optional, \PHPStan\Type\Type $realType, $phpDocType, \PHPStan\Reflection\PassedByReference $passedByReference, $defaultValue, bool $variadic)
    {
        $this->name = $name;
