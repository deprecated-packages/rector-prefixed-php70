...
class UnionTypePropertyReflection implements \PHPStan\Reflection\PropertyReflection
{
    ...
    {
        return \PHPStan\TrinaryLogic::extremeIdentity(...\array_map(static function (\PHPStan\Reflection\PropertyReflection $property) : TrinaryLogic {
    ...
    {
        return \PHPStan\Type\TypeCombinator::union(...\array_map(static function (\PHPStan\Reflection\PropertyReflection $property) : Type {
