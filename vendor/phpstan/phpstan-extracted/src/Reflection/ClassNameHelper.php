...
class ClassNameHelper
{
    public static function isValidClassName(string $name) : bool
    {
        ...
        return \RectorPrefix20210616\_HumbugBox15516bb2b566\Nette\Utils\Strings::match(\ltrim($name, '\\'), '/^[a-zA-Z_\\x80-\\xff][a-zA-Z0-9_\\x80-\\xff]*(\\\\[a-zA-Z_\\x80-\\xff][a-zA-Z0-9_\\x80-\\xff]*)*$/') !== null;
    }
}
