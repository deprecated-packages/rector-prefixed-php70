...
class GenericParametersAcceptorResolver
{
    ...
    public static function resolve(array $argTypes, \PHPStan\Reflection\ParametersAcceptor $parametersAcceptor) : \PHPStan\Reflection\ParametersAcceptor
    {
        ...
        return new \PHPStan\Reflection\ResolvedFunctionVariant($parametersAcceptor, new \PHPStan\Type\Generic\TemplateTypeMap(\array_merge($parametersAcceptor->getTemplateTypeMap()->map(static function (string $name, \PHPStan\Type\Type $type) : Type {
