...
class RegularExpressionPatternRule implements \PHPStan\Rules\Rule
{
    ...
    private function extractPatterns(\PhpParser\Node\Expr\FuncCall $functionCall, \PHPStan\Analyser\Scope $scope) : array
    {
        ...
        if (!\RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\Nette\Utils\Strings::startsWith($functionName, 'preg_')) {
            return [];
        }
    ...
    {
        try {
            \RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\Nette\Utils\Strings::match('', $pattern);
