...
class NewStaticRule implements \PHPStan\Rules\Rule
{
    ...
    public function processNode(\PhpParser\Node $node, \PHPStan\Analyser\Scope $scope) : array
    {
        ...
        $messages = [\PHPStan\Rules\RuleErrorBuilder::message('Unsafe usage of new static().')->tip('See: https://phpstan.org/blog/solving-phpstan-error-unsafe-usage-of-new-static')->build()];
