...
class ExistingNamesInGroupUseRule implements \PHPStan\Rules\Rule
{
     ...
     */
    private function checkConstant(\PhpParser\Node\Name $name)
    {
     ...
     * @return \PHPStan\Rules\RuleError|null
     */
    private function checkFunction(\PhpParser\Node\Name $name)
    {
     ...
     * @return \PHPStan\Rules\RuleError|null
     */
    private function checkClass(\PhpParser\Node\Name $name)
    {
