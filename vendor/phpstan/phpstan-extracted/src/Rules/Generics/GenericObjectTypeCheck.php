    ...
    public function check(\PHPStan\Type\Type $phpDocType, string $classNotGenericMessage, string $notEnoughTypesMessage, string $extraTypesMessage, string $typeIsNotSubtypeMessage) : array
    {
        ...
        foreach ($genericTypes as $genericType) {
            ...
            for ($i = 0; $i < $templateTypesCount; $i++) {
                ...
                $boundType = \PHPStan\Type\Generic\TemplateTypeHelper::resolveToBounds($templateType);
                ...
                if ($boundType->isSuperTypeOf($genericTypeType)->yes()) {
                    ...
                    for ($j = 0; $j < $templateTypesCount; $j++) {
                        ...
                        $templateTypes[$j] = \PHPStan\Type\Generic\TemplateTypeHelper::resolveTemplateTypes($templateTypes[$j], $map);
                    }
                    continue;
                }
