 ...
 */
class UsedTraitsRule implements \PHPStan\Rules\Rule
{
    ...
    public function processNode(\PhpParser\Node $node, \PHPStan\Analyser\Scope $scope) : array
    {
        ...
        return $this->genericAncestorsCheck->check($node->traits, \array_map(static function (\PHPStan\PhpDoc\Tag\UsesTag $tag) : Type {
            return $tag->getType();
