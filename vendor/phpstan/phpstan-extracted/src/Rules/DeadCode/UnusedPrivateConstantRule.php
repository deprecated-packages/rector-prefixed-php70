...
{
    /** @var AlwaysUsedClassConstantsExtensionProvider */
    private $extensionProvider;
    public function __construct(\PHPStan\Rules\Constants\AlwaysUsedClassConstantsExtensionProvider $extensionProvider)
    {
