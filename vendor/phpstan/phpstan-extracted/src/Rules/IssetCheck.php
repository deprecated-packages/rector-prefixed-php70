...
class IssetCheck
{
    ...
    /**
     * @param \PHPStan\Rules\RuleError|null $error
     * @return \PHPStan\Rules\RuleError|null
     */
    public function check(\PhpParser\Node\Expr $expr, \PHPStan\Analyser\Scope $scope, string $operatorDescription, $error = null)
    {
     ...
     * @return \PHPStan\Rules\RuleError|null
     */
    private function generateError(\PHPStan\Type\Type $type, string $message)
    {
