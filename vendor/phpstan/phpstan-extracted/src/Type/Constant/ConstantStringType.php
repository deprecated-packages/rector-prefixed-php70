...
class ConstantStringType extends \PHPStan\Type\StringType implements \PHPStan\Type\ConstantScalarType
{
    ...
    public function describe(\PHPStan\Type\VerbosityLevel $level) : string
    {
        return $level->handle(static function () : string {
            ...
            try {
                $truncatedValue = \RectorPrefix20210526\_HumbugBox0b2f2d5c77b8\Nette\Utils\Strings::truncate($this->value, self::DESCRIBE_LIMIT);
            } catch (\RectorPrefix20210526\_HumbugBox0b2f2d5c77b8\Nette\Utils\RegexpException $e) {
    ...
    public function isCallable() : \PHPStan\TrinaryLogic
    {
        ...
        $matches = \RectorPrefix20210526\_HumbugBox0b2f2d5c77b8\Nette\Utils\Strings::match($this->value, '#^([a-zA-Z_\\x7f-\\xff\\\\][a-zA-Z0-9_\\x7f-\\xff\\\\]*)::([a-zA-Z_\\x7f-\\xff][a-zA-Z0-9_\\x7f-\\xff]*)\\z#');
        if ($matches !== null) {
