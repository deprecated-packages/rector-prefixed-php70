...
class UnionType implements \PHPStan\Type\CompoundType
{
    ...
    {
        $throwException = static function () use($types) {
    ...
    public function getUnresolvedPropertyPrototype(string $propertyName, \PHPStan\Reflection\ClassMemberAccessAnswerer $scope) : \PHPStan\Reflection\Type\UnresolvedPropertyPrototypeReflection
    {
        ...
        return new \PHPStan\Reflection\Type\UnionTypeUnresolvedPropertyPrototypeReflection($propertyName, $propertyPrototypes);
    }
    ...
    public function getUnresolvedMethodPrototype(string $methodName, \PHPStan\Reflection\ClassMemberAccessAnswerer $scope) : \PHPStan\Reflection\Type\UnresolvedMethodPrototypeReflection
    {
        ...
        return new \PHPStan\Reflection\Type\UnionTypeUnresolvedMethodPrototypeReflection($methodName, $methodPrototypes);
    }
    ...
    {
        return $this->unionResults(static function (\PHPStan\Type\Type $type) use($otherType) : TrinaryLogic {
    ...
    public function inferTemplateTypes(\PHPStan\Type\Type $receivedType) : \PHPStan\Type\Generic\TemplateTypeMap
    {
        ...
        foreach ($myTypes as $type) {
            if ($type instanceof \PHPStan\Type\Generic\TemplateType || $type instanceof \PHPStan\Type\Generic\GenericClassStringType && $type->getGenericType() instanceof \PHPStan\Type\Generic\TemplateType) {
