...
final class DsMapDynamicReturnTypeExtension implements \PHPStan\Type\DynamicMethodReturnTypeExtension
{
    ...
    {
        return 'RectorPrefix20210517\\Ds\\Map';
    }
    ...
    public function getTypeFromMethodCall(\PHPStan\Reflection\MethodReflection $methodReflection, \PhpParser\Node\Expr\MethodCall $methodCall, \PHPStan\Analyser\Scope $scope) : \PHPStan\Type\Type
    {
        ...
        if ($returnType instanceof \PHPStan\Type\UnionType) {
            $types = \array_values(\array_filter($returnType->getTypes(), static function (\PHPStan\Type\Type $type) : bool {
                if ($type instanceof \PHPStan\Type\Generic\TemplateType && $type->getName() === 'TDefault' && ($type->getScope()->equals(\PHPStan\Type\Generic\TemplateTypeScope::createWithMethod('RectorPrefix20210517\\Ds\\Map', 'get')) || $type->getScope()->equals(\PHPStan\Type\Generic\TemplateTypeScope::createWithMethod('RectorPrefix20210517\\Ds\\Map', 'remove')))) {
                    return \false;
                }
                return \true;
            }));
