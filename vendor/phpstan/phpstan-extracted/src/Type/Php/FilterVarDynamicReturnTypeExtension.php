...
class FilterVarDynamicReturnTypeExtension implements \PHPStan\Type\DynamicFunctionReturnTypeExtension
{
     ...
     */
    private function determineExactType(\PHPStan\Type\Type $in, int $filterValue)
    {
    ...
    /**
     * @param \PhpParser\Node\Arg|null $flagsArg
     */
    private function getOtherType($flagsArg, \PHPStan\Analyser\Scope $scope) : \PHPStan\Type\Type
    {
     ...
     * @return \PHPStan\Type\Type|null
     */
    private function getDefault(\PhpParser\Node\Arg $expression, \PHPStan\Analyser\Scope $scope)
    {
    ...
    /**
     * @param \PhpParser\Node\Arg|null $expression
     */
    private function hasFlag(int $flag, $expression, \PHPStan\Analyser\Scope $scope) : bool
    {
        if ($expression === null) {
            return \false;
        }
