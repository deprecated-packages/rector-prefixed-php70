...
class FileTypeMapper
{
    ...
    private function resolvePhpDocStringToDocNode(string $phpDocString) : \PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocNode
    {
        ...
        try {
            $phpDocParserVersion = \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Jean85\PrettyVersions::getVersion('phpstan/phpdoc-parser')->getPrettyVersion();
    ...
    private function getPhpDocKey(string $file, $class, $trait, $function, string $docComment) : string
    {
        ...
        if (!isset($this->docKeys[$cacheKey])) {
            $this->docKeys[$cacheKey] = \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Nette\Utils\Strings::replace($docComment, '#\\s+#', ' ');
        }
