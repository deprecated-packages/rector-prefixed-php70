...
class ProcessHelper
{
     ...
     * @return string
     */
    public static function getWorkerCommand(string $mainScript, string $commandName, $projectConfigFile, array $additionalItems, \RectorPrefix20210616\_HumbugBox15516bb2b566\Symfony\Component\Console\Input\InputInterface $input) : string
    {
