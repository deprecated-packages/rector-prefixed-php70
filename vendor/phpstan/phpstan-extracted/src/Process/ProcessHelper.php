...
class ProcessHelper
{
     ...
     * @return string
     */
    public static function getWorkerCommand(string $mainScript, string $commandName, $projectConfigFile, array $additionalItems, \RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Symfony\Component\Console\Input\InputInterface $input) : string
    {
