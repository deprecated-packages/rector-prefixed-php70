...
class ProcessPromise implements \PHPStan\Process\Runnable\Runnable
{
    ...
    public function __construct(\RectorPrefix20210526\_HumbugBox0b2f2d5c77b8\React\EventLoop\LoopInterface $loop, string $name, string $command)
    {
        $this->loop = $loop;
        $this->name = $name;
        $this->command = $command;
        $this->deferred = new \RectorPrefix20210526\_HumbugBox0b2f2d5c77b8\React\Promise\Deferred();
    }
     ...
     */
    public function run() : \RectorPrefix20210526\_HumbugBox0b2f2d5c77b8\React\Promise\CancellablePromiseInterface
    {
        ...
        $this->process = new \RectorPrefix20210526\_HumbugBox0b2f2d5c77b8\React\ChildProcess\Process($this->command, null, null, [1 => $tmpStdOutResource, 2 => $tmpStdErrResource]);
