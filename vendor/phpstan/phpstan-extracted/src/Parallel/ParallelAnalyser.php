...
use RectorPrefix20210525\_HumbugBox0b2f2d5c77b8\Nette\Utils\Random;
...
class ParallelAnalyser
{
     ...
     */
    public function analyse(\PHPStan\Parallel\Schedule $schedule, string $mainScript, $postFileCallback, $projectConfigFile, $tmpFile, $insteadOfFile, \RectorPrefix20210525\_HumbugBox0b2f2d5c77b8\Symfony\Component\Console\Input\InputInterface $input) : \PHPStan\Analyser\AnalyserResult
    {
        ...
        $server->on('connection', function (\RectorPrefix20210525\_HumbugBox0b2f2d5c77b8\React\Socket\ConnectionInterface $connection) use(&$jobs) {
            $decoder = new \RectorPrefix20210525\_HumbugBox0b2f2d5c77b8\Clue\React\NDJson\Decoder($connection, \true, 512, \defined('JSON_INVALID_UTF8_IGNORE') ? \JSON_INVALID_UTF8_IGNORE : 0, $this->decoderBufferSize);
        ...
        for ($i = 0; $i < $numberOfProcesses; $i++) {
            ...
            $processIdentifier = \RectorPrefix20210525\_HumbugBox0b2f2d5c77b8\Nette\Utils\Random::generate();
