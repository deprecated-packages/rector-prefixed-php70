...
use RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\React\Socket\TcpServer;
...
class ProcessPool
{
    ...
    private $processes = [];
    public function __construct(\RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\React\Socket\TcpServer $server)
    {
        $this->server = $server;
    }
