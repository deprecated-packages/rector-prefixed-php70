...
use RectorPrefix20210616\_HumbugBox15516bb2b566\React\Socket\TcpServer;
...
class ProcessPool
{
    ...
    private $processes = [];
    public function __construct(\RectorPrefix20210616\_HumbugBox15516bb2b566\React\Socket\TcpServer $server)
    {
        $this->server = $server;
    }
