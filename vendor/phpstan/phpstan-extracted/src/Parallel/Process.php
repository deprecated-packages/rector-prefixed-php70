...
class Process
{
    ...
    private $timer = null;
    public function __construct(string $command, \RectorPrefix20210620\_HumbugBox15516bb2b566\React\EventLoop\LoopInterface $loop, float $timeoutSeconds)
    {
    ...
    public function start(callable $onData, callable $onError, callable $onExit)
    {
        ...
        $this->process = new \RectorPrefix20210620\_HumbugBox15516bb2b566\React\ChildProcess\Process($this->command, null, null, [1 => $this->stdOut, 2 => $this->stdErr]);
     ...
     * @return void
     */
    public function bindConnection(\RectorPrefix20210620\_HumbugBox15516bb2b566\React\Stream\ReadableStreamInterface $out, \RectorPrefix20210620\_HumbugBox15516bb2b566\React\Stream\WritableStreamInterface $in)
    {
