...
class Process
{
    ...
    private $timer = null;
    public function __construct(string $command, \RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\React\EventLoop\LoopInterface $loop, float $timeoutSeconds)
    {
    ...
    public function start(callable $onData, callable $onError, callable $onExit)
    {
        ...
        $this->process = new \RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\React\ChildProcess\Process($this->command, null, null, [1 => $this->stdOut, 2 => $this->stdErr]);
     ...
     * @return void
     */
    public function bindConnection(\RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\React\Stream\ReadableStreamInterface $out, \RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\React\Stream\WritableStreamInterface $in)
    {
