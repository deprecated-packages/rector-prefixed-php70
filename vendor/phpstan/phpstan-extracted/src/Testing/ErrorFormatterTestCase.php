...
abstract class ErrorFormatterTestCase extends \PHPStan\Testing\TestCase
{
    ...
    /** @var Output|null */
    private $output = null;
    private function getOutputStream() : \RectorPrefix20210616\_HumbugBox15516bb2b566\Symfony\Component\Console\Output\StreamOutput
    {
        ...
        if ($this->outputStream === null) {
            ...
            $this->outputStream = new \RectorPrefix20210616\_HumbugBox15516bb2b566\Symfony\Component\Console\Output\StreamOutput($resource);
        }
    ...
    {
        if ($this->output === null) {
            $errorConsoleStyle = new \PHPStan\Command\ErrorsConsoleStyle(new \RectorPrefix20210616\_HumbugBox15516bb2b566\Symfony\Component\Console\Input\StringInput(''), $this->getOutputStream());
