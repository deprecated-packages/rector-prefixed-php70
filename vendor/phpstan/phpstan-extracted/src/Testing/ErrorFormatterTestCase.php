...
abstract class ErrorFormatterTestCase extends \PHPStan\Testing\TestCase
{
    ...
    /** @var Output|null */
    private $output = null;
    private function getOutputStream() : \RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\Symfony\Component\Console\Output\StreamOutput
    {
        ...
        if ($this->outputStream === null) {
            ...
            $this->outputStream = new \RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\Symfony\Component\Console\Output\StreamOutput($resource);
        }
    ...
    {
        if ($this->output === null) {
            $errorConsoleStyle = new \PHPStan\Command\ErrorsConsoleStyle(new \RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\Symfony\Component\Console\Input\StringInput(''), $this->getOutputStream());
