...
abstract class RuleTestCase extends \PHPStan\Testing\TestCase
{
    ...
    public function analyse(array $files, array $expectedErrors)
    {
        ...
        $strictlyTypedSprintf = static function (int $line, string $message, $tip) : string {
