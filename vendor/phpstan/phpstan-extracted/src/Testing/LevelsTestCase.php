...
abstract class LevelsTestCase extends \RectorPrefix20210523\PHPUnit\Framework\TestCase
{
    /**
    ...
    public function testLevels(string $topic)
    {
        ...
        foreach (\range(0, 8) as $level) {
            ...
            $output = \implode("\n", $outputLines);
            try {
                $actualJson = \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\Nette\Utils\Json::decode($output, \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\Nette\Utils\Json::FORCE_ARRAY);
            } catch (\RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\Nette\Utils\JsonException $e) {
                throw new \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\Nette\Utils\JsonException(\sprintf('Cannot decode: %s', $output));
            }
    ...
    private function compareFiles(string $expectedJsonFile, array $expectedMessages)
    {
        if (\count($expectedMessages) === 0) {
            try {
                ...
                return null;
            } catch (\RectorPrefix20210523\PHPUnit\Framework\AssertionFailedError $e) {
                \unlink($expectedJsonFile);
                return $e;
            }
        }
        $actualOutput = \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\Nette\Utils\Json::encode($expectedMessages, \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\Nette\Utils\Json::PRETTY);
        try {
