...
abstract class TestCase extends \RectorPrefix20210517\PHPUnit\Framework\TestCase
{
    /** @var bool */
    ...
    public static function getReflectors() : array
    {
        ...
        if (!\class_exists(\RectorPrefix20210517\Composer\Autoload\ClassLoader::class)) {
