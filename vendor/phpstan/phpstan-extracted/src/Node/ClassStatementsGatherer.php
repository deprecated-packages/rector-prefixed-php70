...
class ClassStatementsGatherer
{
     ...
     * @return void
     */
    public function __invoke(\PhpParser\Node $node, \PHPStan\Analyser\Scope $scope)
    {
     ...
     * @return void
     */
    private function gatherNodes(\PhpParser\Node $node, \PHPStan\Analyser\Scope $scope)
    {
        if (!$scope->isInClass()) {
