...
use RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\Http\Io\ReadableBodyStream;
use RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\Http\Io\Sender;
use RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\Http\Io\Transaction;
...
class Browser
{
     ...
     */
    public function __construct(\RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\EventLoop\LoopInterface $loop, \RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\Socket\ConnectorInterface $connector = null)
    {
        $this->transaction = new \RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\Http\Io\Transaction(\RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\Http\Io\Sender::createFromLoop($loop, $connector), $loop);
    }
    /**
    ...
    public function withBase($baseUrl)
    {
        ...
        $browser->baseUrl = new \RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\RingCentral\Psr7\Uri($baseUrl);
    ...
    private function requestMayBeStreaming($method, $url, array $headers = array(), $body = '')
    {
        if ($this->baseUrl !== null) {
            ...
            $url = \RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\RingCentral\Psr7\Uri::resolve($this->baseUrl, $url);
        }
        if ($body instanceof \RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\Stream\ReadableStreamInterface) {
            $body = new \RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\Http\Io\ReadableBodyStream($body);
        }
        return $this->transaction->send(new \RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\RingCentral\Psr7\Request($method, $url, $headers, $body, $this->protocolVersion));
    }
}
