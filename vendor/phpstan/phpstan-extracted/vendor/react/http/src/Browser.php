...
use RectorPrefix20210620\_HumbugBox15516bb2b566\React\Http\Io\ReadableBodyStream;
use RectorPrefix20210620\_HumbugBox15516bb2b566\React\Http\Io\Sender;
use RectorPrefix20210620\_HumbugBox15516bb2b566\React\Http\Io\Transaction;
...
class Browser
{
    ...
    {
        $this->transaction = new \RectorPrefix20210620\_HumbugBox15516bb2b566\React\Http\Io\Transaction(\RectorPrefix20210620\_HumbugBox15516bb2b566\React\Http\Io\Sender::createFromLoop($loop, $connector), $loop);
    }
    /**
    ...
    public function withBase($baseUrl)
    {
        ...
        $browser->baseUrl = new \RectorPrefix20210620\_HumbugBox15516bb2b566\RingCentral\Psr7\Uri($baseUrl);
    ...
    private function requestMayBeStreaming($method, $url, array $headers = array(), $body = '')
    {
        if ($this->baseUrl !== null) {
            ...
            $url = \RectorPrefix20210620\_HumbugBox15516bb2b566\RingCentral\Psr7\Uri::resolve($this->baseUrl, $url);
        }
        if ($body instanceof \RectorPrefix20210620\_HumbugBox15516bb2b566\React\Stream\ReadableStreamInterface) {
            $body = new \RectorPrefix20210620\_HumbugBox15516bb2b566\React\Http\Io\ReadableBodyStream($body);
        }
        return $this->transaction->send(new \RectorPrefix20210620\_HumbugBox15516bb2b566\RingCentral\Psr7\Request($method, $url, $headers, $body, $this->protocolVersion));
    }
}
