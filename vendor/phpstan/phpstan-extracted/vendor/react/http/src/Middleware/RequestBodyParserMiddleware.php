...
use RectorPrefix20210616\_HumbugBox15516bb2b566\React\Http\Io\MultipartParser;
final class RequestBodyParserMiddleware
{
    ...
    {
        $this->multipart = new \RectorPrefix20210616\_HumbugBox15516bb2b566\React\Http\Io\MultipartParser($uploadMaxFilesize, $maxFileUploads);
    }
    ...
    private function parseFormUrlencoded(\RectorPrefix20210616\_HumbugBox15516bb2b566\Psr\Http\Message\ServerRequestInterface $request)
    {
