...
use RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Http\Io\MultipartParser;
final class RequestBodyParserMiddleware
{
    ...
    {
        $this->multipart = new \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Http\Io\MultipartParser($uploadMaxFilesize, $maxFileUploads);
    }
    ...
    private function parseFormUrlencoded(\RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\ServerRequestInterface $request)
    {
