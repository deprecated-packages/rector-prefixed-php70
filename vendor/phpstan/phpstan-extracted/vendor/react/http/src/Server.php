...
namespace RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Http;
...
use RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Http\Io\IniUtil;
use RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Http\Io\MiddlewareRunner;
use RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Http\Io\StreamingServer;
use RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Http\Middleware\LimitConcurrentRequestsMiddleware;
use RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Http\Middleware\StreamingRequestMiddleware;
use RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Http\Middleware\RequestBodyBufferMiddleware;
use RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Http\Middleware\RequestBodyParserMiddleware;
 ...
 */
final class Server extends \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Evenement\EventEmitter
{
    /**
     ...
     * @see self::listen()
     */
    public function __construct(\RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\EventLoop\LoopInterface $loop)
    {
        ...
        foreach ((array) $requestHandlers as $handler) {
            if ($handler instanceof \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Http\Middleware\StreamingRequestMiddleware) {
                $streaming = \true;
                break;
            }
        }
        ...
        if (!$streaming) {
            ...
            if ($concurrency !== null) {
                $middleware[] = new \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Http\Middleware\LimitConcurrentRequestsMiddleware($concurrency);
            }
            $middleware[] = new \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Http\Middleware\RequestBodyBufferMiddleware($maxSize);
            ...
            if ($enablePostDataReading !== '') {
                $middleware[] = new \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Http\Middleware\RequestBodyParserMiddleware();
            }
        }
        $middleware = \array_merge($middleware, $requestHandlers);
        $this->streamingServer = new \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Http\Io\StreamingServer($loop, new \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Http\Io\MiddlewareRunner($middleware));
        $that = $this;
    ...
    private function getConcurrentRequestsLimit($memory_limit, $post_max_size)
    {
        ...
        $availableMemory = \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Http\Io\IniUtil::iniSizeToBytes($memory_limit) / 2;
        $concurrentRequests = (int) \ceil($availableMemory / \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Http\Io\IniUtil::iniSizeToBytes($post_max_size));
    ...
    {
        $maxSize = \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Http\Io\IniUtil::iniSizeToBytes($post_max_size === null ? \ini_get('post_max_size') : $post_max_size);
