 ...
 * @internal
 */
class LengthLimitedStream extends \RectorPrefix20210616\_HumbugBox15516bb2b566\Evenement\EventEmitter implements \RectorPrefix20210616\_HumbugBox15516bb2b566\React\Stream\ReadableStreamInterface
{
    private $stream;
    private $closed = \false;
    private $transferredLength = 0;
    private $maxLength;
    public function __construct(\RectorPrefix20210616\_HumbugBox15516bb2b566\React\Stream\ReadableStreamInterface $stream, $maxLength)
    {
        $this->stream = $stream;
