 ...
 * @internal
 */
class ReadableBodyStream extends \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Evenement\EventEmitter implements \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Stream\ReadableStreamInterface, \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\StreamInterface
{
    private $input;
    private $position = 0;
    private $size;
    private $closed = \false;
    public function __construct(\RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Stream\ReadableStreamInterface $input, $size = null)
    {
        $this->input = $input;
        $this->size = $size;
        $that = $this;
