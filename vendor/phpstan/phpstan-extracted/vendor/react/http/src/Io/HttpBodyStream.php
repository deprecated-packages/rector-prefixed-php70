 ...
 * @internal
 */
class HttpBodyStream extends \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Evenement\EventEmitter implements \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\StreamInterface, \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\React\Stream\ReadableStreamInterface
{
    public $input;
     ...
     */
    public function __construct(\RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\React\Stream\ReadableStreamInterface $input, $size)
    {
        $this->input = $input;
        $this->size = $size;
