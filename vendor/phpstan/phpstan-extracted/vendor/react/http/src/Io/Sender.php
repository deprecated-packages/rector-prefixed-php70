...
use RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Http\Client\Client as HttpClient;
...
use RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Socket\ConnectorInterface;
...
class Sender
{
     ...
     * @return self
     */
    public static function createFromLoop(\RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\EventLoop\LoopInterface $loop, \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Socket\ConnectorInterface $connector = null)
    {
        return new self(new \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Http\Client\Client($loop, $connector));
    }
    private $http;
    /**
     ...
     * @internal
     */
    public function __construct(\RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Http\Client\Client $http)
    {
        $this->http = $http;
    }
    /**
    ...
    public function send(\RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\RequestInterface $request)
    {
        ...
        } elseif ($body instanceof \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Stream\ReadableStreamInterface && $body->isReadable() && !$request->hasHeader('Content-Length')) {
        ...
        $deferred = new \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Promise\Deferred(function ($_, $reject) use($requestStream) {
        ...
        $requestStream->on('response', function (\RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\ResponseInterface $response, \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Stream\ReadableStreamInterface $body) use($deferred, $request) {
            $length = null;
            ...
            if ($request->getMethod() === 'HEAD' || $code >= 100 && $code < 200 || $code == 204 || $code == 304) {
                ...
                $body = new \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Http\Io\ChunkedDecoder($body);
            } elseif ($response->hasHeader('Content-Length')) {
                $length = (int) $response->getHeaderLine('Content-Length');
            }
            $deferred->resolve($response->withBody(new \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Http\Io\ReadableBodyStream($body, $length)));
        });
