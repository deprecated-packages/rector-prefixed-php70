...
use RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\RingCentral\Psr7;
/**
...
final class MultipartParser
{
    ...
    public function __construct($uploadMaxFilesize = null, $maxFileUploads = null)
    {
        ...
        $this->uploadMaxFilesize = \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\React\Http\Io\IniUtil::iniSizeToBytes($uploadMaxFilesize);
        $this->maxFileUploads = $maxFileUploads === null ? \ini_get('file_uploads') === '' ? 0 : (int) \ini_get('max_file_uploads') : (int) $maxFileUploads;
    }
    public function parse(\RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\ServerRequestInterface $request)
    {
    ...
    private function parseUploadedFile($filename, $contentType, $contents)
    {
        ...
        if ($size === 0 && $filename === '') {
            ...
            return new \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\React\Http\Io\UploadedFile(\RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\RingCentral\Psr7\stream_for(), $size, \UPLOAD_ERR_NO_FILE, $filename, $contentType);
        }
        ...
        if ($size > $this->uploadMaxFilesize) {
            return new \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\React\Http\Io\UploadedFile(\RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\RingCentral\Psr7\stream_for(), $size, \UPLOAD_ERR_INI_SIZE, $filename, $contentType);
        }
        // file exceeds MAX_FILE_SIZE value
        if ($this->maxFileSize !== null && $size > $this->maxFileSize) {
            return new \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\React\Http\Io\UploadedFile(\RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\RingCentral\Psr7\stream_for(), $size, \UPLOAD_ERR_FORM_SIZE, $filename, $contentType);
        }
        return new \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\React\Http\Io\UploadedFile(\RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\RingCentral\Psr7\stream_for($contents), $size, \UPLOAD_ERR_OK, $filename, $contentType);
    }
