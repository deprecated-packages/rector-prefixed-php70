...
use RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\UploadedFileInterface;
 ...
 * @internal
 */
final class UploadedFile implements \RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\UploadedFileInterface
{
    /**
     * @var StreamInterface
     */
     ...
     */
    public function __construct(\RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\StreamInterface $stream, $size, $error, $filename, $mediaType)
    {
        $this->stream = $stream;
        $this->size = $size;
