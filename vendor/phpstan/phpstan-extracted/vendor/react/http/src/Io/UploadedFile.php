...
use RectorPrefix20210620\_HumbugBox15516bb2b566\Psr\Http\Message\UploadedFileInterface;
 ...
 * @internal
 */
final class UploadedFile implements \RectorPrefix20210620\_HumbugBox15516bb2b566\Psr\Http\Message\UploadedFileInterface
{
    /**
     * @var StreamInterface
     */
     ...
     */
    public function __construct(\RectorPrefix20210620\_HumbugBox15516bb2b566\Psr\Http\Message\StreamInterface $stream, $size, $error, $filename, $mediaType)
    {
        $this->stream = $stream;
        $this->size = $size;
