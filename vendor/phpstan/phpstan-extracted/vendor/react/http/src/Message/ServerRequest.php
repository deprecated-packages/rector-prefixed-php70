...
namespace RectorPrefix20210620\_HumbugBox15516bb2b566\React\Http\Message;
 ...
 */
final class ServerRequest extends \RectorPrefix20210620\_HumbugBox15516bb2b566\RingCentral\Psr7\Request implements \RectorPrefix20210620\_HumbugBox15516bb2b566\Psr\Http\Message\ServerRequestInterface
{
    ...
    {
        $stream = null;
        if ($body instanceof \RectorPrefix20210620\_HumbugBox15516bb2b566\React\Stream\ReadableStreamInterface && !$body instanceof \RectorPrefix20210620\_HumbugBox15516bb2b566\Psr\Http\Message\StreamInterface) {
            $stream = $body;
            $body = null;
        } elseif (!\is_string($body) && !$body instanceof \RectorPrefix20210620\_HumbugBox15516bb2b566\Psr\Http\Message\StreamInterface) {
        ...
        if ($stream !== null) {
            ...
            $this->stream = new \RectorPrefix20210620\_HumbugBox15516bb2b566\React\Http\Io\HttpBodyStream($stream, $size);
        }
