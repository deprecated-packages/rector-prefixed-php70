...
namespace RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\React\Http\Message;
 ...
 */
final class ServerRequest extends \RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\RingCentral\Psr7\Request implements \RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\ServerRequestInterface
{
    ...
    {
        $stream = null;
        if ($body instanceof \RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\React\Stream\ReadableStreamInterface && !$body instanceof \RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\StreamInterface) {
            $stream = $body;
            $body = null;
        } elseif (!\is_string($body) && !$body instanceof \RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\StreamInterface) {
        ...
        if ($stream !== null) {
            ...
            $this->stream = new \RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\React\Http\Io\HttpBodyStream($stream, $size);
        }
