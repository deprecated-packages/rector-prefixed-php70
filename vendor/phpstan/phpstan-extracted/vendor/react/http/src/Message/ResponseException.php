...
{
    private $response;
    public function __construct(\RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\ResponseInterface $response, $message = null, $code = null, $previous = null)
    {
        if ($message === null) {
