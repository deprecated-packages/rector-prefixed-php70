...
{
    private $response;
    public function __construct(\RectorPrefix20210620\_HumbugBox15516bb2b566\Psr\Http\Message\ResponseInterface $response, $message = null, $code = null, $previous = null)
    {
        if ($message === null) {
