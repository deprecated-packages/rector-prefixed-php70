...
namespace RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\Http\Client;
...
use RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\RingCentral\Psr7 as gPsr;
/**
 * @event response
 * @event drain
 * @event error
 ...
 * @internal
 */
class Request extends \RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\Evenement\EventEmitter implements \RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\Stream\WritableStreamInterface
{
    const STATE_INIT = 0;
    ...
    public function __construct(\RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\Socket\ConnectorInterface $connector, \RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\Http\Client\RequestData $requestData)
    {
    ...
    private function writeHead()
    {
        ...
        $promise->then(function (\RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\Socket\ConnectionInterface $stream) use($requestData, &$streamRef, &$stateRef, &$pendingWrites, $that) {
            $streamRef = $stream;
            ...
            $stateRef = \RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\Http\Client\Request::STATE_HEAD_WRITTEN;
    ...
    public function handleData($data)
    {
        ...
        if (\false !== \strpos($this->buffer, "\r\n\r\n") || \false !== \strpos($this->buffer, "\n\n")) {
            try {
                $response = \RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\RingCentral\Psr7\parse_response($this->buffer);
    ...
    protected function connect()
    {
        ...
        if ($scheme !== 'https' && $scheme !== 'http') {
            return \RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\Promise\reject(new \InvalidArgumentException('Invalid request URL given'));
        }
