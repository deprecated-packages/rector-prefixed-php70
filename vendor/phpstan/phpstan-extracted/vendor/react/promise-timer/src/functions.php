...
namespace RectorPrefix20210616\_HumbugBox15516bb2b566\React\Promise\Timer;
...
use RectorPrefix20210616\_HumbugBox15516bb2b566\React\Promise\Promise;
function timeout(\RectorPrefix20210616\_HumbugBox15516bb2b566\React\Promise\PromiseInterface $promise, $time, \RectorPrefix20210616\_HumbugBox15516bb2b566\React\EventLoop\LoopInterface $loop)
{
    ...
    return new \RectorPrefix20210616\_HumbugBox15516bb2b566\React\Promise\Promise(function ($resolve, $reject) use($loop, $time, $promise) {
        $timer = null;
        ...
        $timer = $loop->addTimer($time, function () use($time, &$promise, $reject) {
            $reject(new \RectorPrefix20210616\_HumbugBox15516bb2b566\React\Promise\Timer\TimeoutException($time, 'Timed out after ' . $time . ' seconds'));
...
function resolve($time, \RectorPrefix20210616\_HumbugBox15516bb2b566\React\EventLoop\LoopInterface $loop)
{
    return new \RectorPrefix20210616\_HumbugBox15516bb2b566\React\Promise\Promise(function ($resolve) use($loop, $time, &$timer) {
...
function reject($time, \RectorPrefix20210616\_HumbugBox15516bb2b566\React\EventLoop\LoopInterface $loop)
{
    return resolve($time, $loop)->then(function ($time) {
        throw new \RectorPrefix20210616\_HumbugBox15516bb2b566\React\Promise\Timer\TimeoutException($time, 'Timer expired after ' . $time . ' seconds');
    });
}
