 ...
 */
class UnwrapWritableStream extends \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Evenement\EventEmitter implements \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Stream\WritableStreamInterface
{
    private $promise;
    private $stream;
    ...
    public function __construct(\RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Promise\PromiseInterface $promise)
    {
        ...
        $this->promise = $promise->then(function ($stream) {
            if (!$stream instanceof \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Stream\WritableStreamInterface) {
                throw new \InvalidArgumentException('Not a writable stream');
            }
            return $stream;
        })->then(function (\RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\React\Stream\WritableStreamInterface $stream) use($out, &$store, &$buffer, &$ending, &$closed) {
