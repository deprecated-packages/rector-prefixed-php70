 ...
 */
class UnwrapWritableStream extends \RectorPrefix20210616\_HumbugBox15516bb2b566\Evenement\EventEmitter implements \RectorPrefix20210616\_HumbugBox15516bb2b566\React\Stream\WritableStreamInterface
{
    private $promise;
    private $stream;
    ...
    public function __construct(\RectorPrefix20210616\_HumbugBox15516bb2b566\React\Promise\PromiseInterface $promise)
    {
        ...
        $this->promise = $promise->then(function ($stream) {
            if (!$stream instanceof \RectorPrefix20210616\_HumbugBox15516bb2b566\React\Stream\WritableStreamInterface) {
                throw new \InvalidArgumentException('Not a writable stream');
            }
            return $stream;
        })->then(function (\RectorPrefix20210616\_HumbugBox15516bb2b566\React\Stream\WritableStreamInterface $stream) use($out, &$store, &$buffer, &$ending, &$closed) {
