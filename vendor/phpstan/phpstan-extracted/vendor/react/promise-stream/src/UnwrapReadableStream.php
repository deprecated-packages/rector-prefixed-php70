 ...
 */
class UnwrapReadableStream extends \RectorPrefix20210620\_HumbugBox15516bb2b566\Evenement\EventEmitter implements \RectorPrefix20210620\_HumbugBox15516bb2b566\React\Stream\ReadableStreamInterface
{
    private $promise;
     ...
     */
    public function __construct(\RectorPrefix20210620\_HumbugBox15516bb2b566\React\Promise\PromiseInterface $promise)
    {
        $out = $this;
        $closed =& $this->closed;
        $this->promise = $promise->then(function ($stream) {
            ...
            return $stream;
        })->then(function (\RectorPrefix20210620\_HumbugBox15516bb2b566\React\Stream\ReadableStreamInterface $stream) use($out, &$closed) {
    ...
    public function pause()
    {
        if ($this->promise !== null) {
            $this->promise->then(function (\RectorPrefix20210620\_HumbugBox15516bb2b566\React\Stream\ReadableStreamInterface $stream) {
                $stream->pause();
            });
        }
    }
    ...
    public function close()
    {
        ...
        if ($this->promise instanceof \RectorPrefix20210620\_HumbugBox15516bb2b566\React\Promise\CancellablePromiseInterface) {
            $this->promise->cancel();
        }
        $this->promise = null;
        $this->emit('close');
