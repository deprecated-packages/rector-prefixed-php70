...
use RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\React\Stream\Util;
use RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\React\Stream\WritableStreamInterface;
/**
 * @internal
 * @see unwrapReadable() instead
 */
class UnwrapReadableStream extends \RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\Evenement\EventEmitter implements \RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\React\Stream\ReadableStreamInterface
{
    private $promise;
     ...
     */
    public function __construct(\RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\React\Promise\PromiseInterface $promise)
    {
        $out = $this;
        $closed =& $this->closed;
        $this->promise = $promise->then(function ($stream) {
            ...
            return $stream;
        })->then(function (\RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\React\Stream\ReadableStreamInterface $stream) use($out, &$closed) {
    ...
    public function pause()
    {
        if ($this->promise !== null) {
            $this->promise->then(function (\RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\React\Stream\ReadableStreamInterface $stream) {
                $stream->pause();
            });
        }
    }
    ...
    {
        \RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\React\Stream\Util::pipe($this, $dest, $options);
        return $dest;
    }
    public function close()
    {
        ...
        if ($this->promise instanceof \RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\React\Promise\CancellablePromiseInterface) {
            $this->promise->cancel();
        }
        $this->promise = null;
        $this->emit('close');
