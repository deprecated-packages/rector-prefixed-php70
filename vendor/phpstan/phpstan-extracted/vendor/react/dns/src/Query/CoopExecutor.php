 ...
 * ```
 */
final class CoopExecutor implements \RectorPrefix20210525\_HumbugBox0b2f2d5c77b8\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $pending = array();
    private $counts = array();
    public function __construct(\RectorPrefix20210525\_HumbugBox0b2f2d5c77b8\React\Dns\Query\ExecutorInterface $base)
    {
        $this->executor = $base;
    }
    ...
    private function serializeQueryToIdentity(\RectorPrefix20210525\_HumbugBox0b2f2d5c77b8\React\Dns\Query\Query $query)
    {
