 ...
 * ```
 */
final class CoopExecutor implements \RectorPrefix20210620\_HumbugBox15516bb2b566\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $pending = array();
    private $counts = array();
    public function __construct(\RectorPrefix20210620\_HumbugBox15516bb2b566\React\Dns\Query\ExecutorInterface $base)
    {
        $this->executor = $base;
    }
    ...
    private function serializeQueryToIdentity(\RectorPrefix20210620\_HumbugBox15516bb2b566\React\Dns\Query\Query $query)
    {
