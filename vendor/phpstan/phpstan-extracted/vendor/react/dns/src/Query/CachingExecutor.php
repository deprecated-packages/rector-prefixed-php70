...
final class CachingExecutor implements \RectorPrefix20210616\_HumbugBox15516bb2b566\React\Dns\Query\ExecutorInterface
{
    /**
    ...
    private $executor;
    private $cache;
    public function __construct(\RectorPrefix20210616\_HumbugBox15516bb2b566\React\Dns\Query\ExecutorInterface $executor, \RectorPrefix20210616\_HumbugBox15516bb2b566\React\Cache\CacheInterface $cache)
    {
    ...
    public function query(\RectorPrefix20210616\_HumbugBox15516bb2b566\React\Dns\Query\Query $query)
    {
        ...
        return new \RectorPrefix20210616\_HumbugBox15516bb2b566\React\Promise\Promise(function ($resolve, $reject) use($query, $id, $cache, $executor, &$pending, $that) {
            $pending->then(function ($message) use($query, $id, $cache, $executor, &$pending, $that) {
                ...
                return $pending = $executor->query($query)->then(function (\RectorPrefix20210616\_HumbugBox15516bb2b566\React\Dns\Model\Message $message) use($cache, $id, $that) {
     ...
     * @internal
     */
    public function ttl(\RectorPrefix20210616\_HumbugBox15516bb2b566\React\Dns\Model\Message $message)
    {
