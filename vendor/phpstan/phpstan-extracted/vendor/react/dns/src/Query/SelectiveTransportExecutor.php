 ...
 * ```
 */
class SelectiveTransportExecutor implements \RectorPrefix20210525\_HumbugBox0b2f2d5c77b8\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\RectorPrefix20210525\_HumbugBox0b2f2d5c77b8\React\Dns\Query\ExecutorInterface $datagramExecutor, \RectorPrefix20210525\_HumbugBox0b2f2d5c77b8\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
    ...
    public function query(\RectorPrefix20210525\_HumbugBox0b2f2d5c77b8\React\Dns\Query\Query $query)
    {
        ...
        return new \RectorPrefix20210525\_HumbugBox0b2f2d5c77b8\React\Promise\Promise(function ($resolve, $reject) use(&$pending, $stream, $query) {
