 ...
 * ```
 */
class SelectiveTransportExecutor implements \RectorPrefix20210616\_HumbugBox15516bb2b566\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\RectorPrefix20210616\_HumbugBox15516bb2b566\React\Dns\Query\ExecutorInterface $datagramExecutor, \RectorPrefix20210616\_HumbugBox15516bb2b566\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
    ...
    public function query(\RectorPrefix20210616\_HumbugBox15516bb2b566\React\Dns\Query\Query $query)
    {
        ...
        return new \RectorPrefix20210616\_HumbugBox15516bb2b566\React\Promise\Promise(function ($resolve, $reject) use(&$pending, $stream, $query) {
