...
final class RetryExecutor implements \RectorPrefix20210620\_HumbugBox15516bb2b566\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $retries;
    public function __construct(\RectorPrefix20210620\_HumbugBox15516bb2b566\React\Dns\Query\ExecutorInterface $executor, $retries = 2)
    {
    ...
    public function tryQuery(\RectorPrefix20210620\_HumbugBox15516bb2b566\React\Dns\Query\Query $query, $retries)
    {
        $deferred = new \RectorPrefix20210620\_HumbugBox15516bb2b566\React\Promise\Deferred(function () use(&$promise) {
        ...
        $errorback = function ($e) use($deferred, &$promise, $query, $success, &$errorback, &$retries, $executor) {
            if (!$e instanceof \RectorPrefix20210620\_HumbugBox15516bb2b566\React\Dns\Query\TimeoutException) {
                $errorback = null;
                $deferred->reject($e);
            } elseif ($retries <= 0) {
                $errorback = null;
