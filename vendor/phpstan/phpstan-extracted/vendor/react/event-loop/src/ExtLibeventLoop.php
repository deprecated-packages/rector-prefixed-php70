 ...
 */
final class ExtLibeventLoop implements \RectorPrefix20210620\_HumbugBox15516bb2b566\React\EventLoop\LoopInterface
{
    /** @internal */
     ...
     */
    private function scheduleTimer(\RectorPrefix20210620\_HumbugBox15516bb2b566\React\EventLoop\TimerInterface $timer)
    {
    ...
    private function createTimerCallback()
    {
        ...
        $this->timerCallback = function ($_, $__, $timer) use($timers, $that) {
            ...
            if ($timer->isPeriodic()) {
                \event_add($timers[$timer], $timer->getInterval() * \RectorPrefix20210620\_HumbugBox15516bb2b566\React\EventLoop\ExtLibeventLoop::MICROSECONDS_PER_SECOND);
