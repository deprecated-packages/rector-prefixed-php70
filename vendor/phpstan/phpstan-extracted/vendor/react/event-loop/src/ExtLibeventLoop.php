 ...
 */
final class ExtLibeventLoop implements \RectorPrefix20210522\_HumbugBox0b2f2d5c77b8\React\EventLoop\LoopInterface
{
    /** @internal */
     ...
     */
    private function scheduleTimer(\RectorPrefix20210522\_HumbugBox0b2f2d5c77b8\React\EventLoop\TimerInterface $timer)
    {
    ...
    private function createTimerCallback()
    {
        ...
        $this->timerCallback = function ($_, $__, $timer) use($timers, $that) {
            ...
            if ($timer->isPeriodic()) {
                \event_add($timers[$timer], $timer->getInterval() * \RectorPrefix20210522\_HumbugBox0b2f2d5c77b8\React\EventLoop\ExtLibeventLoop::MICROSECONDS_PER_SECOND);
