 ...
 */
final class ExtUvLoop implements \RectorPrefix20210620\_HumbugBox15516bb2b566\React\EventLoop\LoopInterface
{
    private $uv;
    ...
    public function addSignal($signal, $listener)
    {
        ...
        if (!isset($this->signalEvents[$signal])) {
            ...
            $this->signalEvents[$signal] = \RectorPrefix20210620\_HumbugBox15516bb2b566\uv_signal_init($this->uv);
            \RectorPrefix20210620\_HumbugBox15516bb2b566\uv_signal_start($this->signalEvents[$signal], function () use($signals, $signal) {
                $signals->call($signal);
            }, $signal);
        }
    }
    ...
    {
        if (!isset($this->streamEvents[(int) $stream])) {
            $this->streamEvents[(int) $stream] = \RectorPrefix20210620\_HumbugBox15516bb2b566\uv_poll_init_socket($this->uv, $stream);
        }
