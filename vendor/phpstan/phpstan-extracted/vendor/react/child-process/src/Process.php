...
namespace RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\React\ChildProcess;
...
use RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\React\Stream\ReadableResourceStream;
 ...
 */
class Process extends \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\Evenement\EventEmitter
{
    /**
     ...
     */
    public function start(\RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\React\EventLoop\LoopInterface $loop, $interval = 0.1)
    {
        if ($this->isRunning()) {
        ...
        foreach ($pipes as $n => $fd) {
            if (\strpos($this->fds[$n][1], 'w') === \false) {
                $stream = new \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\React\Stream\WritableResourceStream($fd, $loop);
            } else {
                $stream = new \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\React\Stream\ReadableResourceStream($fd, $loop);
