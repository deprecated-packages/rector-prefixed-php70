...
namespace RectorPrefix20210620\_HumbugBox15516bb2b566\React\ChildProcess;
...
use RectorPrefix20210620\_HumbugBox15516bb2b566\React\Stream\ReadableResourceStream;
 ...
 */
class Process extends \RectorPrefix20210620\_HumbugBox15516bb2b566\Evenement\EventEmitter
{
    /**
     ...
     */
    public function start(\RectorPrefix20210620\_HumbugBox15516bb2b566\React\EventLoop\LoopInterface $loop, $interval = 0.1)
    {
        if ($this->isRunning()) {
        ...
        foreach ($pipes as $n => $fd) {
            if (\strpos($this->fds[$n][1], 'w') === \false) {
                $stream = new \RectorPrefix20210620\_HumbugBox15516bb2b566\React\Stream\WritableResourceStream($fd, $loop);
            } else {
                $stream = new \RectorPrefix20210620\_HumbugBox15516bb2b566\React\Stream\ReadableResourceStream($fd, $loop);
