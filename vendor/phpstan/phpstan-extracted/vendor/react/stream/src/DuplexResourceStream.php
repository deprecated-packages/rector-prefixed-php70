...
final class DuplexResourceStream extends \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\Evenement\EventEmitter implements \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Stream\DuplexStreamInterface
{
    private $stream;
    private $loop;
    /**
    ...
    public function __construct($stream, \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\EventLoop\LoopInterface $loop, $readChunkSize = null, \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Stream\WritableStreamInterface $buffer = null)
    {
        ...
        if ($buffer === null) {
            $buffer = new \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
        $this->loop = $loop;
