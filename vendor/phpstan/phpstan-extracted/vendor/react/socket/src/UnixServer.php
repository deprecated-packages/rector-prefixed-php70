 ...
 */
final class UnixServer extends \RectorPrefix20210620\_HumbugBox15516bb2b566\Evenement\EventEmitter implements \RectorPrefix20210620\_HumbugBox15516bb2b566\React\Socket\ServerInterface
{
    private $master;
    private $loop;
     ...
     */
    public function __construct($path, \RectorPrefix20210620\_HumbugBox15516bb2b566\React\EventLoop\LoopInterface $loop, array $context = array())
    {
        $this->loop = $loop;
    ...
    {
        $connection = new \RectorPrefix20210620\_HumbugBox15516bb2b566\React\Socket\Connection($socket, $this->loop);
        $connection->unix = \true;
