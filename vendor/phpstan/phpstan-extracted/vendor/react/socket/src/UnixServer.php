 ...
 */
final class UnixServer extends \RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\Evenement\EventEmitter implements \RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\React\Socket\ServerInterface
{
    private $master;
    private $loop;
     ...
     */
    public function __construct($path, \RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\React\EventLoop\LoopInterface $loop, array $context = array())
    {
        $this->loop = $loop;
    ...
    {
        $connection = new \RectorPrefix20210518\_HumbugBox0b2f2d5c77b8\React\Socket\Connection($socket, $this->loop);
        $connection->unix = \true;
