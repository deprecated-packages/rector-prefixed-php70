...
class StreamEncryption
{
    ...
    private $method;
    private $server;
    public function __construct(\RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\EventLoop\LoopInterface $loop, $server = \true)
    {
        $this->loop = $loop;
        $this->server = $server;
    ...
    public function enable(\RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Socket\Connection $stream)
    {
        return $this->toggle($stream, \true);
    }
    public function toggle(\RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Socket\Connection $stream, $toggle)
    {
        // pause actual stream instance to continue operation on raw stream socket
        $stream->pause();
        // TODO: add write() event to make sure we're not sending any excessive data
        // cancelling this leaves this stream in an inconsistent state…
        $deferred = new \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Promise\Deferred(function () {
    ...
    public function toggleCrypto($socket, \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Promise\Deferred $deferred, $toggle, $method)
    {
        $error = null;
