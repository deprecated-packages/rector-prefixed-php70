...
final class DnsConnector implements \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\React\Socket\ConnectorInterface
{
    private $connector;
    private $resolver;
    public function __construct(\RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\React\Socket\ConnectorInterface $connector, \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\React\Dns\Resolver\ResolverInterface $resolver)
    {
    ...
    public function connect($uri)
    {
        ...
        $resolved = null;
        return new \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\React\Promise\Promise(function ($resolve, $reject) use(&$promise, &$resolved, $uri, $connector, $host, $parts) {
