...
use RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Stream\DuplexResourceStream;
use RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Stream\Util;
use RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Stream\WritableResourceStream;
 ...
 * @internal
 */
class Connection extends \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\Evenement\EventEmitter implements \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Socket\ConnectionInterface
{
    /**
    ...
    public $stream;
    private $input;
    public function __construct($resource, \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\EventLoop\LoopInterface $loop)
    {
        ...
        $this->input = new \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Stream\DuplexResourceStream($resource, $loop, $clearCompleteBuffer ? -1 : null, new \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Stream\WritableResourceStream($resource, $loop, null, $limitWriteChunks ? 8192 : null));
        $this->stream = $resource;
        \RectorPrefix20210517\_HumbugBox0b2f2d5c77b8\React\Stream\Util::forwardEvents($this->input, $this, array('data', 'end', 'error', 'close', 'pipe', 'drain'));
