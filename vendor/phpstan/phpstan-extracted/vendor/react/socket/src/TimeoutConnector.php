...
final class TimeoutConnector implements \RectorPrefix20210616\_HumbugBox15516bb2b566\React\Socket\ConnectorInterface
{
    private $connector;
    private $timeout;
    private $loop;
    public function __construct(\RectorPrefix20210616\_HumbugBox15516bb2b566\React\Socket\ConnectorInterface $connector, $timeout, \RectorPrefix20210616\_HumbugBox15516bb2b566\React\EventLoop\LoopInterface $loop)
    {
    ...
    {
        return \RectorPrefix20210616\_HumbugBox15516bb2b566\React\Promise\Timer\timeout($this->connector->connect($uri), $this->timeout, $this->loop)->then(null, self::handler($uri));
    }
    /**
