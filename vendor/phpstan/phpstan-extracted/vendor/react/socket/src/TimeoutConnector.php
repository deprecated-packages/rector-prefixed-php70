...
final class TimeoutConnector implements \RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\Socket\ConnectorInterface
{
    private $connector;
    private $timeout;
    private $loop;
    public function __construct(\RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\Socket\ConnectorInterface $connector, $timeout, \RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\EventLoop\LoopInterface $loop)
    {
    ...
    {
        return \RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\React\Promise\Timer\timeout($this->connector->connect($uri), $this->timeout, $this->loop)->then(null, self::handler($uri));
    }
    /**
