...
namespace RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\React\Cache;
...
class ArrayCache implements \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\React\Cache\CacheInterface
{
    private $limit;
    private $data = array();
    ...
    public function get($key, $default = null)
    {
        ...
        if (!\array_key_exists($key, $this->data)) {
            return \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\React\Promise\resolve($default);
        }
        // remove and append to end of array to keep track of LRU info
        $value = $this->data[$key];
        unset($this->data[$key]);
        $this->data[$key] = $value;
        return \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\React\Promise\resolve($value);
    }
    public function set($key, $value, $ttl = null)
    {
        ...
        return \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\React\Promise\resolve(\true);
    }
    ...
    public function getMultiple(array $keys, $default = null)
    {
        ...
        return \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\React\Promise\all($values);
    }
    ...
    public function has($key)
    {
        ...
        if (!\array_key_exists($key, $this->data)) {
            return \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\React\Promise\resolve(\false);
        }
        // remove and append to end of array to keep track of LRU info
        $value = $this->data[$key];
        unset($this->data[$key]);
