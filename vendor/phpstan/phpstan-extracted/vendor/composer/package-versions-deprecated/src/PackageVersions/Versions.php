...
use RectorPrefix20210620\_HumbugBox15516bb2b566\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\RectorPrefix20210620\_HumbugBox15516bb2b566\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\RectorPrefix20210620\_HumbugBox15516bb2b566\Composer\InstalledVersions::class, \false) || !\RectorPrefix20210620\_HumbugBox15516bb2b566\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \RectorPrefix20210620\_HumbugBox15516bb2b566\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\RectorPrefix20210620\_HumbugBox15516bb2b566\Composer\InstalledVersions::class, \false) && \RectorPrefix20210620\_HumbugBox15516bb2b566\Composer\InstalledVersions::getRawData()) {
            return \RectorPrefix20210620\_HumbugBox15516bb2b566\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \RectorPrefix20210620\_HumbugBox15516bb2b566\Composer\InstalledVersions::getReference($packageName);
        }
