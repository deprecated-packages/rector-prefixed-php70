...
class ComposerAutoloaderInit76efdea48d97ddd5e412eb932aafadf4
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            ...
            \call_user_func(\RectorPrefix20210518\Composer\Autoload\ComposerStaticInit76efdea48d97ddd5e412eb932aafadf4::getInitializer($loader));
        } else {
        ...
        $loader->register(\true);
        if ($useStaticLoader) {
            $includeFiles = \RectorPrefix20210518\Composer\Autoload\ComposerStaticInit76efdea48d97ddd5e412eb932aafadf4::$files;
        } else {
            $includeFiles = (require __DIR__ . '/autoload_files.php');
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            \RectorPrefix20210518\composerRequire76efdea48d97ddd5e412eb932aafadf4($fileIdentifier, $file);
        }
        return $loader;
    }
}
// autoload_real.php @generated by Composer
\class_alias('RectorPrefix20210518\\ComposerAutoloaderInit76efdea48d97ddd5e412eb932aafadf4', 'ComposerAutoloaderInit76efdea48d97ddd5e412eb932aafadf4', \false);
