 ...
 */
abstract class AbstractCi implements \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\OndraM\CiDetector\Ci\CiInterface
{
    /** @var Env */
    protected $env;
    public function __construct(\RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\OndraM\CiDetector\Env $env)
    {
        $this->env = $env;
    }
}
