 ...
 */
abstract class AbstractCi implements \RectorPrefix20210616\_HumbugBox15516bb2b566\OndraM\CiDetector\Ci\CiInterface
{
    /** @var Env */
    protected $env;
    public function __construct(\RectorPrefix20210616\_HumbugBox15516bb2b566\OndraM\CiDetector\Env $env)
    {
        $this->env = $env;
    }
}
