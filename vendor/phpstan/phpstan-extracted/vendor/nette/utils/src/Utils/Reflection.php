...
final class Reflection
{
    ...
    {
        $type = $param->getType();
        return $type instanceof \ReflectionNamedType ? self::normalizeType($type->getName(), $param) : null;
    }
    /**
    ...
    public static function getPropertyType(\ReflectionProperty $prop)
    {
        ...
        return $type instanceof \ReflectionNamedType ? self::normalizeType($type->getName(), $prop) : null;
    }
    /**
    ...
    public static function expandClassName(string $name, \ReflectionClass $context) : string
    {
        ...
        if (empty($name)) {
            throw new \RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Nette\InvalidArgumentException('Class name must not be empty.');
    ...
    public static function getUseStatements(\ReflectionClass $class) : array
    {
        if ($class->isAnonymous()) {
            throw new \RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Nette\NotImplementedException('Anonymous classes are not supported.');
        }
        static $cache = [];
