...
namespace RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\Nette\Bridges\DITracy;

use RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\Nette;
use RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\Nette\DI\Container;
use RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\Tracy;
/**
 * Dependency injection container panel for Debugger Bar.
 */
class ContainerPanel implements \RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\Tracy\IBarPanel
{
    ...
    /** @var float|null */
    private $elapsedTime;
    public function __construct(\RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\Nette\DI\Container $container)
    {
    ...
    {
        return \RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\Nette\Utils\Helpers::capture(function () {
    ...
    public function getPanel() : string
    {
        ...
        return \RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\Nette\Utils\Helpers::capture(function () use($tags, $types, $rc) {
    ...
    {
        $prop = (new \ReflectionClass(\RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\Nette\DI\Container::class))->getProperty($name);
