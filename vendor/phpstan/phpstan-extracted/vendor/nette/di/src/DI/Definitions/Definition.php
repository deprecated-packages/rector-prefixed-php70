...
abstract class Definition
{
    ...
    {
        if ($this->name) {
            throw new \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Nette\InvalidStateException('Name already has been set.');
        }
        $this->name = $name;
        return $this;
    }
    ...
    protected function setType($type)
    {
        ...
        if ($type === null) {
            ...
            throw new \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Nette\InvalidArgumentException("Service '{$this->name}': Class or interface '{$type}' not found.");
        } else {
            $this->type = \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Nette\DI\Helpers::normalizeClass($type);
        }
        return $this;
    }
    /**
     ...
     * @return void
     */
    public abstract function resolveType(\RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Nette\DI\Resolver $resolver);
    /**
     * @return void
     */
    public abstract function complete(\RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Nette\DI\Resolver $resolver);
    /**
     * @return void
     */
    public abstract function generateMethod(\RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Nette\PhpGenerator\Method $method, \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Nette\DI\PhpGenerator $generator);
    /**
