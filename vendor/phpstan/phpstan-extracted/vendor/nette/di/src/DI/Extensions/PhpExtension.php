 ...
 */
final class PhpExtension extends \RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Nette\DI\CompilerExtension
{
    public function getConfigSchema() : \RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Nette\Schema\Schema
    {
        return \RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Nette\Schema\Expect::arrayOf('scalar');
    }
    public function loadConfiguration()
    {
        foreach ($this->getConfig() as $name => $value) {
            if ($value === null) {
                ...
                // intentionally ==
                throw new \RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Nette\NotSupportedException('Required function ini_set() is disabled.');
            }
        }
    }
}
