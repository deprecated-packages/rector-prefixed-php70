...
use RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Nette\PhpGenerator\Dumper;
use RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Nette\PhpGenerator\Parameter;
/**
 * @internal
 */
trait FunctionLike
{
    ...
    {
        $this->body = $args === null ? $code : (new \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Nette\PhpGenerator\Dumper())->format($code, ...$args);
        return $this;
    }
    ...
    public function setParameters(array $val)
    {
        $this->parameters = [];
        foreach ($val as $v) {
            if (!$v instanceof \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Nette\PhpGenerator\Parameter) {
                throw new \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Nette\InvalidArgumentException('Argument must be Nette\\PhpGenerator\\Parameter[].');
            }
     ...
     */
    public function addParameter(string $name, $defaultValue = null) : \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Nette\PhpGenerator\Parameter
    {
        $param = new \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Nette\PhpGenerator\Parameter($name);
        if (\func_num_args() > 1) {
