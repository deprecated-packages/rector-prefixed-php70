...
final class Helpers
{
    ...
    {
        return (new \RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Nette\PhpGenerator\Dumper())->dump($var);
    }
    /** @deprecated  use Nette\PhpGenerator\Dumper::format() */
    public static function format(string $statement, ...$args) : string
    {
        return (new \RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Nette\PhpGenerator\Dumper())->format($statement, ...$args);
    }
    /** @deprecated  use Nette\PhpGenerator\Dumper::format() */
    ...
    {
        return \RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Nette\PhpGenerator\Dumper::createObject($class, $props);
    }
}
