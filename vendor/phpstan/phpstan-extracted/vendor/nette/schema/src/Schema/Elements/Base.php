...
trait Base
{
    ...
    public function doNormalize($value, \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Nette\Schema\Context $context)
    {
        if ($this->before) {
    ...
    private function doValidate($value, string $expected, \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Nette\Schema\Context $context) : bool
    {
        try {
            \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Nette\Utils\Validators::assert($value, $expected, 'option %path%');
            return \true;
    ...
    private function doFinalize($value, \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Nette\Schema\Context $context)
    {
        if ($this->castTo) {
            if (\RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Nette\Utils\Reflection::isBuiltinType($this->castTo)) {
                \settype($value, $this->castTo);
            } else {
                $value = \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Nette\Utils\Arrays::toObject($value, new $this->castTo());
            }
        }
