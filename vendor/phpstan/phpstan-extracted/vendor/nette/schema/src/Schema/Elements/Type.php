...
use RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Nette\Schema\DynamicParameter;
...
final class Type implements \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Nette\Schema\Schema
{
    use Base;
    ...
    {
        $this->type .= '|' . \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Nette\Schema\DynamicParameter::class;
        return $this;
    }
    /**
     * @return $this
    ...
    {
        $this->items = $type instanceof \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Nette\Schema\Schema ? $type : new self($type);
        return $this;
    }
    /**
     * @return $this
    ...
    public function complete($value, \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Nette\Schema\Context $context)
    {
        ...
        if ($value instanceof \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Nette\Schema\DynamicParameter) {
            $context->dynamics[] = [$value, \str_replace('|' . \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Nette\Schema\DynamicParameter::class, '', $expected)];
        }
        if ($this->items) {
        ...
        $value = \RectorPrefix20210531\_HumbugBox0b2f2d5c77b8\Nette\Schema\Helpers::merge($value, $this->default);
