...
final class AnyOf implements \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\Nette\Schema\Schema
{
    use Base;
    ...
    {
        $this->set[] = new \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\Nette\Schema\Elements\Type(\RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\Nette\Schema\DynamicParameter::class);
        return $this;
    }
    /********************* processing ****************d*g**/
    ...
    public function complete($value, \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\Nette\Schema\Context $context)
    {
        ...
        foreach ($this->set as $item) {
            if ($item instanceof \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\Nette\Schema\Schema) {
                $dolly = new \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\Nette\Schema\Context();
    ...
    public function completeDefault(\RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\Nette\Schema\Context $context)
    {
        ...
        if ($this->default instanceof \RectorPrefix20210523\_HumbugBox0b2f2d5c77b8\Nette\Schema\Schema) {
