...
final class Processor
{
     ...
     */
    public function process(\RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Nette\Schema\Schema $schema, $data)
    {
     ...
     * @throws ValidationException
     */
    public function processMultiple(\RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Nette\Schema\Schema $schema, array $dataset)
    {
        $context = $this->createContext();
        $flatten = null;
        $first = \true;
     ...
     * @return void
     */
    private function throwsErrors(\RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Nette\Schema\Context $context)
    {
        $messages = [];
        ...
        if ($messages) {
            throw new \RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Nette\Schema\ValidationException($messages[0], $messages);
        }
    }
    private function createContext() : \RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Nette\Schema\Context
    {
        $context = new \RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Nette\Schema\Context();
