 ...
 */
class Uri implements \RectorPrefix20210522\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\UriInterface
{
     ...
     * @return UriInterface
     */
    public static function resolve(\RectorPrefix20210522\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\UriInterface $base, $rel)
    {
        if ($rel === null || $rel === '') {
            return $base;
        }
        if (!$rel instanceof \RectorPrefix20210522\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\UriInterface) {
            $rel = new self($rel);
        }
     ...
     * @return UriInterface
     */
    public static function withoutQueryValue(\RectorPrefix20210522\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\UriInterface $uri, $key)
    {
     ...
     * @return UriInterface
     */
    public static function withQueryValue(\RectorPrefix20210522\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\UriInterface $uri, $key, $value)
    {
        $current = $uri->getQuery();
