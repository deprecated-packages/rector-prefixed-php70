 ...
 */
class Request extends \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\RingCentral\Psr7\MessageTrait implements \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\RequestInterface
{
    /** @var string */
    private $method;
    /** @var null|string */
    ...
    {
        if (\is_string($uri)) {
            $uri = new \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\RingCentral\Psr7\Uri($uri);
        } elseif (!$uri instanceof \RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\UriInterface) {
            throw new \InvalidArgumentException('RectorPrefix20210528\\_HumbugBox0b2f2d5c77b8\\URI must be a string or Psr\\Http\\Message\\UriInterface');
        }
    ...
    public function withUri(\RectorPrefix20210528\_HumbugBox0b2f2d5c77b8\Psr\Http\Message\UriInterface $uri, $preserveHost = \false)
    {
        if ($uri === $this->uri) {
            return $this;
        }
