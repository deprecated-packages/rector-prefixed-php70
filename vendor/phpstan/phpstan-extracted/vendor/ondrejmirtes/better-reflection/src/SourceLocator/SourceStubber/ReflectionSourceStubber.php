...
final class ReflectionSourceStubber implements \PHPStan\BetterReflection\SourceLocator\SourceStubber\SourceStubber
{
    ...
    public function generateConstantStub(string $constantName)
    {
        ...
        list($constantValue, $extensionName) = $constantData;
     ...
     * @return void
     */
    private function addDocComment(\PhpParser\Builder $node, \Reflector $reflection)
    {
     ...
     * @return void
     */
    private function addClassModifiers(\PhpParser\Builder\Class_ $classNode, \ReflectionClass $classReflection)
    {
     ...
     * @return void
     */
    private function addExtendsAndImplements(\PhpParser\Builder\Declaration $classNode, \ReflectionClass $classReflection)
    {
     ...
     * @return void
     */
    private function addTraitUse(\PhpParser\Builder\Declaration $classNode, \ReflectionClass $classReflection)
    {
        $alreadyUsedTraitNames = [];
        foreach ($classReflection->getTraitAliases() as $methodNameAlias => $methodInfo) {
            list($traitName, $methodName) = \explode('::', $methodInfo);
     ...
     * @return void
     */
    private function addProperties(\PhpParser\Builder\Declaration $classNode, \ReflectionClass $classReflection)
    {
     ...
     * @return void
     */
    private function addPropertyModifiers(\PhpParser\Builder\Property $propertyNode, \ReflectionProperty $propertyReflection)
    {
     ...
     * @return void
     */
    private function addConstants(\PhpParser\Builder\Declaration $classNode, \ReflectionClass $classReflection)
    {
     ...
     * @return void
     */
    private function addMethods(\PhpParser\Builder\Declaration $classNode, \ReflectionClass $classReflection)
    {
     ...
     * @return void
     */
    private function addMethodFlags(\PhpParser\Builder\Method $methodNode, \ReflectionMethod $methodReflection)
    {
     ...
     * @return void
     */
    private function addParameters(\PhpParser\Builder\FunctionLike $functionNode, \ReflectionFunctionAbstract $functionReflectionAbstract)
    {
     ...
     */
    private function createStubData(string $stub, $extensionName) : \PHPStan\BetterReflection\SourceLocator\SourceStubber\StubData
    {
        return new \PHPStan\BetterReflection\SourceLocator\SourceStubber\StubData($stub, $extensionName);
    }
}
