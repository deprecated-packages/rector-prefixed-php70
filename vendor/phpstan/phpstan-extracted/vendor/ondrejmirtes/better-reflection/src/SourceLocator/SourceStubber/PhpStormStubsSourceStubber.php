...
use Error;
use RectorPrefix20210522\_HumbugBox0b2f2d5c77b8\JetBrains\PHPStormStub\PhpStormStubsMap;
use ParseError;
...
final class PhpStormStubsSourceStubber implements \PHPStan\BetterReflection\SourceLocator\SourceStubber\SourceStubber
{
    ...
    public function __construct(\PhpParser\Parser $phpParser, $phpVersionId = null)
    {
        ...
        $this->classMap = \array_change_key_case(\RectorPrefix20210522\_HumbugBox0b2f2d5c77b8\JetBrains\PHPStormStub\PhpStormStubsMap::CLASSES);
        $this->functionMap = \array_change_key_case(\RectorPrefix20210522\_HumbugBox0b2f2d5c77b8\JetBrains\PHPStormStub\PhpStormStubsMap::FUNCTIONS);
        $this->constantMap = \RectorPrefix20210522\_HumbugBox0b2f2d5c77b8\JetBrains\PHPStormStub\PhpStormStubsMap::CONSTANTS;
    }
