...
class FileIteratorSourceLocator implements \PHPStan\BetterReflection\SourceLocator\Type\SourceLocator
{
     ...
     */
    public function __construct(\Iterator $fileInfoIterator, \PHPStan\BetterReflection\SourceLocator\Ast\Locator $astLocator)
    {
        foreach ($fileInfoIterator as $fileInfo) {
            if (!$fileInfo instanceof \SplFileInfo) {
                throw \PHPStan\BetterReflection\SourceLocator\Exception\InvalidFileInfo::fromNonSplFileInfo($fileInfo);
            }
        }
    ...
    {
        return $this->aggregateSourceLocator ?: new \PHPStan\BetterReflection\SourceLocator\Type\AggregateSourceLocator(\array_values(\array_filter(\array_map(function (\SplFileInfo $item) {
