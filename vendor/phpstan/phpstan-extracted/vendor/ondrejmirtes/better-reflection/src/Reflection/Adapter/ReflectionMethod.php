...
class ReflectionMethod extends \ReflectionMethod
{
    ...
    public function __construct(\PHPStan\BetterReflection\Reflection\ReflectionMethod $betterReflectionMethod)
    {
        $this->betterReflectionMethod = $betterReflectionMethod;
    }
    public function getBetterReflection() : \PHPStan\BetterReflection\Reflection\ReflectionMethod
    {
    ...
    public function getParameters()
    {
        ...
        foreach ($parameters as $key => $parameter) {
            $wrappedParameters[$key] = new \PHPStan\BetterReflection\Reflection\Adapter\ReflectionParameter($parameter);
        }
    ...
    {
        return \PHPStan\BetterReflection\Reflection\Adapter\ReflectionType::fromReturnTypeOrNull($this->betterReflectionMethod->getReturnType());
    }
    /**
     * {@inheritDoc}
     */
