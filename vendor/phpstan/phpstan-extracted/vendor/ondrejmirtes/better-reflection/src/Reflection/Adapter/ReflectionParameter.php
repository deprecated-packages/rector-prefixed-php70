...
class ReflectionParameter extends \ReflectionParameter
{
    ...
    public function __construct(\PHPStan\BetterReflection\Reflection\ReflectionParameter $betterReflectionParameter)
    {
    ...
    public function getDeclaringFunction()
    {
        ...
        \assert($function instanceof \PHPStan\BetterReflection\Reflection\ReflectionMethod || $function instanceof \PHPStan\BetterReflection\Reflection\ReflectionFunction);
        if ($function instanceof \PHPStan\BetterReflection\Reflection\ReflectionMethod) {
    ...
    public function getClass()
    {
        ...
        return new \PHPStan\BetterReflection\Reflection\Adapter\ReflectionClass($class);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return \PHPStan\BetterReflection\Reflection\Adapter\ReflectionType::fromReturnTypeOrNull($this->betterReflectionParameter->getType());
    }
}
