...
class ReflectionClass extends \ReflectionClass
{
    ...
    public function __construct(\PHPStan\BetterReflection\Reflection\ReflectionClass $betterReflectionClass)
    {
        $this->betterReflectionClass = $betterReflectionClass;
        unset($this->name);
    }
    public function getBetterReflection() : \PHPStan\BetterReflection\Reflection\ReflectionClass
    {
    ...
    public static function export($argument, $return = \false)
    {
        if (\is_string($argument) || \is_object($argument)) {
            if (\is_string($argument)) {
                $output = \PHPStan\BetterReflection\Reflection\ReflectionClass::createFromName($argument)->__toString();
            } else {
    ...
    {
        try {
            return new \PHPStan\BetterReflection\Reflection\Adapter\ReflectionMethod($this->betterReflectionClass->getConstructor());
    ...
    {
        return new \PHPStan\BetterReflection\Reflection\Adapter\ReflectionMethod($this->betterReflectionClass->getMethod($name));
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return \array_map(static function (\PHPStan\BetterReflection\Reflection\ReflectionMethod $method) : ReflectionMethod {
    ...
    {
        return new \PHPStan\BetterReflection\Reflection\Adapter\ReflectionClassConstant($this->betterReflectionClass->getReflectionConstant($name));
    }
    /**
     * {@inheritdoc}
     */
    ...
    public function getTraits()
    {
        ...
        $traitsByName = \array_combine($traitNames, \array_map(static function (\PHPStan\BetterReflection\Reflection\ReflectionClass $trait) : self {
