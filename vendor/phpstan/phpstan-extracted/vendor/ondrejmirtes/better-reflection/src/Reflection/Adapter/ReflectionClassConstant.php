...
class ReflectionClassConstant extends \ReflectionClassConstant
{
    ...
    public function __construct(\PHPStan\BetterReflection\Reflection\ReflectionClassConstant $betterClassConstant)
    {
    ...
    {
        return new \PHPStan\BetterReflection\Reflection\Adapter\ReflectionClass($this->betterClassConstant->getDeclaringClass());
    }
    /**
