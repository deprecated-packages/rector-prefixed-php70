...
class ReflectionFunction extends \ReflectionFunction
{
    ...
    public function __construct(\PHPStan\BetterReflection\Reflection\ReflectionFunction $betterReflectionFunction)
    {
    ...
    {
        return \PHPStan\BetterReflection\Reflection\Adapter\ReflectionType::fromReturnTypeOrNull($this->betterReflectionFunction->getReturnType());
    }
    /**
     * {@inheritDoc}
     */
