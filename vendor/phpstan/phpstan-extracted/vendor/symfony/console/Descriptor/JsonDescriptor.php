 ...
 * @internal
 */
class JsonDescriptor extends \RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function describeApplication(\RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Symfony\Component\Console\Application $application, array $options = [])
    {
        ...
        $description = new \RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $describedNamespace, \true);
        $commands = [];
    ...
    private function getInputArgumentData(\RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Symfony\Component\Console\Input\InputArgument $argument) : array
    {
    ...
    private function getInputOptionData(\RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Symfony\Component\Console\Input\InputOption $option) : array
    {
    ...
    private function getInputDefinitionData(\RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Symfony\Component\Console\Input\InputDefinition $definition) : array
    {
        $inputArguments = [];
    ...
    private function getCommandData(\RectorPrefix20210519\_HumbugBox0b2f2d5c77b8\Symfony\Component\Console\Command\Command $command) : array
    {
        $command->getSynopsis();
