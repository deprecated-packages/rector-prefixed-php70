 ...
 */
class StringInput extends \RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\Symfony\Component\Console\Input\ArgvInput
{
    ...
    private function tokenize(string $input) : array
    {
        ...
        while ($cursor < $length) {
            if (\preg_match('/\\s+/A', $input, $match, 0, $cursor)) {
                ...
                // should never happen
                throw new \RectorPrefix20210520\_HumbugBox0b2f2d5c77b8\Symfony\Component\Console\Exception\InvalidArgumentException(\sprintf('Unable to parse input near "... %s ...".', \substr($input, $cursor, 10)));
            }
