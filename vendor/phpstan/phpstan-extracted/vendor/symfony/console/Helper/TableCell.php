...
class TableCell
{
    ...
    public function __construct(string $value = '', array $options = [])
    {
        ...
        if ($diff = \array_diff(\array_keys($options), \array_keys($this->options))) {
            throw new \RectorPrefix20210527\_HumbugBox0b2f2d5c77b8\Symfony\Component\Console\Exception\InvalidArgumentException(\sprintf('The TableCell does not support the following options: \'%s\'.', \implode('\', \'', $diff)));
        }
