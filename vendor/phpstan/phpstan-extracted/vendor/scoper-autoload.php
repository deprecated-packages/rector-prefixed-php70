...
if (!class_exists('ComposerAutoloaderInit0a08881bd4add292d577afcbaf8089ff', false) && !interface_exists('ComposerAutoloaderInit0a08881bd4add292d577afcbaf8089ff', false) && !trait_exists('ComposerAutoloaderInit0a08881bd4add292d577afcbaf8089ff', false)) {
    spl_autoload_call('RectorPrefix20210519\ComposerAutoloaderInit0a08881bd4add292d577afcbaf8089ff');
}
...
if (!class_exists('ReflectionUnionType', false) && !interface_exists('ReflectionUnionType', false) && !trait_exists('ReflectionUnionType', false)) {
    spl_autoload_call('RectorPrefix20210519\ReflectionUnionType');
}
if (!class_exists('ComposerAutoloaderInit76efdea48d97ddd5e412eb932aafadf4', false) && !interface_exists('ComposerAutoloaderInit76efdea48d97ddd5e412eb932aafadf4', false) && !trait_exists('ComposerAutoloaderInit76efdea48d97ddd5e412eb932aafadf4', false)) {
    spl_autoload_call('RectorPrefix20210519\ComposerAutoloaderInit76efdea48d97ddd5e412eb932aafadf4');
}
...
if (!function_exists('composerRequire0a08881bd4add292d577afcbaf8089ff')) {
    function composerRequire0a08881bd4add292d577afcbaf8089ff() {
        return \RectorPrefix20210519\composerRequire0a08881bd4add292d577afcbaf8089ff(...func_get_args());
    }
}
...
if (!function_exists('getUrlFromPath')) {
    function getUrlFromPath() {
        return \RectorPrefix20210519\getUrlFromPath(...func_get_args());
    }
}
if (!function_exists('showJsonError')) {
    function showJsonError() {
        return \RectorPrefix20210519\showJsonError(...func_get_args());
    }
}
if (!function_exists('output')) {
    function output() {
        return \RectorPrefix20210519\output(...func_get_args());
    }
}
if (!function_exists('parseHeaderValue')) {
    function parseHeaderValue() {
        return \RectorPrefix20210519\parseHeaderValue(...func_get_args());
    }
}
...
if (!function_exists('composerRequire76efdea48d97ddd5e412eb932aafadf4')) {
    function composerRequire76efdea48d97ddd5e412eb932aafadf4() {
        return \RectorPrefix20210519\composerRequire76efdea48d97ddd5e412eb932aafadf4(...func_get_args());
    }
}
if (!function_exists('xcallable')) {
    function xcallable() {
        return \RectorPrefix20210519\xcallable(...func_get_args());
    }
}
if (!function_exists('showUsage')) {
    function showUsage() {
        return \RectorPrefix20210519\showUsage(...func_get_args());
    }
}
if (!function_exists('lintFile')) {
    function lintFile() {
        return \RectorPrefix20210519\lintFile(...func_get_args());
    }
}
if (!function_exists('lint')) {
    function lint() {
        return \RectorPrefix20210519\lint(...func_get_args());
    }
}
