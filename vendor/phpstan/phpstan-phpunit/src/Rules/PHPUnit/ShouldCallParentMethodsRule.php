...
class ShouldCallParentMethodsRule implements \PHPStan\Rules\Rule
{
    ...
    public function processNode(\PhpParser\Node $node, \PHPStan\Analyser\Scope $scope) : array
    {
        ...
        if (!$scope->getClassReflection()->isSubclassOf(\RectorPrefix20210620\PHPUnit\Framework\TestCase::class)) {
            return [];
        }
        ...
        if ($parentMethod->getDeclaringClass()->getName() === \RectorPrefix20210620\PHPUnit\Framework\TestCase::class) {
            return [];
        }
