...
namespace RectorPrefix20210517\Symplify\PackageBuilder\Parameter;
...
final class ParameterProvider
{
     ...
     */
    public function __construct(\RectorPrefix20210517\Symfony\Component\DependencyInjection\ContainerInterface $container)
    {
    ...
    public function ensureParameterIsSet(string $name)
    {
        ...
        throw new \RectorPrefix20210517\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException($name);
    }
}
