...
namespace RectorPrefix20210504\Symplify\PackageBuilder\Parameter;
...
use RectorPrefix20210504\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException;
/**
...
final class ParameterProvider
{
     ...
     */
    public function __construct(\RectorPrefix20210504\Symfony\Component\DependencyInjection\ContainerInterface $container)
    {
    ...
    public function ensureParameterIsSet(string $name)
    {
        ...
        throw new \RectorPrefix20210504\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException($name);
    }
}
