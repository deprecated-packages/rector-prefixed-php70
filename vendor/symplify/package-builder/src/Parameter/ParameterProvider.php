...
namespace RectorPrefix20210531\Symplify\PackageBuilder\Parameter;
...
final class ParameterProvider
{
     ...
     */
    public function __construct(\RectorPrefix20210531\Symfony\Component\DependencyInjection\ContainerInterface $container)
    {
    ...
    public function ensureParameterIsSet(string $name)
    {
        ...
        throw new \RectorPrefix20210531\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException($name);
    }
}
