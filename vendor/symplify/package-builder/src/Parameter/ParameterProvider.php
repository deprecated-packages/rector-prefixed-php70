...
namespace RectorPrefix20210503\Symplify\PackageBuilder\Parameter;
...
use RectorPrefix20210503\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException;
/**
...
final class ParameterProvider
{
    ...
    public function ensureParameterIsSet(string $name)
    {
        ...
        throw new \RectorPrefix20210503\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException($name);
    }
}
