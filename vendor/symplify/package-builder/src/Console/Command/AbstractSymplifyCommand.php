...
abstract class AbstractSymplifyCommand extends \RectorPrefix20210518\Symfony\Component\Console\Command\Command
{
    ...
    {
        parent::__construct();
        $this->addOption(\RectorPrefix20210518\Symplify\PackageBuilder\ValueObject\Option::CONFIG, 'c', \RectorPrefix20210518\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to config file');
    }
    /**
     * @required
     * @return void
