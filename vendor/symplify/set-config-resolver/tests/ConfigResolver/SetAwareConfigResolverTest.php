...
namespace RectorPrefix20210504\Symplify\SetConfigResolver\Tests\ConfigResolver;
...
use RectorPrefix20210504\Symplify\SetConfigResolver\SetAwareConfigResolver;
use RectorPrefix20210504\Symplify\SetConfigResolver\Tests\ConfigResolver\Source\DummySetProvider;
use RectorPrefix20210504\Symplify\SmartFileSystem\Exception\FileNotFoundException;
use Symplify\SmartFileSystem\SmartFileInfo;
final class SetAwareConfigResolverTest extends \RectorPrefix20210504\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $this->setAwareConfigResolver = new \RectorPrefix20210504\Symplify\SetConfigResolver\SetAwareConfigResolver(new \RectorPrefix20210504\Symplify\SetConfigResolver\Tests\ConfigResolver\Source\DummySetProvider());
    }
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \RectorPrefix20210504\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    {
        $this->expectException(\RectorPrefix20210504\Symplify\SetConfigResolver\Exception\SetNotFoundException::class);
    ...
    public function testMissingFileInInput()
    {
        ...
        $arrayInput = new \RectorPrefix20210504\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
