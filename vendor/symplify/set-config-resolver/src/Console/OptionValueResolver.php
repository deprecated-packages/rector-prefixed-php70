...
namespace RectorPrefix20210503\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     * @return string|null
     */
    public function getOptionValue(\RectorPrefix20210503\Symfony\Component\Console\Input\InputInterface $input, array $optionNames)
    {
