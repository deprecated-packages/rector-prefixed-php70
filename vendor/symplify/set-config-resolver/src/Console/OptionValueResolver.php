...
namespace RectorPrefix20210504\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     * @return string|null
     */
    public function getOptionValue(\RectorPrefix20210504\Symfony\Component\Console\Input\InputInterface $input, array $optionNames)
    {
