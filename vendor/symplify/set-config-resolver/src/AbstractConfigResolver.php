...
namespace RectorPrefix20210504\Symplify\SetConfigResolver;

use RectorPrefix20210504\Symfony\Component\Console\Input\InputInterface;
use RectorPrefix20210504\Symplify\SetConfigResolver\Console\Option\OptionName;
use RectorPrefix20210504\Symplify\SetConfigResolver\Console\OptionValueResolver;
...
abstract class AbstractConfigResolver
{
    ...
    {
        $this->optionValueResolver = new \RectorPrefix20210504\Symplify\SetConfigResolver\Console\OptionValueResolver();
    }
    /**
     * @return \Symplify\SmartFileSystem\SmartFileInfo|null
     */
    public function resolveFromInput(\RectorPrefix20210504\Symfony\Component\Console\Input\InputInterface $input)
    {
        $configValue = $this->optionValueResolver->getOptionValue($input, \RectorPrefix20210504\Symplify\SetConfigResolver\Console\Option\OptionName::CONFIG);
        if ($configValue !== null) {
            if (!\file_exists($configValue)) {
                $message = \sprintf('File "%s" was not found', $configValue);
                throw new \RectorPrefix20210504\Symplify\SmartFileSystem\Exception\FileNotFoundException($message);
            }
     ...
     * @return \Symplify\SmartFileSystem\SmartFileInfo|null
     */
    public function resolveFromInputWithFallback(\RectorPrefix20210504\Symfony\Component\Console\Input\InputInterface $input, array $fallbackFiles)
    {
