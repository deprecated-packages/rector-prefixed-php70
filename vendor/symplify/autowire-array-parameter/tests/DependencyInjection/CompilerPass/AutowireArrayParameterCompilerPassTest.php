...
namespace RectorPrefix20210503\Symplify\AutowireArrayParameter\Tests\DependencyInjection\CompilerPass;

use RectorPrefix20210503\Symplify\AutowireArrayParameter\Tests\HttpKernel\AutowireArrayParameterHttpKernel;
use RectorPrefix20210503\Symplify\AutowireArrayParameter\Tests\Source\ArrayShapeCollector;
use RectorPrefix20210503\Symplify\AutowireArrayParameter\Tests\Source\Contract\FirstCollectedInterface;
use RectorPrefix20210503\Symplify\AutowireArrayParameter\Tests\Source\Contract\SecondCollectedInterface;
use RectorPrefix20210503\Symplify\AutowireArrayParameter\Tests\Source\IterableCollector;
use RectorPrefix20210503\Symplify\AutowireArrayParameter\Tests\Source\SomeCollector;
...
final class AutowireArrayParameterCompilerPassTest extends \RectorPrefix20210503\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    public function testIterable()
    {
        ...
        $this->assertInstanceOf(\RectorPrefix20210503\Symplify\AutowireArrayParameter\Tests\Source\Contract\FirstCollectedInterface::class, $iterableCollector->getFirstCollected()[0]);
        $this->assertInstanceOf(\RectorPrefix20210503\Symplify\AutowireArrayParameter\Tests\Source\Contract\SecondCollectedInterface::class, $iterableCollector->getSecondCollected()[0]);
    }
}
