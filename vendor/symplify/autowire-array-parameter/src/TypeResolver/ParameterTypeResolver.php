...
namespace RectorPrefix20210503\Symplify\AutowireArrayParameter\TypeResolver;
...
final class ParameterTypeResolver
{
    ...
    public function __construct(\RectorPrefix20210503\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver $paramTypeDocBlockResolver)
    {
    ...
    public function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod)
    {
        ...
        $resolvedClass = \RectorPrefix20210503\Nette\Utils\Reflection::expandClassName($resolvedType, $declaringReflectionClass);
