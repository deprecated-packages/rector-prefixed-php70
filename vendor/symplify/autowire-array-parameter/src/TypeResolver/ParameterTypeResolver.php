...
namespace RectorPrefix20210504\Symplify\AutowireArrayParameter\TypeResolver;
...
final class ParameterTypeResolver
{
    ...
    public function __construct(\RectorPrefix20210504\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver $paramTypeDocBlockResolver)
    {
    ...
    public function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod)
    {
        ...
        $resolvedClass = \RectorPrefix20210504\Nette\Utils\Reflection::expandClassName($resolvedType, $declaringReflectionClass);
