...
namespace RectorPrefix20210522\Symplify\ComposerJsonManipulator\FileSystem;

use RectorPrefix20210522\Nette\Utils\Json;
use RectorPrefix20210522\Symplify\ComposerJsonManipulator\Json\JsonCleaner;
use RectorPrefix20210522\Symplify\ComposerJsonManipulator\Json\JsonInliner;
use RectorPrefix20210522\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson;
use RectorPrefix20210522\Symplify\PackageBuilder\Configuration\StaticEolConfiguration;
...
final class JsonFileManager
{
    ...
    public function __construct(\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \RectorPrefix20210522\Symplify\ComposerJsonManipulator\Json\JsonCleaner $jsonCleaner, \RectorPrefix20210522\Symplify\ComposerJsonManipulator\Json\JsonInliner $jsonInliner)
    {
    ...
    public function loadFromFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
        ...
        if (!isset($this->cachedJSONFiles[$realPath])) {
            $this->cachedJSONFiles[$realPath] = \RectorPrefix20210522\Nette\Utils\Json::decode($smartFileInfo->getContents(), \RectorPrefix20210522\Nette\Utils\Json::FORCE_ARRAY);
        }
    ...
    public function printComposerJsonToFilePath(\RectorPrefix20210522\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, string $filePath) : string
    {
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \RectorPrefix20210522\Nette\Utils\Json::encode($json, \RectorPrefix20210522\Nette\Utils\Json::PRETTY) . \RectorPrefix20210522\Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
