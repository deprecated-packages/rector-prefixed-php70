...
namespace RectorPrefix20210520\Symplify\ComposerJsonManipulator\FileSystem;

use RectorPrefix20210520\Nette\Utils\Json;
use RectorPrefix20210520\Symplify\ComposerJsonManipulator\Json\JsonCleaner;
use RectorPrefix20210520\Symplify\ComposerJsonManipulator\Json\JsonInliner;
use RectorPrefix20210520\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson;
use RectorPrefix20210520\Symplify\PackageBuilder\Configuration\StaticEolConfiguration;
...
final class JsonFileManager
{
    ...
    public function __construct(\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \RectorPrefix20210520\Symplify\ComposerJsonManipulator\Json\JsonCleaner $jsonCleaner, \RectorPrefix20210520\Symplify\ComposerJsonManipulator\Json\JsonInliner $jsonInliner)
    {
    ...
    public function loadFromFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
        ...
        if (!isset($this->cachedJSONFiles[$realPath])) {
            $this->cachedJSONFiles[$realPath] = \RectorPrefix20210520\Nette\Utils\Json::decode($smartFileInfo->getContents(), \RectorPrefix20210520\Nette\Utils\Json::FORCE_ARRAY);
        }
    ...
    public function printComposerJsonToFilePath(\RectorPrefix20210520\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, string $filePath) : string
    {
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \RectorPrefix20210520\Nette\Utils\Json::encode($json, \RectorPrefix20210520\Nette\Utils\Json::PRETTY) . \RectorPrefix20210520\Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
