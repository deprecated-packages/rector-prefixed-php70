 ...
 */
final class SmartFileSystem extends \RectorPrefix20210504\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile(string $filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \RectorPrefix20210504\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    ...
    private function getLastError() : string
    {
        ...
        return \RectorPrefix20210504\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX, '');
    }
}
