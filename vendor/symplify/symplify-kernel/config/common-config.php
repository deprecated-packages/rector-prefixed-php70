...
return static function (\RectorPrefix20210517\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) {
    ...
    // filesystem
    $services->set(\RectorPrefix20210517\Symplify\SmartFileSystem\Finder\FinderSanitizer::class);
    $services->set(\RectorPrefix20210517\Symplify\SmartFileSystem\SmartFileSystem::class);
    $services->set(\RectorPrefix20210517\Symplify\SmartFileSystem\Finder\SmartFinder::class);
    $services->set(\RectorPrefix20210517\Symplify\SmartFileSystem\FileSystemGuard::class);
    $services->set(\RectorPrefix20210517\Symplify\SmartFileSystem\FileSystemFilter::class);
