...
use RectorPrefix20210503\Symplify\ComposerJsonManipulator\ComposerJsonFactory;
use RectorPrefix20210503\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager;
use RectorPrefix20210503\Symplify\ComposerJsonManipulator\Json\JsonCleaner;
use RectorPrefix20210503\Symplify\ComposerJsonManipulator\Json\JsonInliner;
...
use RectorPrefix20210503\Symplify\SmartFileSystem\Finder\SmartFinder;
...
return static function (\RectorPrefix20210503\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) {
    ...
    $services->set(\RectorPrefix20210503\Symplify\SmartFileSystem\Finder\SmartFinder::class);
    ...
    $services->set(\RectorPrefix20210503\Symplify\PackageBuilder\Parameter\ParameterProvider::class)->args([\RectorPrefix20210503\Symfony\Component\DependencyInjection\Loader\Configurator\service(\RectorPrefix20210503\Symfony\Component\DependencyInjection\ContainerInterface::class)]);
    $services->set(\RectorPrefix20210503\Symplify\PackageBuilder\Reflection\PrivatesAccessor::class);
    $services->set(\RectorPrefix20210503\Symplify\SymplifyKernel\Console\ConsoleApplicationFactory::class);
    // composer json factory
    $services->set(\RectorPrefix20210503\Symplify\ComposerJsonManipulator\ComposerJsonFactory::class);
    $services->set(\RectorPrefix20210503\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager::class);
    $services->set(\RectorPrefix20210503\Symplify\ComposerJsonManipulator\Json\JsonCleaner::class);
    $services->set(\RectorPrefix20210503\Symplify\ComposerJsonManipulator\Json\JsonInliner::class);
};
