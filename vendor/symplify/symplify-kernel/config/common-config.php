...
return static function (\RectorPrefix20210518\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) {
    ...
    // filesystem
    $services->set(\RectorPrefix20210518\Symplify\SmartFileSystem\Finder\FinderSanitizer::class);
    $services->set(\RectorPrefix20210518\Symplify\SmartFileSystem\SmartFileSystem::class);
    $services->set(\RectorPrefix20210518\Symplify\SmartFileSystem\Finder\SmartFinder::class);
    $services->set(\RectorPrefix20210518\Symplify\SmartFileSystem\FileSystemGuard::class);
    $services->set(\RectorPrefix20210518\Symplify\SmartFileSystem\FileSystemFilter::class);
