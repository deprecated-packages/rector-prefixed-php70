...
abstract class AbstractSymplifyConsoleApplication extends \RectorPrefix20210503\Symfony\Component\Console\Application
{
    /**
     * @var CommandNaming
     */
    ...
    {
        $this->commandNaming = new \RectorPrefix20210503\Symplify\PackageBuilder\Console\Command\CommandNaming();
