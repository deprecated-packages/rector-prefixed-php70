...
namespace RectorPrefix20210518\Symplify\Astral\NodeFinder;

use PhpParser\Node;
use PhpParser\NodeFinder;
use RectorPrefix20210518\Symplify\Astral\ValueObject\CommonAttributeKey;
...
final class SimpleNodeFinder
{
     ...
     */
    private $nodeFinder;
    public function __construct(\RectorPrefix20210518\Symplify\PackageBuilder\Php\TypeChecker $typeChecker, \PhpParser\NodeFinder $nodeFinder)
    {
    ...
    {
        $node = $node->getAttribute(\RectorPrefix20210518\Symplify\Astral\ValueObject\CommonAttributeKey::PARENT);
        while ($node) {
