...
namespace RectorPrefix20210503\Symplify\Astral\Tests\NodeValue;
...
use RectorPrefix20210503\Symplify\Astral\NodeFinder\SimpleNodeFinder;
use RectorPrefix20210503\Symplify\Astral\NodeValue\NodeValueResolver;
use RectorPrefix20210503\Symplify\Astral\StaticFactory\SimpleNameResolverStaticFactory;
use RectorPrefix20210503\Symplify\PackageBuilder\Php\TypeChecker;
final class NodeValueResolverTest extends \RectorPrefix20210503\PHPUnit\Framework\TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->nodeValueResolver = new \RectorPrefix20210503\Symplify\Astral\NodeValue\NodeValueResolver($simpleNameResolver, new \RectorPrefix20210503\Symplify\PackageBuilder\Php\TypeChecker(), $simpleNodeFinder);
    }
    /**
