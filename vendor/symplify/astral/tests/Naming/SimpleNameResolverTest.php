...
namespace RectorPrefix20210503\Symplify\Astral\Tests\Naming;

use Iterator;
use PhpParser\Node;
use PhpParser\Node\Identifier;
use RectorPrefix20210503\Symplify\Astral\HttpKernel\AstralKernel;
...
final class SimpleNameResolverTest extends \RectorPrefix20210503\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
