...
namespace RectorPrefix20210528\Symplify\Skipper\FileSystem;
...
final class PathNormalizer
{
    ...
    {
        // ends with *
        if (\RectorPrefix20210528\Nette\Utils\Strings::match($path, self::ONLY_ENDS_WITH_ASTERISK_REGEX)) {
            return '*' . $path;
        }
        // starts with *
        if (\RectorPrefix20210528\Nette\Utils\Strings::match($path, self::ONLY_STARTS_WITH_ASTERISK_REGEX)) {
            return $path . '*';
        }
