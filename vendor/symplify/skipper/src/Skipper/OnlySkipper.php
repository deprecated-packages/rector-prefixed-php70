...
namespace RectorPrefix20210520\Symplify\Skipper\Skipper;
...
final class OnlySkipper
{
    ...
    public function __construct(\RectorPrefix20210520\Symplify\Skipper\Matcher\FileInfoMatcher $fileInfoMatcher)
    {
