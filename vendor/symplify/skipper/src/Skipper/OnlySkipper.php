...
namespace RectorPrefix20210527\Symplify\Skipper\Skipper;
...
final class OnlySkipper
{
    ...
    public function __construct(\RectorPrefix20210527\Symplify\Skipper\Matcher\FileInfoMatcher $fileInfoMatcher)
    {
