...
namespace RectorPrefix20210616\Symplify\Skipper\Skipper;
...
final class OnlySkipper
{
    ...
    public function __construct(\RectorPrefix20210616\Symplify\Skipper\Matcher\FileInfoMatcher $fileInfoMatcher)
    {
