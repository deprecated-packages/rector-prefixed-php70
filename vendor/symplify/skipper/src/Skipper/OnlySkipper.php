...
namespace RectorPrefix20210503\Symplify\Skipper\Skipper;
...
final class OnlySkipper
{
    ...
    public function __construct(\RectorPrefix20210503\Symplify\Skipper\Matcher\FileInfoMatcher $fileInfoMatcher)
    {
