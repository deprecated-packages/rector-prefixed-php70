...
namespace RectorPrefix20210504\Symplify\Skipper\Skipper;
...
final class OnlySkipper
{
    ...
    public function __construct(\RectorPrefix20210504\Symplify\Skipper\Matcher\FileInfoMatcher $fileInfoMatcher)
    {
