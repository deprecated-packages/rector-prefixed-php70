...
final class SkippedPathsResolver
{
    ...
    public function __construct(\RectorPrefix20210525\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Symplify\SmartFileSystem\Normalizer\PathNormalizer $pathNormalizer)
    {
