...
namespace RectorPrefix20210503\Symplify\Skipper\Tests\FileSystem;

use Iterator;
use RectorPrefix20210503\Symplify\PackageBuilder\Testing\AbstractKernelTestCase;
use RectorPrefix20210503\Symplify\Skipper\FileSystem\PathNormalizer;
use RectorPrefix20210503\Symplify\Skipper\HttpKernel\SkipperKernel;
final class PathNormalizerTest extends \RectorPrefix20210503\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var PathNormalizer
     */
