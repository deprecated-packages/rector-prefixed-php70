...
use RectorPrefix20210522\Symplify\EasyTesting\Console\EasyTestingConsoleApplication;
...
return static function (\RectorPrefix20210522\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) {
    ...
    $services->load('RectorPrefix20210522\Symplify\\EasyTesting\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/DataProvider', __DIR__ . '/../src/HttpKernel', __DIR__ . '/../src/ValueObject']);
    // console
    $services->set(\RectorPrefix20210522\Symplify\EasyTesting\Console\EasyTestingConsoleApplication::class);
    $services->alias(\RectorPrefix20210522\Symfony\Component\Console\Application::class, \RectorPrefix20210522\Symplify\EasyTesting\Console\EasyTestingConsoleApplication::class);
