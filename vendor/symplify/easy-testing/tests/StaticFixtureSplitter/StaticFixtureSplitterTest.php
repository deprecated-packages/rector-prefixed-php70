...
namespace RectorPrefix20210504\Symplify\EasyTesting\Tests\StaticFixtureSplitter;
...
final class StaticFixtureSplitterTest extends \RectorPrefix20210504\PHPUnit\Framework\TestCase
{
    public function test()
    {
        $fileInfo = new \Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/simple_fixture.php.inc');
        $inputAndExpected = \RectorPrefix20210504\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToInputAndExpected($fileInfo);
    ...
    public function testSplitFileInfoToLocalInputAndExpected()
    {
        ...
        $inputFileInfoAndExpected = \RectorPrefix20210504\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToLocalInputAndExpected($fileInfo);
