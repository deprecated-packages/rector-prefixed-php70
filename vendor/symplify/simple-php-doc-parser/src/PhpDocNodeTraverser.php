...
namespace RectorPrefix20210518\Symplify\SimplePhpDocParser;

use PHPStan\PhpDocParser\Ast\Node;
use RectorPrefix20210518\Symplify\SimplePhpDocParser\Contract\PhpDocNodeVisitorInterface;
use RectorPrefix20210518\Symplify\SimplePhpDocParser\PhpDocNodeVisitor\CallablePhpDocNodeVisitor;
/**
 * Mimics
...
final class PhpDocNodeTraverser
{
     ...
     * @return void
     */
    public function addPhpDocNodeVisitor(\RectorPrefix20210518\Symplify\SimplePhpDocParser\Contract\PhpDocNodeVisitorInterface $phpDocNodeVisitor)
    {
    ...
    {
        $callablePhpDocNodeVisitor = new \RectorPrefix20210518\Symplify\SimplePhpDocParser\PhpDocNodeVisitor\CallablePhpDocNodeVisitor($callable, $docContent);
