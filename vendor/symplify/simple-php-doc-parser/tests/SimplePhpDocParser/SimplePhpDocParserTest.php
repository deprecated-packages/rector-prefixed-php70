...
namespace RectorPrefix20210503\Symplify\SimplePhpDocParser\Tests\SimplePhpDocParser;
...
use RectorPrefix20210503\Symplify\SimplePhpDocParser\ValueObject\Ast\PhpDoc\SimplePhpDocNode;
use Symplify\SmartFileSystem\SmartFileInfo;
final class SimplePhpDocParserTest extends \RectorPrefix20210503\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    public function testVar()
    {
        ...
        $this->assertInstanceOf(\RectorPrefix20210503\Symplify\SimplePhpDocParser\ValueObject\Ast\PhpDoc\SimplePhpDocNode::class, $phpDocNode);
