...
namespace RectorPrefix20210503\Symplify\SimplePhpDocParser\Tests\PhpDocNodeVisitor;
...
use RectorPrefix20210503\Symplify\SimplePhpDocParser\Tests\HttpKernel\SimplePhpDocParserKernel;
use RectorPrefix20210503\Symplify\SimplePhpDocParser\ValueObject\PhpDocAttributeKey;
final class ParentConnectingPhpDocNodeVisitorTest extends \RectorPrefix20210503\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    public function testTypeNode()
    {
        ...
        $returnParent = $returnTagValueNode->getAttribute(\RectorPrefix20210503\Symplify\SimplePhpDocParser\ValueObject\PhpDocAttributeKey::PARENT);
        $this->assertSame($phpDocChildNode, $returnParent);
        $returnTypeParent = $returnTagValueNode->type->getAttribute(\RectorPrefix20210503\Symplify\SimplePhpDocParser\ValueObject\PhpDocAttributeKey::PARENT);
