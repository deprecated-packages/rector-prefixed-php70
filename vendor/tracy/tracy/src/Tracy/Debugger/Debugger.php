...
class Debugger
{
     ...
     * @return void
     */
    public static function setLogger(\RectorPrefix20210526\Tracy\ILogger $logger)
    {
        self::$logger = $logger;
    }
