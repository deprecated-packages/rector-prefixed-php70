...
final class Exposer
{
     ...
     * @return void
     */
    public static function exposeObject($obj, \RectorPrefix20210620\Tracy\Dumper\Value $value, \RectorPrefix20210620\Tracy\Dumper\Describer $describer)
    {
        $tmp = (array) $obj;
        $values = $tmp;
        // bug #79477, PHP < 7.4.6
     ...
     * @return void
     */
    public static function exposeClosure(\Closure $obj, \RectorPrefix20210620\Tracy\Dumper\Value $value, \RectorPrefix20210620\Tracy\Dumper\Describer $describer)
    {
     ...
     * @return void
     */
    public static function exposeArrayObject(\ArrayObject $obj, \RectorPrefix20210620\Tracy\Dumper\Value $value, \RectorPrefix20210620\Tracy\Dumper\Describer $describer)
    {
        $flags = $obj->getFlags();
     ...
     * @return void
     */
    public static function exposeDOMNode(\DOMNode $obj, \RectorPrefix20210620\Tracy\Dumper\Value $value, \RectorPrefix20210620\Tracy\Dumper\Describer $describer)
    {
     ...
     * @return void
     */
    public static function exposeDOMNodeList($obj, \RectorPrefix20210620\Tracy\Dumper\Value $value, \RectorPrefix20210620\Tracy\Dumper\Describer $describer)
    {
     ...
     * @return void
     */
    public static function exposePhpIncompleteClass(\__PHP_Incomplete_Class $obj, \RectorPrefix20210620\Tracy\Dumper\Value $value, \RectorPrefix20210620\Tracy\Dumper\Describer $describer)
    {
        $values = (array) $obj;
     ...
     * @return void
     */
    public static function exposeDsCollection(\Ds\Collection $obj, \RectorPrefix20210620\Tracy\Dumper\Value $value, \RectorPrefix20210620\Tracy\Dumper\Describer $describer)
    {
        foreach ($obj as $k => $v) {
     ...
     * @return void
     */
    public static function exposeDsMap(\Ds\Map $obj, \RectorPrefix20210620\Tracy\Dumper\Value $value, \RectorPrefix20210620\Tracy\Dumper\Describer $describer)
    {
        $i = 0;
        foreach ($obj as $k => $v) {
