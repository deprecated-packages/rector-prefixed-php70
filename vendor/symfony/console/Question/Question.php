 ...
 */
namespace RectorPrefix20210504\Symfony\Component\Console\Question;
...
class Question
{
    ...
    public function setHidden($hidden)
    {
        if ($this->autocompleterCallback) {
            throw new \RectorPrefix20210504\Symfony\Component\Console\Exception\LogicException('A hidden question cannot use the autocompleter.');
        }
    ...
    public function setMaxAttempts($attempts)
    {
        if (null !== $attempts) {
            ...
            if ($attempts < 1) {
                throw new \RectorPrefix20210504\Symfony\Component\Console\Exception\InvalidArgumentException('Maximum number of attempts must be a positive value.');
            }
        }
