...
abstract class Helper implements \RectorPrefix20210531\Symfony\Component\Console\Helper\HelperInterface
{
     ...
     * @param string|null $string
     */
    public static function strlenWithoutDecoration(\RectorPrefix20210531\Symfony\Component\Console\Formatter\OutputFormatterInterface $formatter, $string)
    {
     ...
     * @param string|null $string
     */
    public static function removeDecoration(\RectorPrefix20210531\Symfony\Component\Console\Formatter\OutputFormatterInterface $formatter, $string)
    {
