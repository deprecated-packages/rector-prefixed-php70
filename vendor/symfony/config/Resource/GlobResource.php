...
use RectorPrefix20210531\Symfony\Component\Finder\Glob;
/**
 ...
 * @final
 */
class GlobResource implements \IteratorAggregate, \RectorPrefix20210531\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\RectorPrefix20210531\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \RectorPrefix20210531\Symfony\Component\Finder\Finder();
        $regex = \RectorPrefix20210531\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {
