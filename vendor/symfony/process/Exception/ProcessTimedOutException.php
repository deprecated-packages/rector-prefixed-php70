 ...
 */
class ProcessTimedOutException extends \RectorPrefix20210503\Symfony\Component\Process\Exception\RuntimeException
{
    const TYPE_GENERAL = 1;
    const TYPE_IDLE = 2;
    private $process;
    private $timeoutType;
    public function __construct(\RectorPrefix20210503\Symfony\Component\Process\Process $process, int $timeoutType)
    {
