...
trigger_deprecation('symfony/event-dispatcher', '5.1', '%s is deprecated, use the event dispatcher without the proxy.', \RectorPrefix20210531\Symfony\Component\EventDispatcher\LegacyEventDispatcherProxy::class);
/**
