...
use RectorPrefix20210525\Composer\InstalledVersions;
use RectorPrefix20210525\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use RectorPrefix20210525\Doctrine\Persistence\Proxy;
use RectorPrefix20210525\Mockery\MockInterface;
use RectorPrefix20210525\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use RectorPrefix20210525\PHPUnit\Framework\MockObject\MockObject;
use RectorPrefix20210525\Prophecy\Prophecy\ProphecySubjectInterface;
use RectorPrefix20210525\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable()
    {
        ...
        \class_exists(\RectorPrefix20210525\Symfony\Component\ErrorHandler\ErrorHandler::class);
        \class_exists(\RectorPrefix20210525\Psr\Log\LogLevel::class);
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($parentAndOwnInterfaces + \class_uses($class, \false) as $use) {
            ...
            if (isset(self::$method[$use])) {
                if ($refl->isAbstract()) {
                    ...
                    if (!\strncmp($vendor, \str_replace('_', '\\', $use), $vendorLen) && 0 === \strpos($className, 'Symfony\\') && (!\class_exists(\RectorPrefix20210525\Composer\InstalledVersions::class) || 'symfony/symfony' !== \RectorPrefix20210525\Composer\InstalledVersions::getRootPackage()['name'])) {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \RectorPrefix20210525\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
