 ...
 */
namespace RectorPrefix20210503\Symfony\Component\ErrorHandler\ErrorRenderer;
 ...
 */
class HtmlErrorRenderer implements \RectorPrefix20210503\Symfony\Component\ErrorHandler\ErrorRenderer\ErrorRendererInterface
{
    const GHOST_ADDONS = ['02-14' => self::GHOST_HEART, '02-29' => self::GHOST_PLUS, '10-18' => self::GHOST_GIFT];
     ...
     */
    public function __construct($debug = \false, string $charset = null, $fileLinkFormat = null, string $projectDir = null, $outputBuffer = '', \RectorPrefix20210503\Psr\Log\LoggerInterface $logger = null)
    {
     ...
     * {@inheritdoc}
     */
    public function render(\Throwable $exception) : \RectorPrefix20210503\Symfony\Component\ErrorHandler\Exception\FlattenException
    {
        ...
        $exception = \RectorPrefix20210503\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception, null, $headers);
        return $exception->setAsString($this->renderException($exception));
    }
    /**
     * Gets the HTML content associated with the given exception.
     */
    public function getBody(\RectorPrefix20210503\Symfony\Component\ErrorHandler\Exception\FlattenException $exception) : string
    {
    ...
    public static function isDebug(\RectorPrefix20210503\Symfony\Component\HttpFoundation\RequestStack $requestStack, bool $debug) : \Closure
    {
    ...
    public static function getAndCleanOutputBuffer(\RectorPrefix20210503\Symfony\Component\HttpFoundation\RequestStack $requestStack) : \Closure
    {
        return static function () use($requestStack) : string {
            ...
            \RectorPrefix20210503\Symfony\Component\HttpFoundation\Response::closeOutputBuffers($startObLevel + 1, \true);
            return \ob_get_clean();
        };
    }
    private function renderException(\RectorPrefix20210503\Symfony\Component\ErrorHandler\Exception\FlattenException $exception, string $debugTemplate = 'views/exception_full.html.php') : string
    {
