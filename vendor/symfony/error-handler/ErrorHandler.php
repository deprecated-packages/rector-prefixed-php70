 ...
 */
namespace RectorPrefix20210503\Symfony\Component\ErrorHandler;

use RectorPrefix20210503\Psr\Log\LoggerInterface;
use RectorPrefix20210503\Psr\Log\LogLevel;
use RectorPrefix20210503\Symfony\Component\ErrorHandler\Error\FatalError;
use RectorPrefix20210503\Symfony\Component\ErrorHandler\Error\OutOfMemoryError;
use RectorPrefix20210503\Symfony\Component\ErrorHandler\ErrorEnhancer\ClassNotFoundErrorEnhancer;
use RectorPrefix20210503\Symfony\Component\ErrorHandler\ErrorEnhancer\ErrorEnhancerInterface;
use RectorPrefix20210503\Symfony\Component\ErrorHandler\ErrorEnhancer\UndefinedFunctionErrorEnhancer;
use RectorPrefix20210503\Symfony\Component\ErrorHandler\ErrorEnhancer\UndefinedMethodErrorEnhancer;
use RectorPrefix20210503\Symfony\Component\ErrorHandler\ErrorRenderer\CliErrorRenderer;
use RectorPrefix20210503\Symfony\Component\ErrorHandler\ErrorRenderer\HtmlErrorRenderer;
...
class ErrorHandler
{
    ...
    private $loggers = [\E_DEPRECATED => [null, \RectorPrefix20210503\Psr\Log\LogLevel::INFO], \E_USER_DEPRECATED => [null, \RectorPrefix20210503\Psr\Log\LogLevel::INFO], \E_NOTICE => [null, \RectorPrefix20210503\Psr\Log\LogLevel::WARNING], \E_USER_NOTICE => [null, \RectorPrefix20210503\Psr\Log\LogLevel::WARNING], \E_STRICT => [null, \RectorPrefix20210503\Psr\Log\LogLevel::WARNING], \E_WARNING => [null, \RectorPrefix20210503\Psr\Log\LogLevel::WARNING], \E_USER_WARNING => [null, \RectorPrefix20210503\Psr\Log\LogLevel::WARNING], \E_COMPILE_WARNING => [null, \RectorPrefix20210503\Psr\Log\LogLevel::WARNING], \E_CORE_WARNING => [null, \RectorPrefix20210503\Psr\Log\LogLevel::WARNING], \E_USER_ERROR => [null, \RectorPrefix20210503\Psr\Log\LogLevel::CRITICAL], \E_RECOVERABLE_ERROR => [null, \RectorPrefix20210503\Psr\Log\LogLevel::CRITICAL], \E_COMPILE_ERROR => [null, \RectorPrefix20210503\Psr\Log\LogLevel::CRITICAL], \E_PARSE => [null, \RectorPrefix20210503\Psr\Log\LogLevel::CRITICAL], \E_ERROR => [null, \RectorPrefix20210503\Psr\Log\LogLevel::CRITICAL], \E_CORE_ERROR => [null, \RectorPrefix20210503\Psr\Log\LogLevel::CRITICAL]];
    ...
    public function __construct(\RectorPrefix20210503\Symfony\Component\ErrorHandler\BufferingLogger $bootstrappingLogger = null, bool $debug = \false)
    {
     ...
     * @return void
     */
    public function setDefaultLogger(\RectorPrefix20210503\Psr\Log\LoggerInterface $logger, $levels = \E_ALL, bool $replace = \false)
    {
        $loggers = [];
        if (\is_array($levels)) {
    ...
    public function setLoggers(array $loggers) : array
    {
        ...
        foreach ($loggers as $type => $log) {
            ...
            } elseif ($log[0] instanceof \RectorPrefix20210503\Psr\Log\LoggerInterface) {
                $this->loggedErrors |= $type;
            } else {
        ...
        if ($flush) {
            foreach ($this->bootstrappingLogger->cleanLogs() as $log) {
                $type = \RectorPrefix20210503\Symfony\Component\ErrorHandler\ThrowableUtils::getSeverity($log[2]['exception']);
                if (!isset($flush[$type])) {
    ...
    public function handleError(int $type, string $message, string $file, int $line) : bool
    {
        ...
        if (null !== self::$toStringException) {
            ...
            if (!isset(self::$silencedErrorCache[$id = $file . ':' . $line])) {
                ...
                $errorAsException = new \RectorPrefix20210503\Symfony\Component\ErrorHandler\Exception\SilencedErrorContext($type, $file, $line, isset($lightTrace[1]) ? [$lightTrace[0]] : $lightTrace);
        ...
        if ($this->isRecursive) {
            ...
            try {
                ...
                $level = $type & $level ? $this->loggers[$type][1] : \RectorPrefix20210503\Psr\Log\LogLevel::DEBUG;
    ...
    public function handleException(\Throwable $exception)
    {
        ...
        if (!$exception instanceof \RectorPrefix20210503\Symfony\Component\ErrorHandler\Error\FatalError) {
            self::$exitCode = 255;
            $type = \RectorPrefix20210503\Symfony\Component\ErrorHandler\ThrowableUtils::getSeverity($exception);
        } else {
        ...
        if (!$exception instanceof \RectorPrefix20210503\Symfony\Component\ErrorHandler\Error\OutOfMemoryError) {
    ...
    public static function handleFatalError(array $error = null)
    {
        ...
        if ($error && ($error['type'] &= \E_PARSE | \E_ERROR | \E_CORE_ERROR | \E_COMPILE_ERROR)) {
            ...
            if (0 === \strpos($error['message'], 'Allowed memory') || 0 === \strpos($error['message'], 'Out of memory')) {
                $fatalError = new \RectorPrefix20210503\Symfony\Component\ErrorHandler\Error\OutOfMemoryError($handler->levels[$error['type']] . ': ' . $error['message'], 0, $error, 2, \false, $trace);
            } else {
                $fatalError = new \RectorPrefix20210503\Symfony\Component\ErrorHandler\Error\FatalError($handler->levels[$error['type']] . ': ' . $error['message'], 0, $error, 2, \true, $trace);
            }
        } else {
            $fatalError = null;
        }
        ...
        } catch (\RectorPrefix20210503\Symfony\Component\ErrorHandler\Error\FatalError $e) {
    ...
    {
        $renderer = \in_array(\PHP_SAPI, ['cli', 'phpdbg'], \true) ? new \RectorPrefix20210503\Symfony\Component\ErrorHandler\ErrorRenderer\CliErrorRenderer() : new \RectorPrefix20210503\Symfony\Component\ErrorHandler\ErrorRenderer\HtmlErrorRenderer($this->debug);
    ...
    {
        return [new \RectorPrefix20210503\Symfony\Component\ErrorHandler\ErrorEnhancer\UndefinedFunctionErrorEnhancer(), new \RectorPrefix20210503\Symfony\Component\ErrorHandler\ErrorEnhancer\UndefinedMethodErrorEnhancer(), new \RectorPrefix20210503\Symfony\Component\ErrorHandler\ErrorEnhancer\ClassNotFoundErrorEnhancer()];
    }
    /**
    ...
    private function cleanTrace(array $backtrace, int $type, string &$file, int &$line, bool $throw) : array
    {
        ...
        if (\class_exists(\RectorPrefix20210503\Symfony\Component\ErrorHandler\DebugClassLoader::class, \false)) {
            for ($i = \count($lightTrace) - 2; 0 < $i; --$i) {
                if (\RectorPrefix20210503\Symfony\Component\ErrorHandler\DebugClassLoader::class === ($lightTrace[$i]['class'] ?? null)) {
