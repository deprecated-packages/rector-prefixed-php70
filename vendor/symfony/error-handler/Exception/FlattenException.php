...
use RectorPrefix20210531\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface;
...
class FlattenException
{
    ...
    public static function createFromThrowable(\Throwable $exception, int $statusCode = null, array $headers = [])
    {
        ...
        if ($exception instanceof \RectorPrefix20210531\Symfony\Component\HttpKernel\Exception\HttpExceptionInterface) {
            $statusCode = $exception->getStatusCode();
            $headers = \array_merge($headers, $exception->getHeaders());
        } elseif ($exception instanceof \RectorPrefix20210531\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface) {
            $statusCode = 400;
        }
        if (null === $statusCode) {
            $statusCode = 500;
        }
        if (\class_exists(\RectorPrefix20210531\Symfony\Component\HttpFoundation\Response::class) && isset(\RectorPrefix20210531\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode])) {
            $statusText = \RectorPrefix20210531\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode];
        } else {
