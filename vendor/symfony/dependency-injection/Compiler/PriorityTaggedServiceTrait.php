...
class PriorityTaggedServiceUtil
{
     ...
     * @return string|null
     */
    public static function getDefaultIndex(\RectorPrefix20210517\Symfony\Component\DependencyInjection\ContainerBuilder $container, string $serviceId, string $class, string $defaultIndexMethod, string $tagName, $indexAttribute)
    {
     ...
     * @return int|null
     */
    public static function getDefaultPriority(\RectorPrefix20210517\Symfony\Component\DependencyInjection\ContainerBuilder $container, string $serviceId, string $class, string $defaultPriorityMethod, string $tagName)
    {
