 ...
 */
class AnalyzeServiceReferencesPass extends \RectorPrefix20210503\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    private $graph;
    ...
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        if ($value instanceof \RectorPrefix20210503\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
            $this->lazy = !$this->byFactory || !$value instanceof \RectorPrefix20210503\Symfony\Component\DependencyInjection\Argument\IteratorArgument;
        ...
        if ($value instanceof \RectorPrefix20210503\Symfony\Component\DependencyInjection\Reference) {
            ...
            $this->graph->connect($this->currentId, $this->currentDefinition, $targetId, $targetDefinition, $value, $this->lazy || $this->hasProxyDumper && $targetDefinition && $targetDefinition->isLazy(), \RectorPrefix20210503\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_UNINITIALIZED_REFERENCE === $value->getInvalidBehavior(), $this->byConstructor);
            if ($inExpression) {
