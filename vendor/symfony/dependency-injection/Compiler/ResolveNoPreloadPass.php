 ...
 */
class ResolveNoPreloadPass extends \RectorPrefix20210504\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    {
        if ($value instanceof \RectorPrefix20210504\Symfony\Component\DependencyInjection\Reference && \RectorPrefix20210504\Symfony\Component\DependencyInjection\ContainerBuilder::IGNORE_ON_UNINITIALIZED_REFERENCE !== $value->getInvalidBehavior() && $this->container->hasDefinition($id = (string) $value)) {
