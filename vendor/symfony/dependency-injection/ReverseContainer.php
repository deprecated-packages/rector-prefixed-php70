...
final class ReverseContainer
{
    ...
    public function __construct(\RectorPrefix20210523\Symfony\Component\DependencyInjection\Container $serviceContainer, \RectorPrefix20210523\Psr\Container\ContainerInterface $reversibleLocator, string $tagName = 'container.reversible')
    {
        ...
        }, $serviceContainer, \RectorPrefix20210523\Symfony\Component\DependencyInjection\Container::class);
    }
    /**
    ...
    public function getService(string $id)
    {
        ...
        if (isset($this->serviceContainer->getRemovedIds()[$id])) {
            throw new \RectorPrefix20210523\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, null, null, [], \sprintf('The "%s" service is private and cannot be accessed by reference. You should either make it public, or tag it as "%s".', $id, $this->tagName));
        }
