 ...
 */
class RequestMatcher implements \RectorPrefix20210504\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
     ...
     * {@inheritdoc}
     */
    public function matches(\RectorPrefix20210504\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (\RectorPrefix20210504\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
