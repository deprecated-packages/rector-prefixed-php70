...
use RectorPrefix20210503\Symfony\Component\HttpFoundation\File\Exception\FileException;
use RectorPrefix20210503\Symfony\Component\HttpFoundation\File\File;
/**
 ...
 */
class BinaryFileResponse extends \RectorPrefix20210503\Symfony\Component\HttpFoundation\Response
{
    ...
    {
        if (!$file instanceof \RectorPrefix20210503\Symfony\Component\HttpFoundation\File\File) {
            if ($file instanceof \SplFileInfo) {
                $file = new \RectorPrefix20210503\Symfony\Component\HttpFoundation\File\File($file->getPathname());
            } else {
                $file = new \RectorPrefix20210503\Symfony\Component\HttpFoundation\File\File((string) $file);
            }
        }
        if (!$file->isReadable()) {
            throw new \RectorPrefix20210503\Symfony\Component\HttpFoundation\File\Exception\FileException('File must be readable.');
        }
        $this->file = $file;
        if ($autoEtag) {
            $this->setAutoEtag();
     ...
     * {@inheritdoc}
     */
    public function prepare(\RectorPrefix20210503\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (self::$trustXSendfileTypeHeader && $request->headers->has('X-Sendfile-Type')) {
            ...
            if ('x-accel-redirect' === \strtolower($type)) {
                ...
                $parts = \RectorPrefix20210503\Symfony\Component\HttpFoundation\HeaderUtils::split($request->headers->get('X-Accel-Mapping', ''), ',=');
