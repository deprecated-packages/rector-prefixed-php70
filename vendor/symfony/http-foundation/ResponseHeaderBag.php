 ...
 */
class ResponseHeaderBag extends \RectorPrefix20210504\Symfony\Component\HttpFoundation\HeaderBag
{
    ...
    public function set(string $key, $values, bool $replace = \true)
    {
        ...
        if ('set-cookie' === $uniqueKey) {
            ...
            foreach ((array) $values as $cookie) {
                $this->setCookie(\RectorPrefix20210504\Symfony\Component\HttpFoundation\Cookie::fromString($cookie));
            }
    ...
    public function setCookie(\RectorPrefix20210504\Symfony\Component\HttpFoundation\Cookie $cookie)
    {
    ...
    {
        $this->setCookie(new \RectorPrefix20210504\Symfony\Component\HttpFoundation\Cookie($name, null, 1, $path, $domain, $secure, $httpOnly, \false, $sameSite));
    }
    /**
    ...
    {
        return \RectorPrefix20210504\Symfony\Component\HttpFoundation\HeaderUtils::makeDisposition($disposition, $filename, $filenameFallback);
    }
    /**
