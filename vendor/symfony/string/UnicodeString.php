 ...
 */
class UnicodeString extends \RectorPrefix20210504\Symfony\Component\String\AbstractUnicodeString
{
    public function __construct(string $string = '')
    {
        $this->string = \normalizer_is_normalized($string) ? $string : \normalizer_normalize($string);
        if (\false === $this->string) {
            throw new \RectorPrefix20210504\Symfony\Component\String\Exception\InvalidArgumentException('Invalid UTF-8 string.');
        }
    }
    public function append(string ...$suffix) : \RectorPrefix20210504\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    {
        if ($suffix instanceof \RectorPrefix20210504\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($string instanceof \RectorPrefix20210504\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($needle instanceof \RectorPrefix20210504\Symfony\Component\String\AbstractString) {
    ...
    public function join(array $strings, string $lastGlue = null) : \RectorPrefix20210504\Symfony\Component\String\AbstractString
    {
    ...
    public function normalize(int $form = self::NFC)
    {
        ...
        if (\in_array($form, [self::NFC, self::NFKC], \true)) {
            ...
            throw new \RectorPrefix20210504\Symfony\Component\String\Exception\InvalidArgumentException('Unsupported normalization form.');
    ...
    public function prepend(string ...$prefix) : \RectorPrefix20210504\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    public function replace(string $from, string $to) : \RectorPrefix20210504\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    public function replaceMatches(string $fromRegexp, $to) : \RectorPrefix20210504\Symfony\Component\String\AbstractString
    {
        $str = parent::replaceMatches($fromRegexp, $to);
        \normalizer_is_normalized($str->string) ?: ($str->string = \normalizer_normalize($str->string));
        return $str;
    }
    public function slice(int $start = 0, int $length = null) : \RectorPrefix20210504\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    public function splice(string $replacement, int $start = 0, int $length = null) : \RectorPrefix20210504\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
        if (\PHP_VERSION_ID < 80000 && 0 > $start && \grapheme_strlen($this->string) < -$start) {
            $start = 0;
    ...
    public function split(string $delimiter, int $limit = null, int $flags = null) : array
    {
        ...
        if (\false === $delimiter) {
            throw new \RectorPrefix20210504\Symfony\Component\String\Exception\InvalidArgumentException('Split delimiter is not a valid UTF-8 string.');
        }
        $str = clone $this;
        $tail = $this->string;
        $chunks = [];
    ...
    {
        if ($prefix instanceof \RectorPrefix20210504\Symfony\Component\String\AbstractString) {
