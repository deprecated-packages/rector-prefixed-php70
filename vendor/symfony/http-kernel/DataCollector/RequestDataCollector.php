...
use RectorPrefix20210503\Symfony\Component\HttpFoundation\ParameterBag;
use RectorPrefix20210503\Symfony\Component\HttpFoundation\Request;
use RectorPrefix20210503\Symfony\Component\HttpFoundation\RequestStack;
use RectorPrefix20210503\Symfony\Component\HttpFoundation\Response;
use RectorPrefix20210503\Symfony\Component\HttpFoundation\Session\SessionBagInterface;
 ...
 * @final
 */
class RequestDataCollector extends \RectorPrefix20210503\Symfony\Component\HttpKernel\DataCollector\DataCollector implements \RectorPrefix20210503\Symfony\Component\EventDispatcher\EventSubscriberInterface, \RectorPrefix20210503\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface
{
    ...
    public function collect(\RectorPrefix20210503\Symfony\Component\HttpFoundation\Request $request, \RectorPrefix20210503\Symfony\Component\HttpFoundation\Response $response, \Throwable $exception = null)
    {
        ...
        if ($response->isRedirect()) {
            $response->headers->setCookie(new \RectorPrefix20210503\Symfony\Component\HttpFoundation\Cookie('sf_redirect', \json_encode(['token' => $response->headers->get('x-debug-token'), 'route' => $request->attributes->get('_route', 'n/a'), 'method' => $request->getMethod(), 'controller' => $this->parseController($request->attributes->get('_controller')), 'status_code' => $statusCode, 'status_text' => \RectorPrefix20210503\Symfony\Component\HttpFoundation\Response::$statusTexts[(int) $statusCode]]), 0, '/', null, $request->isSecure(), \true, \false, 'lax'));
        }
    ...
    {
        return new \RectorPrefix20210503\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_request']->getValue());
    }
    public function getRequestQuery()
    {
        return new \RectorPrefix20210503\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_query']->getValue());
    }
    public function getRequestFiles()
    {
        return new \RectorPrefix20210503\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_files']->getValue());
    }
    public function getRequestHeaders()
    {
        return new \RectorPrefix20210503\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_headers']->getValue());
    }
    public function getRequestServer($raw = \false)
    {
        return new \RectorPrefix20210503\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_server']->getValue($raw));
    }
    public function getRequestCookies($raw = \false)
    {
        return new \RectorPrefix20210503\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_cookies']->getValue($raw));
    }
    public function getRequestAttributes()
    {
        return new \RectorPrefix20210503\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_attributes']->getValue());
    }
    public function getResponseHeaders()
    {
        return new \RectorPrefix20210503\Symfony\Component\HttpFoundation\ParameterBag($this->data['response_headers']->getValue());
    }
    public function getResponseCookies()
    {
        return new \RectorPrefix20210503\Symfony\Component\HttpFoundation\ParameterBag($this->data['response_cookies']->getValue());
    }
    ...
    {
        return new \RectorPrefix20210503\Symfony\Component\HttpFoundation\ParameterBag($this->data['dotenv_vars']->getValue());
    }
    /**
     * Gets the route name.
     *
    ...
    {
        return [\RectorPrefix20210503\Symfony\Component\HttpKernel\KernelEvents::CONTROLLER => 'onKernelController', \RectorPrefix20210503\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => 'onKernelResponse'];
    }
    /**
     * {@inheritdoc}
     */
    ...
    public function collectSessionUsage()
    {
        ...
        for ($i = $traceEndIndex; $i > 0; --$i) {
            if (null !== ($class = $trace[$i]['class'] ?? null) && (\is_subclass_of($class, \RectorPrefix20210503\Symfony\Component\HttpFoundation\Session\SessionInterface::class) || \is_subclass_of($class, \RectorPrefix20210503\Symfony\Component\HttpFoundation\Session\SessionBagInterface::class))) {
                $traceEndIndex = $i;
                break;
            }
        }
