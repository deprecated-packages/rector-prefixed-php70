 ...
 */
final class NotTaggedControllerValueResolver implements \RectorPrefix20210531\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    private $container;
    public function __construct(\RectorPrefix20210531\Psr\Container\ContainerInterface $container)
    {
     ...
     * @return mixed[]
     */
    public function resolve(\RectorPrefix20210531\Symfony\Component\HttpFoundation\Request $request, \RectorPrefix20210531\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument)
    {
        ...
        throw new \RectorPrefix20210531\Symfony\Component\DependencyInjection\Exception\RuntimeException($message);
    }
}
