 ...
 */
class Store implements \RectorPrefix20210503\Symfony\Component\HttpKernel\HttpCache\StoreInterface
{
    protected $root;
    private $keyCache;
    private $locks;
     ...
     * @return string
     */
    protected function generateContentDigest(\RectorPrefix20210503\Symfony\Component\HttpFoundation\Response $response)
    {
    ...
    {
        $key = $this->getCacheKey(\RectorPrefix20210503\Symfony\Component\HttpFoundation\Request::create($url));
        if (isset($this->locks[$key])) {
            \flock($this->locks[$key], \LOCK_UN);
            \fclose($this->locks[$key]);
            unset($this->locks[$key]);
     ...
     */
    protected function generateCacheKey(\RectorPrefix20210503\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     */
    private function getCacheKey(\RectorPrefix20210503\Symfony\Component\HttpFoundation\Request $request) : string
    {
     ...
     */
    private function persistRequest(\RectorPrefix20210503\Symfony\Component\HttpFoundation\Request $request) : array
    {
     ...
     */
    private function persistResponse(\RectorPrefix20210503\Symfony\Component\HttpFoundation\Response $response) : array
    {
     ...
     */
    private function restoreResponse(array $headers, string $path = null) : \RectorPrefix20210503\Symfony\Component\HttpFoundation\Response
    {
        ...
        return new \RectorPrefix20210503\Symfony\Component\HttpFoundation\Response($path, $status, $headers);
    }
}
