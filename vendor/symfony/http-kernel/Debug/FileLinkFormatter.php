...
class FileLinkFormatter
{
     ...
     * @return string|null
     */
    public static function generateUrlFormat(\RectorPrefix20210620\Symfony\Component\Routing\Generator\UrlGeneratorInterface $router, string $routeName, string $queryString)
    {
        try {
