 ...
 */
class FileProfilerStorage implements \RectorPrefix20210616\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * @throws \RuntimeException
     */
    public function write(\RectorPrefix20210616\Symfony\Component\HttpKernel\Profiler\Profile $profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\RectorPrefix20210616\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    protected function createProfileFromData(string $token, array $data, \RectorPrefix20210616\Symfony\Component\HttpKernel\Profiler\Profile $parent = null)
    {
        $profile = new \RectorPrefix20210616\Symfony\Component\HttpKernel\Profiler\Profile($token);
