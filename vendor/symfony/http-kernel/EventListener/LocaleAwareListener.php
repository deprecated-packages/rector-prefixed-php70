...
use RectorPrefix20210504\Symfony\Contracts\Translation\LocaleAwareInterface;
/**
 * Pass the current locale to the provided services.
 *
 * @author Pierre Bobiet <pierrebobiet@gmail.com>
 */
class LocaleAwareListener implements \RectorPrefix20210504\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
     ...
     */
    public function __construct($localeAwareServices, \RectorPrefix20210504\Symfony\Component\HttpFoundation\RequestStack $requestStack)
    {
    ...
    public static function getSubscribedEvents()
    {
        return [
            ...
            \RectorPrefix20210504\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 15]],
            \RectorPrefix20210504\Symfony\Component\HttpKernel\KernelEvents::FINISH_REQUEST => [['onKernelFinishRequest', -15]],
        ];
    }
    /**
     * @return void
