 ...
 */
namespace RectorPrefix20210616\JsonSchema\Entity;
...
class JsonPointer
{
    ...
    {
        if (!\is_string($value)) {
            throw new \RectorPrefix20210616\JsonSchema\Exception\InvalidArgumentException('Ref value must be a string');
        }
