 ...
 */
namespace RectorPrefix20210526\JsonSchema\Entity;
...
class JsonPointer
{
    ...
    {
        if (!\is_string($value)) {
            throw new \RectorPrefix20210526\JsonSchema\Exception\InvalidArgumentException('Ref value must be a string');
        }
