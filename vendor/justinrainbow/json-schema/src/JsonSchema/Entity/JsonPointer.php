 ...
 */
namespace RectorPrefix20210504\JsonSchema\Entity;
...
class JsonPointer
{
    ...
    {
        if (!\is_string($value)) {
            throw new \RectorPrefix20210504\JsonSchema\Exception\InvalidArgumentException('Ref value must be a string');
        }
