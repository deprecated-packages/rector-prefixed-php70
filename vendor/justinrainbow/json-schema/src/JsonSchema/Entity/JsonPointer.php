 ...
 */
namespace RectorPrefix20210518\JsonSchema\Entity;
...
class JsonPointer
{
    ...
    {
        if (!\is_string($value)) {
            throw new \RectorPrefix20210518\JsonSchema\Exception\InvalidArgumentException('Ref value must be a string');
        }
