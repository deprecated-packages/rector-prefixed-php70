 ...
 */
class EnumConstraint extends \RectorPrefix20210503\JsonSchema\Constraints\Constraint
{
    /**
     * {@inheritdoc}
     */
    public function check(&$element, $schema = null, \RectorPrefix20210503\JsonSchema\Entity\JsonPointer $path = null, $i = null)
    {
        ...
        if ($element instanceof \RectorPrefix20210503\JsonSchema\Constraints\UndefinedConstraint && (!isset($schema->required) || !$schema->required)) {
            return;
        }
