 ...
 */
class ObjectConstraint extends \RectorPrefix20210517\JsonSchema\Constraints\Constraint
{
    /**
     ...
     * {@inheritdoc}
     */
    public function check(&$element, $schema = null, \RectorPrefix20210517\JsonSchema\Entity\JsonPointer $path = null, $properties = null, $additionalProp = null, $patternProperties = null, $appliedDefaults = array())
    {
        if ($element instanceof \RectorPrefix20210517\JsonSchema\Constraints\UndefinedConstraint) {
            return;
        }
    ...
    public function validatePatternProperties($element, \RectorPrefix20210517\JsonSchema\Entity\JsonPointer $path = null, $patternProperties)
    {
        $try = array('/', '#', '+', '~', '%');
        $matches = array();
     ...
     */
    public function validateElement($element, $matches, $schema = null, \RectorPrefix20210517\JsonSchema\Entity\JsonPointer $path = null, $properties = null, $additionalProp = null)
    {
        ...
        foreach ($element as $i => $value) {
            ...
            if (\is_object($property)) {
                $this->validateMinMaxConstraint(!$property instanceof \RectorPrefix20210517\JsonSchema\Constraints\UndefinedConstraint ? $property : $element, $definition, $path);
            }
        }
    }
    /**
     ...
     */
    public function validateProperties(&$element, $properties = null, \RectorPrefix20210517\JsonSchema\Entity\JsonPointer $path = null)
    {
     ...
     */
    protected function validateMinMaxConstraint($element, $objectDefinition, \RectorPrefix20210517\JsonSchema\Entity\JsonPointer $path = null)
    {
