...
use RectorPrefix20210520\JsonSchema\Rfc3339;
/**
 ...
 */
class FormatConstraint extends \RectorPrefix20210520\JsonSchema\Constraints\Constraint
{
    /**
     * {@inheritdoc}
     */
    public function check(&$element, $schema = null, \RectorPrefix20210520\JsonSchema\Entity\JsonPointer $path = null, $i = null)
    {
        ...
        switch ($schema->format) {
            ...
            case 'time':
                ...
                break;
            case 'date-time':
                if (null === \RectorPrefix20210520\JsonSchema\Rfc3339::createFromString($element)) {
