 ...
 */
class CollectionConstraint extends \RectorPrefix20210525\JsonSchema\Constraints\Constraint
{
    /**
     * {@inheritdoc}
     */
     ...
     * @param string           $i
     */
    protected function validateItems(&$value, $schema = null, \RectorPrefix20210525\JsonSchema\Entity\JsonPointer $path = null, $i = null)
    {
