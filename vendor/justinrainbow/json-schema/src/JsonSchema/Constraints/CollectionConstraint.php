 ...
 */
class CollectionConstraint extends \RectorPrefix20210531\JsonSchema\Constraints\Constraint
{
    /**
     * {@inheritdoc}
     */
    public function check(&$value, $schema = null, \RectorPrefix20210531\JsonSchema\Entity\JsonPointer $path = null, $i = null)
    {
        // Verify minItems
     ...
     * @param string           $i
     */
    protected function validateItems(&$value, $schema = null, \RectorPrefix20210531\JsonSchema\Entity\JsonPointer $path = null, $i = null)
    {
