 ...
 */
class TypeConstraint extends \RectorPrefix20210525\JsonSchema\Constraints\Constraint
{
    /**
     ...
     * {@inheritdoc}
     */
    public function check(&$value = null, $schema = null, \RectorPrefix20210525\JsonSchema\Entity\JsonPointer $path = null, $i = null)
    {
    ...
    protected function validateType(&$value, $type)
    {
        ...
        $coerce = $this->factory->getConfig(\RectorPrefix20210525\JsonSchema\Constraints\Constraint::CHECK_MODE_COERCE_TYPES);
        if ('integer' === $type) {
            if ($coerce) {
        ...
        throw new \RectorPrefix20210525\JsonSchema\Exception\InvalidArgumentException((\is_object($value) ? 'object' : $value) . ' is an invalid type for ' . $type);
    }
    /**
