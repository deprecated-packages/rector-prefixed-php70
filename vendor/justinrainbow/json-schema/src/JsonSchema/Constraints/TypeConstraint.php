 ...
 */
class TypeConstraint extends \RectorPrefix20210503\JsonSchema\Constraints\Constraint
{
    /**
     ...
     * {@inheritdoc}
     */
    public function check(&$value = null, $schema = null, \RectorPrefix20210503\JsonSchema\Entity\JsonPointer $path = null, $i = null)
    {
    ...
    protected function validateType(&$value, $type)
    {
        ...
        $coerce = $this->factory->getConfig(\RectorPrefix20210503\JsonSchema\Constraints\Constraint::CHECK_MODE_COERCE_TYPES);
        if ('integer' === $type) {
            if ($coerce) {
        ...
        throw new \RectorPrefix20210503\JsonSchema\Exception\InvalidArgumentException((\is_object($value) ? 'object' : $value) . ' is an invalid type for ' . $type);
    }
    /**
