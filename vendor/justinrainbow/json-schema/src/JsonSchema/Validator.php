...
use RectorPrefix20210523\JsonSchema\Constraints\Constraint;
/**
 ...
 * @see    README.md
 */
class Validator extends \RectorPrefix20210523\JsonSchema\Constraints\BaseConstraint
{
    ...
    public function validate(&$value, $schema = null, $checkMode = null)
    {
        ...
        if (\is_object($schema) && \property_exists($schema, 'id')) {
            ...
            $schemaURI = \RectorPrefix20210523\JsonSchema\SchemaStorage::INTERNAL_PROVIDED_SCHEMA_URI;
        }
    ...
    {
        return $this->validate($value, $schema, \RectorPrefix20210523\JsonSchema\Constraints\Constraint::CHECK_MODE_COERCE_TYPES);
    }
}
