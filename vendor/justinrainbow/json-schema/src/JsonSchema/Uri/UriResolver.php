...
use RectorPrefix20210522\JsonSchema\Exception\UriResolverException;
use RectorPrefix20210522\JsonSchema\UriResolverInterface;
/**
 * Resolves JSON Schema URIs
 *
 * @author Sander Coolen <sander@jibber.nl>
 */
class UriResolver implements \RectorPrefix20210522\JsonSchema\UriResolverInterface
{
    /**
    ...
    public static function combineRelativePathWithBasePath($relativePath, $basePath)
    {
        ...
        if ($numLevelUp >= \count($basePathSegments)) {
            throw new \RectorPrefix20210522\JsonSchema\Exception\UriResolverException(\sprintf("Unable to resolve URI '%s' from base '%s'", $relativePath, $basePath));
        }
