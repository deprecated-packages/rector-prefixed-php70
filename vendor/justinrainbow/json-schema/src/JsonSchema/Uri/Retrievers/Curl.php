 ...
 */
namespace RectorPrefix20210503\JsonSchema\Uri\Retrievers;
 ...
 */
class Curl extends \RectorPrefix20210503\JsonSchema\Uri\Retrievers\AbstractRetriever
{
    ...
    public function __construct()
    {
        if (!\function_exists('curl_init')) {
            ...
            throw new \RectorPrefix20210503\JsonSchema\Exception\RuntimeException('cURL not installed');
            // @codeCoverageIgnore
        }
    }
    /**
    ...
    public function retrieve($uri)
    {
        ...
        \curl_setopt($ch, \CURLOPT_HTTPHEADER, array('Accept: ' . \RectorPrefix20210503\JsonSchema\Validator::SCHEMA_MEDIA_TYPE));
        $response = \curl_exec($ch);
        if (\false === $response) {
            throw new \RectorPrefix20210503\JsonSchema\Exception\ResourceNotFoundException('JSON schema not found');
        }
