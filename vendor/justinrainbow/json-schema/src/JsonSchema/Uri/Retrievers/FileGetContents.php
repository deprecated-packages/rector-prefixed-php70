 ...
 */
class FileGetContents extends \RectorPrefix20210517\JsonSchema\Uri\Retrievers\AbstractRetriever
{
    ...
    public function retrieve($uri)
    {
        ...
        if ($errorMessage) {
            throw new \RectorPrefix20210517\JsonSchema\Exception\ResourceNotFoundException($errorMessage);
        }
        if (\false === $response) {
            throw new \RectorPrefix20210517\JsonSchema\Exception\ResourceNotFoundException('JSON schema not found at ' . $uri);
        }
