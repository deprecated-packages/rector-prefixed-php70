 ...
 */
class FileGetContents extends \RectorPrefix20210525\JsonSchema\Uri\Retrievers\AbstractRetriever
{
    ...
    public function retrieve($uri)
    {
        ...
        if ($errorMessage) {
            throw new \RectorPrefix20210525\JsonSchema\Exception\ResourceNotFoundException($errorMessage);
        }
        if (\false === $response) {
            throw new \RectorPrefix20210525\JsonSchema\Exception\ResourceNotFoundException('JSON schema not found at ' . $uri);
        }
