...
class SomeClass
{
    public function run()
    {
        return new \RectorPrefix20210520\AnotherClass();
    }
}
...
class AnotherClass
{
    ...
    {
        return \RectorPrefix20210520\StaticClass::staticMethod();
    }
}
...
, [self::TYPES_TO_SERVICES => ['ClassName']])]);
    ...
    public function refactor(\PhpParser\Node $node)
    {
        ...
        $this->traverseNodesWithCallable($node->stmts, function (\PhpParser\Node $node) use($classesUsingTypes) {
