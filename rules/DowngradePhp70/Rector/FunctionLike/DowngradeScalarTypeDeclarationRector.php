...
CODE_SAMPLE
     ...
     */
    private function resolveRecastAssign(\PhpParser\Node\Param $param, \PhpParser\Node\FunctionLike $functionLike)
    {
    ...
    /**
     * @return \PhpParser\Node\Expr\Cast|null
     */
    private function recastVariabletIfScalarType(\PhpParser\Node\Expr\Variable $variable, \PHPStan\Type\Type $type)
    {
