...
final class TokenManipulator
{
    ...
    public function __construct(\RectorPrefix20210531\Symplify\Astral\NodeTraverser\SimpleCallableNodeTraverser $simpleCallableNodeTraverser, \Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \Rector\NodeTypeResolver\NodeTypeResolver $nodeTypeResolver, \Rector\PostRector\Collector\NodesToRemoveCollector $nodesToRemoveCollector, \Rector\Core\PhpParser\Node\Value\ValueResolver $valueResolver, \Rector\Core\PhpParser\Comparing\NodeComparator $nodeComparator)
    {
    ...
    public function refactorTokenIsKind(array $nodes, \PhpParser\Node\Expr $singleTokenExpr)
    {
        $this->simpleCallableNodeTraverser->traverseNodesWithCallable($nodes, function (\PhpParser\Node $node) use($singleTokenExpr) {
            ...
            if (!\RectorPrefix20210531\Nette\Utils\Strings::match($constName, '#^T_#')) {
                return null;
            }
