...
, $exampleConfiguration)]);
    ...
    public function configure(array $configuration)
    {
        ...
        \RectorPrefix20210620\Webmozart\Assert\Assert::allIsInstanceOf($addedArguments, \Rector\Arguments\ValueObject\ArgumentAdder::class);
     ...
     * @return void
     */
    private function processPositionWithDefaultValues($node, \Rector\Arguments\ValueObject\ArgumentAdder $argumentAdder)
    {
