...
, [self::REPLACED_ARGUMENTS => [new \Rector\Arguments\ValueObject\FuncCallArgumentDefaultValueReplacer('version_compare', 2, 'gte', 'ge')]])]);
    ...
    public function configure(array $configuration)
    {
        ...
        \RectorPrefix20210525\Webmozart\Assert\Assert::allIsInstanceOf($replacedArguments, \Rector\Arguments\ValueObject\FuncCallArgumentDefaultValueReplacer::class);
