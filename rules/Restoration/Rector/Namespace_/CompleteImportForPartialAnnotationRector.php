...
use RectorPrefix20210522\Symplify\Astral\ValueObject\NodeBuilder\UseBuilder;
...
, [self::USE_IMPORTS_TO_RESTORE => [new \Rector\Restoration\ValueObject\CompleteImportForPartialAnnotation('Doctrine\\ORM\\Mapping', 'ORM')]])]);
    ...
    public function refactor(\PhpParser\Node $node)
    {
        ...
        foreach ($this->useImportsToRestore as $useImportToRestore) {
            ...
            if (!\RectorPrefix20210522\Nette\Utils\Strings::match($this->print($class), $annotationToSeek)) {
                continue;
            }
    ...
    public function configure(array $configuration)
    {
        ...
        \RectorPrefix20210522\Webmozart\Assert\Assert::allIsInstanceOf($useImportsToRestore, \Rector\Restoration\ValueObject\CompleteImportForPartialAnnotation::class);
    ...
    {
        $useBuilder = new \RectorPrefix20210522\Symplify\Astral\ValueObject\NodeBuilder\UseBuilder($completeImportForPartialAnnotation->getUse());
