...
CODE_SAMPLE
    ...
    {
        return !\RectorPrefix20210503\Nette\Utils\Strings::startsWith($string->value, 'phar://');
    }
    ...
    {
        if (!\RectorPrefix20210503\Nette\Utils\Strings::startsWith($string->value, './')) {
            return;
        }
        $string->value = \RectorPrefix20210503\Nette\Utils\Strings::replace($string->value, '#^\\.\\/#', '/');
    }
    /**
     * @return void
     */
