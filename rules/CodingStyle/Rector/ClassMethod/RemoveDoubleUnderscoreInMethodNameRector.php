...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node)
    {
        ...
        if (!\RectorPrefix20210525\Nette\Utils\Strings::match($methodName, self::DOUBLE_UNDERSCORE_START_REGEX)) {
            return null;
        }
        $newName = \RectorPrefix20210525\Nette\Utils\Strings::substring($methodName, 2);
