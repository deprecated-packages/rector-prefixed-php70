...
final class DocAliasResolver
{
    ...
    public function __construct(\RectorPrefix20210528\Symplify\Astral\NodeTraverser\SimpleCallableNodeTraverser $simpleCallableNodeTraverser, \Rector\BetterPhpDocParser\PhpDocInfo\PhpDocInfoFactory $phpDocInfoFactory)
    {
    ...
    public function resolve(\PhpParser\Node $node) : array
    {
        ...
        $this->simpleCallableNodeTraverser->traverseNodesWithCallable($node, function (\PhpParser\Node $node) use(&$possibleDocAliases) {
            ...
            $matches = \RectorPrefix20210528\Nette\Utils\Strings::matchAll($docComment->getText(), self::DOC_ALIAS_REGEX);
