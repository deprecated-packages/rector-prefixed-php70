...
final class DowngradeAttributeToAnnotationRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
     ...
     * @var string
     */
    const ATTRIBUTE_TO_ANNOTATION = 'attribute_to_annotation';
    /**
...
, [self::ATTRIBUTE_TO_ANNOTATION => [new \Rector\DowngradePhp80\ValueObject\DowngradeAttributeToAnnotation('Symfony\\Component\\Routing\\Annotation\\Route', 'Symfony\\Component\\Routing\\Annotation\\Route')]])]);
    ...
    public function refactor(\PhpParser\Node $node)
    {
        ...
        foreach ($node->attrGroups as $attrGroup) {
            foreach ($attrGroup->attrs as $key => $attribute) {
                ...
                if (!\RectorPrefix20210525\Nette\Utils\Strings::contains($attributeToAnnotation->getTag(), '\\')) {
    ...
    public function configure(array $configuration)
    {
        ...
        \RectorPrefix20210525\Webmozart\Assert\Assert::allIsInstanceOf($attributesToAnnotations, \Rector\DowngradePhp80\ValueObject\DowngradeAttributeToAnnotation::class);
        $this->attributesToAnnotations = $attributesToAnnotations;
    }
    /**
     * @param \PhpParser\Node\Stmt\ClassMethod|\PhpParser\Node\Stmt\Property|\PhpParser\Node\Stmt\Class_ $node
     * @return void
     */
    private function cleanupEmptyAttrGroups($node)
    {
     ...
     * @return \Rector\DowngradePhp80\ValueObject\DowngradeAttributeToAnnotation|null
     */
    private function matchAttributeToAnnotation(\PhpParser\Node\Attribute $attribute, array $attributesToAnnotations)
    {
