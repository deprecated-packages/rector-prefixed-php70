...
final class DowngradeNamedArgumentRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     */
    private $parser;
    public function __construct(\PHPStan\Reflection\ReflectionProvider $reflectionProvider, \RectorPrefix20210616\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \PhpParser\Parser $parser)
    {
...
CODE_SAMPLE
     ...
     * @return \PhpParser\Node|null
     */
    private function applyRemoveNamedArgument(\PhpParser\Node $node, array $args)
    {
     ...
     * @return \PhpParser\Node|null
     */
    private function getCaller(\PhpParser\Node $node)
    {
     ...
     * @return void
     */
    private function replacePreviousArgs(\PhpParser\Node $node, array $params, int $keyParam, array $newArgs)
    {
