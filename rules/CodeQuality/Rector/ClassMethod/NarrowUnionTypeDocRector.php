...
CODE_SAMPLE
     ...
     * @return void
     */
    private function changeDocObjectWithoutClassType(\PHPStan\Type\UnionType $unionType, int $key, \Rector\BetterPhpDocParser\PhpDocInfo\PhpDocInfo $phpDocInfo)
    {
     ...
     * @return void
     */
    private function changeDocObjectScalar(int $key, \Rector\BetterPhpDocParser\PhpDocInfo\PhpDocInfo $phpDocInfo)
    {
        $paramTagValueNodes = $phpDocInfo->getParamTagValueNodes();
