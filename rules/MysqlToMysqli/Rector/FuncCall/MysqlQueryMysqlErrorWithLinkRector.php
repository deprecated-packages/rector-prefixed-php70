...
CODE_SAMPLE
    ...
    {
        $connectionAssign = $this->betterNodeFinder->findFirstPrevious($funcCall, function (\PhpParser\Node $node) {
     ...
     * @return void
     */
    private function removeExistingConnectionParameter(\PhpParser\Node\Expr\FuncCall $funcCall)
    {
