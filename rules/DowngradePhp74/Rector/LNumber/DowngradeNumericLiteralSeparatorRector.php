...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node)
    {
        ...
        if (\RectorPrefix20210519\Nette\Utils\Strings::contains($numberNodeValue, '+')) {
            return null;
        }
         ...
         * Then, add it again.
         */
        if ($node instanceof \PhpParser\Node\Scalar\DNumber && !\RectorPrefix20210519\Nette\Utils\Strings::contains($node->value, '.')) {
            $node->value .= '.0';
        }
        return $node;
    }
